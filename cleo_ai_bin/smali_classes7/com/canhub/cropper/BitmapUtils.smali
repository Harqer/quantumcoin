...
.method private final buildUri(Landroid/content/Context;Landroid/graphics/Bitmap$CompressFormat;)Landroid/net/Uri;
    ...
    invoke-static {p1, p0}, Lcom/canhub/cropper/utils/GetUriForFileKt;->getUriForFile(Landroid/content/Context;Ljava/io/File;)Landroid/net/Uri;
...
.method private final calculateInSampleSizeByMaxTextureSize(II)I
    ...
    sput p0, Lcom/canhub/cropper/BitmapUtils;->mMaxTextureSize:I

    .line 851
    :cond_0
    sget p0, Lcom/canhub/cropper/BitmapUtils;->mMaxTextureSize:I
...
.method private final cropBitmap(Landroid/content/Context;Landroid/net/Uri;[FIIIZIIIIZZI)Lcom/canhub/cropper/BitmapUtils$BitmapSampled;
    ...
    .line 545
    invoke-virtual/range {v5 .. v11}, Lcom/canhub/cropper/BitmapUtils;->getRectFromPoints([FIIZII)Landroid/graphics/Rect;
    ...
    .line 561
    :try_start_0
    invoke-direct/range {v5 .. v11}, Lcom/canhub/cropper/BitmapUtils;->decodeSampledBitmapRegion(Landroid/content/Context;Landroid/net/Uri;Landroid/graphics/Rect;III)Lcom/canhub/cropper/BitmapUtils$BitmapSampled;
    ...
    .line 570
    :try_start_2
    invoke-direct {p0, v1, v4, v12, v13}, Lcom/canhub/cropper/BitmapUtils;->rotateAndFlipBitmapInt(Landroid/graphics/Bitmap;IZZ)Landroid/graphics/Bitmap;

    move-result-object v1

    .line 572
    rem-int/lit8 p1, v4, 0x5a
    ...
    .line 589
    :cond_2
    new-instance p0, Lcom/canhub/cropper/BitmapUtils$BitmapSampled;

    invoke-direct {p0, v1, v8}, Lcom/canhub/cropper/BitmapUtils$BitmapSampled;-><init>(Landroid/graphics/Bitmap;I)V
    ...
    .line 592
    invoke-direct/range {v0 .. v13}, Lcom/canhub/cropper/BitmapUtils;->cropBitmap(Landroid/content/Context;Landroid/net/Uri;[FIZIIILandroid/graphics/Rect;IIZZ)Lcom/canhub/cropper/BitmapUtils$BitmapSampled;
...
.method private final cropBitmap(Landroid/content/Context;Landroid/net/Uri;[FIZIIILandroid/graphics/Rect;IIZZ)Lcom/canhub/cropper/BitmapUtils$BitmapSampled;
    ...
    .line 635
    invoke-direct {p0, v3, v4, v5, v6}, Lcom/canhub/cropper/BitmapUtils;->calculateInSampleSizeByRequestedSize(IIII)I
    ...
    .line 643
    invoke-direct {p0, v3, p2, v2}, Lcom/canhub/cropper/BitmapUtils;->decodeImage(Landroid/content/ContentResolver;Landroid/net/Uri;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    .line 657
    :try_start_2
    invoke-direct/range {v0 .. v9}, Lcom/canhub/cropper/BitmapUtils;->cropBitmapObjectWithScale(Landroid/graphics/Bitmap;[FIZIIFZZ)Landroid/graphics/Bitmap;
    ...
    invoke-direct {v0, v10, v11}, Lcom/canhub/cropper/BitmapUtils$BitmapSampled;-><init>(Landroid/graphics/Bitmap;I)V
    ...
    invoke-direct {v1, p2, v0}, Lcom/canhub/cropper/CropException$FailedToLoadBitmap;-><init>(Landroid/net/Uri;Ljava/lang/String;)V
...
.method private final cropBitmapObjectWithScale(Landroid/graphics/Bitmap;[FIZIIFZZ)Landroid/graphics/Bitmap;
    ...
    .line 224
    invoke-virtual/range {v8 .. v14}, Lcom/canhub/cropper/BitmapUtils;->getRectFromPoints([FIIZII)Landroid/graphics/Rect;
...
.method private final cropForRotatedImage(Landroid/graphics/Bitmap;[FLandroid/graphics/Rect;IZII)Landroid/graphics/Bitmap;
    ...
    .line 805
    invoke-static {p1, p0, p2, p4, p3}, Landroid/graphics/Bitmap;->createBitmap(Landroid/graphics/Bitmap;IIII)Landroid/graphics/Bitmap;
...
.method private final decodeImage(Landroid/content/ContentResolver;Landroid/net/Uri;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    invoke-direct {p0, p2}, Lcom/canhub/cropper/CropException$FailedToDecodeImage;-><init>(Landroid/net/Uri;)V
...
.method private final decodeSampledBitmapRegion(Landroid/content/Context;Landroid/net/Uri;Landroid/graphics/Rect;III)Lcom/canhub/cropper/BitmapUtils$BitmapSampled;
    ...
    invoke-static {p1}, Landroid/graphics/BitmapRegionDecoder;->newInstance(Ljava/io/InputStream;)Landroid/graphics/BitmapRegionDecoder;
    ...
    invoke-virtual {p1, p3, v0}, Landroid/graphics/BitmapRegionDecoder;->decodeRegion(Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    invoke-direct {p0, p4, p1}, Lcom/canhub/cropper/BitmapUtils$BitmapSampled;-><init>(Landroid/graphics/Bitmap;I)V
    ...
    .line 761
    new-instance p1, Lcom/canhub/cropper/CropException$FailedToLoadBitmap;

    invoke-virtual {p0}, Ljava/lang/Exception;->getMessage()Ljava/lang/String;

    move-result-object p0

    invoke-direct {p1, p2, p0}, Lcom/canhub/cropper/CropException$FailedToLoadBitmap;-><init>(Landroid/net/Uri;Ljava/lang/String;)V
...
.method private final rotateAndFlipBitmapInt(Landroid/graphics/Bitmap;IZZ)Landroid/graphics/Bitmap;
    ...
    .line 874
    invoke-virtual {v5, p3, p0}, Landroid/graphics/Matrix;->postScale(FF)Z
...
.method public final decodeSampledBitmap(Landroid/content/Context;Landroid/net/Uri;II)Lcom/canhub/cropper/BitmapUtils$BitmapSampled;
    ...
    const-string p1, "File is not a picture"
    ...
    invoke-direct {p1, p0, p3}, Lcom/canhub/cropper/BitmapUtils$BitmapSampled;-><init>(Landroid/graphics/Bitmap;I)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final getEMPTY_RECT()Landroid/graphics/Rect;
    ...
    .line 39
    sget-object p0, Lcom/canhub/cropper/BitmapUtils;->EMPTY_RECT:Landroid/graphics/Rect;
...
.method public final getEMPTY_RECT_F()Landroid/graphics/RectF;
    ...
    .line 40
    sget-object p0, Lcom/canhub/cropper/BitmapUtils;->EMPTY_RECT_F:Landroid/graphics/RectF;
...
.method public final getMStateBitmap()Landroid/util/Pair;
    ...
    .line 67
    sget-object p0, Lcom/canhub/cropper/BitmapUtils;->mStateBitmap:Landroid/util/Pair;
...
.method public final getPOINTS()[F
    ...
    .line 52
    sget-object p0, Lcom/canhub/cropper/BitmapUtils;->POINTS:[F
...
.method public final getPOINTS2()[F
    ...
    .line 57
    sget-object p0, Lcom/canhub/cropper/BitmapUtils;->POINTS2:[F
...
.method public final getRECT()Landroid/graphics/RectF;
    ...
    .line 47
    sget-object p0, Lcom/canhub/cropper/BitmapUtils;->RECT:Landroid/graphics/RectF;
...
.method public final orientateBitmapByExif(Landroid/graphics/Bitmap;Landroid/content/Context;Landroid/net/Uri;)Lcom/canhub/cropper/BitmapUtils$RotateBitmapResult;
    ...
    .line 85
    :cond_1
    new-instance p0, Lcom/canhub/cropper/BitmapUtils$RotateBitmapResult;

    const/4 p2, 0x0

    invoke-direct {p0, p1, p2, p2, p2}, Lcom/canhub/cropper/BitmapUtils$RotateBitmapResult;-><init>(Landroid/graphics/Bitmap;IZZ)V
...
.method public final orientateBitmapByExif(Landroid/graphics/Bitmap;Landroidx/exifinterface/media/ExifInterface;)Lcom/canhub/cropper/BitmapUtils$RotateBitmapResult;
    ...
    invoke-virtual {p2, p0, v0}, Landroidx/exifinterface/media/ExifInterface;->getAttributeInt(Ljava/lang/String;I)I
    ...
    invoke-direct {p0, p1, p2, v2, v0}, Lcom/canhub/cropper/BitmapUtils$RotateBitmapResult;-><init>(Landroid/graphics/Bitmap;IZZ)V
...
.method public final resizeBitmap(Landroid/graphics/Bitmap;IILcom/canhub/cropper/CropImageView$RequestSizeOptions;)Landroid/graphics/Bitmap;
    ...
    .line 489
    :try_start_0
    sget-object p0, Lcom/canhub/cropper/CropImageView$RequestSizeOptions;->RESIZE_FIT:Lcom/canhub/cropper/CropImageView$RequestSizeOptions;

    if-eq p4, p0, :cond_0

    sget-object p0, Lcom/canhub/cropper/CropImageView$RequestSizeOptions;->RESIZE_INSIDE:Lcom/canhub/cropper/CropImageView$RequestSizeOptions;

    if-eq p4, p0, :cond_0

    sget-object p0, Lcom/canhub/cropper/CropImageView$RequestSizeOptions;->RESIZE_EXACT:Lcom/canhub/cropper/CropImageView$RequestSizeOptions;
    ...
    .line 514
    const-string p2, "Failed to resize cropped image, return bitmap before resize"
...
.method public final writeBitmapToUri(Landroid/content/Context;Landroid/graphics/Bitmap;Landroid/graphics/Bitmap$CompressFormat;ILandroid/net/Uri;)Landroid/net/Uri;
    ...
    invoke-virtual {p0, p5, p1}, Landroid/content/ContentResolver;->openOutputStream(Landroid/net/Uri;Ljava/lang/String;)Ljava/io/OutputStream;
...
.method public final writeTempStateStoreBitmap(Landroid/content/Context;Landroid/graphics/Bitmap;Landroid/net/Uri;)Landroid/net/Uri;
    ...
    .line 423
    const-string p1, "Failed to write bitmap to temp file for image-cropper save instance state"
