.class final Lcom/stripe/android/challenge/passive/DaggerPassiveChallengeComponent$PassiveChallengeComponentImpl;
.super Ljava/lang/Object;
.source "DaggerPassiveChallengeComponent.java"

# interfaces
.implements Lcom/stripe/android/challenge/passive/PassiveChallengeComponent;
...
.field private final passiveChallengeComponentImpl:Lcom/stripe/android/challenge/passive/DaggerPassiveChallengeComponent$PassiveChallengeComponentImpl;
...
.method constructor <init>(Lcom/stripe/android/core/injection/CoreCommonModule;Lcom/stripe/android/core/injection/CoroutineContextModule;Landroid/content/Context;Lkotlin/jvm/functions/Function0;Ljava/util/Set;Lcom/stripe/android/model/PassiveCaptchaParams;)V
    ...
    .line 75
    iput-object p0, p0, Lcom/stripe/android/challenge/passive/DaggerPassiveChallengeComponent$PassiveChallengeComponentImpl;->passiveChallengeComponentImpl:Lcom/stripe/android/challenge/passive/DaggerPassiveChallengeComponent$PassiveChallengeComponentImpl;

    .line 83
    iput-object p6, p0, Lcom/stripe/android/challenge/passive/DaggerPassiveChallengeComponent$PassiveChallengeComponentImpl;->passiveCaptchaParams:Lcom/stripe/android/model/PassiveCaptchaParams;

    .line 84
    iput-object p1, p0, Lcom/stripe/android/challenge/passive/DaggerPassiveChallengeComponent$PassiveChallengeComponentImpl;->coreCommonModule:Lcom/stripe/android/core/injection/CoreCommonModule;

    .line 85
    iput-object p2, p0, Lcom/stripe/android/challenge/passive/DaggerPassiveChallengeComponent$PassiveChallengeComponentImpl;->coroutineContextModule:Lcom/stripe/android/core/injection/CoroutineContextModule;

    .line 86
    iput-object p3, p0, Lcom/stripe/android/challenge/passive/DaggerPassiveChallengeComponent$PassiveChallengeComponentImpl;->context:Landroid/content/Context;

    .line 87
    iput-object p4, p0, Lcom/stripe/android/challenge/passive/DaggerPassiveChallengeComponent$PassiveChallengeComponentImpl;->publishableKeyProvider:Lkotlin/jvm/functions/Function0;

    .line 88
    iput-object p5, p0, Lcom/stripe/android/challenge/passive/DaggerPassiveChallengeComponent$PassiveChallengeComponentImpl;->productUsage:Ljava/util/Set;

    .line 89
    invoke-direct/range {p0 .. p6}, Lcom/stripe/android/challenge/passive/DaggerPassiveChallengeComponent$PassiveChallengeComponentImpl;->initialize(Lcom/stripe/android/core/injection/CoreCommonModule;Lcom/stripe/android/core/injection/CoroutineContextModule;Landroid/content/Context;Lkotlin/jvm/functions/Function0;Ljava/util/Set;Lcom/stripe/android/model/PassiveCaptchaParams;)V
...
.method private initialize(Lcom/stripe/android/core/injection/CoreCommonModule;Lcom/stripe/android/core/injection/CoroutineContextModule;Landroid/content/Context;Lkotlin/jvm/functions/Function0;Ljava/util/Set;Lcom/stripe/android/model/PassiveCaptchaParams;)V
    ...
    iput-object p1, p0, Lcom/stripe/android/challenge/passive/DaggerPassiveChallengeComponent$PassiveChallengeComponentImpl;->provideDurationProvider:Ldagger/internal/Provider;
...
.method captchaEventsReporter()Lcom/stripe/android/hcaptcha/analytics/CaptchaEventsReporter;
    ...
    .line 110
    invoke-virtual {p0}, Lcom/stripe/android/challenge/passive/DaggerPassiveChallengeComponent$PassiveChallengeComponentImpl;->defaultAnalyticsRequestExecutor()Lcom/stripe/android/core/networking/DefaultAnalyticsRequestExecutor;

    move-result-object v0

    invoke-virtual {p0}, Lcom/stripe/android/challenge/passive/DaggerPassiveChallengeComponent$PassiveChallengeComponentImpl;->paymentAnalyticsRequestFactory()Lcom/stripe/android/networking/PaymentAnalyticsRequestFactory;

    move-result-object v1

    iget-object v2, p0, Lcom/stripe/android/challenge/passive/DaggerPassiveChallengeComponent$PassiveChallengeComponentImpl;->provideDurationProvider:Ldagger/internal/Provider;
    ...
    invoke-virtual {p0}, Lcom/stripe/android/challenge/passive/DaggerPassiveChallengeComponent$PassiveChallengeComponentImpl;->realErrorReporter()Lcom/stripe/android/payments/core/analytics/RealErrorReporter;
...
.method defaultAnalyticsRequestExecutor()Lcom/stripe/android/core/networking/DefaultAnalyticsRequestExecutor;
    ...
    invoke-virtual {p0}, Lcom/stripe/android/challenge/passive/DaggerPassiveChallengeComponent$PassiveChallengeComponentImpl;->logger()Lcom/stripe/android/core/Logger;

    move-result-object v1

    iget-object p0, p0, Lcom/stripe/android/challenge/passive/DaggerPassiveChallengeComponent$PassiveChallengeComponentImpl;->coroutineContextModule:Lcom/stripe/android/core/injection/CoroutineContextModule;
...
.method public getPassiveChallengeViewModel()Lcom/stripe/android/challenge/passive/PassiveChallengeViewModel;
    .locals 2

    .line 127
    new-instance v0, Lcom/stripe/android/challenge/passive/PassiveChallengeViewModel;

    iget-object v1, p0, Lcom/stripe/android/challenge/passive/DaggerPassiveChallengeComponent$PassiveChallengeComponentImpl;->passiveCaptchaParams:Lcom/stripe/android/model/PassiveCaptchaParams;

    invoke-virtual {p0}, Lcom/stripe/android/challenge/passive/DaggerPassiveChallengeComponent$PassiveChallengeComponentImpl;->hCaptchaService()Lcom/stripe/android/hcaptcha/HCaptchaService;

    move-result-object p0

    invoke-direct {v0, v1, p0}, Lcom/stripe/android/challenge/passive/PassiveChallengeViewModel;-><init>(Lcom/stripe/android/model/PassiveCaptchaParams;Lcom/stripe/android/hcaptcha/HCaptchaService;)V
...
.method hCaptchaService()Lcom/stripe/android/hcaptcha/HCaptchaService;
    ...
    invoke-virtual {p0}, Lcom/stripe/android/challenge/passive/DaggerPassiveChallengeComponent$PassiveChallengeComponentImpl;->captchaEventsReporter()Lcom/stripe/android/hcaptcha/analytics/CaptchaEventsReporter;
...
.method logger()Lcom/stripe/android/core/Logger;
    ...
    .line 94
    iget-object p0, p0, Lcom/stripe/android/challenge/passive/DaggerPassiveChallengeComponent$PassiveChallengeComponentImpl;->coreCommonModule:Lcom/stripe/android/core/injection/CoreCommonModule;
...
.method paymentAnalyticsRequestFactory()Lcom/stripe/android/networking/PaymentAnalyticsRequestFactory;
    ...
    iget-object v1, p0, Lcom/stripe/android/challenge/passive/DaggerPassiveChallengeComponent$PassiveChallengeComponentImpl;->context:Landroid/content/Context;

    iget-object v2, p0, Lcom/stripe/android/challenge/passive/DaggerPassiveChallengeComponent$PassiveChallengeComponentImpl;->publishableKeyProvider:Lkotlin/jvm/functions/Function0;

    iget-object p0, p0, Lcom/stripe/android/challenge/passive/DaggerPassiveChallengeComponent$PassiveChallengeComponentImpl;->productUsage:Ljava/util/Set;
