...
.method public getBookmarks()Ljava/util/List;
    ...
    .line 316
    :cond_0
    iget-object p0, p0, Lcom/github/barteksc/pdfviewer/PdfFile;->pdfiumCore:Lio/legere/pdfiumandroid/PdfiumCore;

    invoke-virtual {p0, v0}, Lio/legere/pdfiumandroid/PdfiumCore;->getTableOfContents(Lio/legere/pdfiumandroid/PdfDocument;)Ljava/util/List;
...
.method public getDocLen(F)F
    ...
    .line 224
    iget p0, p0, Lcom/github/barteksc/pdfviewer/PdfFile;->documentLength:F
...
.method public getMaxPageSize()Landroid/util/SizeF;
    ...
    iget-object p0, p0, Lcom/github/barteksc/pdfviewer/PdfFile;->maxWidthPageSize:Landroid/util/SizeF;

    return-object p0

    :cond_0
    iget-object p0, p0, Lcom/github/barteksc/pdfviewer/PdfFile;->maxHeightPageSize:Landroid/util/SizeF;
...
.method public getMetaData()Lio/legere/pdfiumandroid/PdfDocument$Meta;
    ...
    invoke-virtual {p0, v0}, Lio/legere/pdfiumandroid/PdfiumCore;->getDocumentMeta(Lio/legere/pdfiumandroid/PdfDocument;)Lio/legere/pdfiumandroid/PdfDocument$Meta;
...
.method public getPageLength(IF)F
    ...
    .line 232
    iget-boolean p0, p0, Lcom/github/barteksc/pdfviewer/PdfFile;->isVertical:Z
...
.method public getPageLinks(I)Ljava/util/List;
    ...
    iget-object p0, p0, Lcom/github/barteksc/pdfviewer/PdfFile;->pdfDocument:Lio/legere/pdfiumandroid/PdfDocument;

    invoke-virtual {v0, p0, p1}, Lio/legere/pdfiumandroid/PdfiumCore;->getPageLinks(Lio/legere/pdfiumandroid/PdfDocument;I)Ljava/util/List;
...
.method public getPageOffset(IF)F
    ...
    .line 246
    :cond_0
    iget-object p0, p0, Lcom/github/barteksc/pdfviewer/PdfFile;->pageOffsets:Ljava/util/List;
...
.method public getPageSize(I)Landroid/util/SizeF;
    ...
    .line 149
    :cond_0
    iget-object p0, p0, Lcom/github/barteksc/pdfviewer/PdfFile;->pageSizes:Ljava/util/List;
...
.method public getPageSpacing(IF)F
    ...
    iget-object p0, p0, Lcom/github/barteksc/pdfviewer/PdfFile;->pageSpacing:Ljava/util/List;
    ...
    :cond_0
    iget p0, p0, Lcom/github/barteksc/pdfviewer/PdfFile;->spacingPx:I
...
.method public getPagesCount()I
    ...
    .line 141
    iget p0, p0, Lcom/github/barteksc/pdfviewer/PdfFile;->pagesCount:I
...
.method public mapRectToDevice(IIIIILandroid/graphics/RectF;)Landroid/graphics/RectF;
    ...
    invoke-virtual {p0, p1}, Lio/legere/pdfiumandroid/PdfDocument;->openPage(I)Lio/legere/pdfiumandroid/PdfPage;
...
.method public openPage(I)Z
    ...
    .line 286
    iget-object p0, p0, Lcom/github/barteksc/pdfviewer/PdfFile;->openedPages:Landroid/util/SparseBooleanArray;

    invoke-virtual {p0, v0, v1}, Landroid/util/SparseBooleanArray;->put(IZ)V

    .line 287
    new-instance p0, Lcom/github/barteksc/pdfviewer/exception/PageRenderingException;

    invoke-direct {p0, p1, v3}, Lcom/github/barteksc/pdfviewer/exception/PageRenderingException;-><init>(ILjava/lang/Throwable;)V
...
.method public recalculatePageSizes(Lio/legere/pdfiumandroid/util/Size;)V
    ...
    .line 125
    new-instance v1, Lcom/github/barteksc/pdfviewer/util/PageSizeCalculator;
    ...
    .line 127
    invoke-virtual {v1}, Lcom/github/barteksc/pdfviewer/util/PageSizeCalculator;->getOptimalMaxWidthPageSize()Landroid/util/SizeF;

    move-result-object p1

    iput-object p1, p0, Lcom/github/barteksc/pdfviewer/PdfFile;->maxWidthPageSize:Landroid/util/SizeF;

    .line 128
    invoke-virtual {v1}, Lcom/github/barteksc/pdfviewer/util/PageSizeCalculator;->getOptimalMaxHeightPageSize()Landroid/util/SizeF;

    move-result-object p1

    iput-object p1, p0, Lcom/github/barteksc/pdfviewer/PdfFile;->maxHeightPageSize:Landroid/util/SizeF;

    .line 130
    iget-object p1, p0, Lcom/github/barteksc/pdfviewer/PdfFile;->originalPageSizes:Ljava/util/List;
    ...
    check-cast v0, Lio/legere/pdfiumandroid/util/Size;

    .line 131
    iget-object v2, p0, Lcom/github/barteksc/pdfviewer/PdfFile;->pageSizes:Ljava/util/List;

    iget-boolean v3, p0, Lcom/github/barteksc/pdfviewer/PdfFile;->showTwoPages:Z

    iget-boolean v4, p0, Lcom/github/barteksc/pdfviewer/PdfFile;->isLandscape:Z

    invoke-virtual {v1, v0, v3, v4}, Lcom/github/barteksc/pdfviewer/util/PageSizeCalculator;->calculate(Lio/legere/pdfiumandroid/util/Size;ZZ)Landroid/util/SizeF;
    ...
    .line 133
    :cond_0
    iget-boolean p1, p0, Lcom/github/barteksc/pdfviewer/PdfFile;->autoSpacing:Z

    if-eqz p1, :cond_1

    .line 134
    invoke-direct {p0, v5}, Lcom/github/barteksc/pdfviewer/PdfFile;->prepareAutoSpacing(Lio/legere/pdfiumandroid/util/Size;)V
