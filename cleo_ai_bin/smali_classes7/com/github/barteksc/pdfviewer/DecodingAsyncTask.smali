...
.method private getViewSize(Lcom/github/barteksc/pdfviewer/PDFView;)Lio/legere/pdfiumandroid/util/Size;
    ...
    .line 78
    new-instance p0, Lio/legere/pdfiumandroid/util/Size;
    ...
    invoke-direct {p0, v0, p1}, Lio/legere/pdfiumandroid/util/Size;-><init>(II)V
...
.method protected varargs doInBackground([Ljava/lang/Void;)Ljava/lang/Throwable;
    ...
    .line 51
    :try_start_0
    iget-object v1, v0, Lcom/github/barteksc/pdfviewer/DecodingAsyncTask;->pdfViewReference:Ljava/lang/ref/WeakReference;
    ...
    .line 53
    iget-object v2, v0, Lcom/github/barteksc/pdfviewer/DecodingAsyncTask;->docSource:Lcom/github/barteksc/pdfviewer/source/DocumentSource;

    invoke-virtual {v1}, Lcom/github/barteksc/pdfviewer/PDFView;->getContext()Landroid/content/Context;

    move-result-object v3

    iget-object v4, v0, Lcom/github/barteksc/pdfviewer/DecodingAsyncTask;->pdfiumCore:Lio/legere/pdfiumandroid/PdfiumCore;

    iget-object v5, v0, Lcom/github/barteksc/pdfviewer/DecodingAsyncTask;->password:Ljava/lang/String;
    ...
    .line 54
    new-instance v6, Lcom/github/barteksc/pdfviewer/PdfFile;

    iget-object v7, v0, Lcom/github/barteksc/pdfviewer/DecodingAsyncTask;->pdfiumCore:Lio/legere/pdfiumandroid/PdfiumCore;

    .line 57
    invoke-virtual {v1}, Lcom/github/barteksc/pdfviewer/PDFView;->getPageFitPolicy()Lcom/github/barteksc/pdfviewer/util/FitPolicy;

    move-result-object v9

    .line 58
    invoke-direct {v0, v1}, Lcom/github/barteksc/pdfviewer/DecodingAsyncTask;->getViewSize(Lcom/github/barteksc/pdfviewer/PDFView;)Lio/legere/pdfiumandroid/util/Size;

    move-result-object v10

    iget-object v11, v0, Lcom/github/barteksc/pdfviewer/DecodingAsyncTask;->userPages:[I

    .line 60
    invoke-virtual {v1}, Lcom/github/barteksc/pdfviewer/PDFView;->isOnDualPageMode()Z
    ...
    .line 63
    invoke-virtual {v1}, Lcom/github/barteksc/pdfviewer/PDFView;->isAutoSpacingEnabled()Z

    move-result v15

    .line 64
    invoke-virtual {v1}, Lcom/github/barteksc/pdfviewer/PDFView;->isFitEachPage()Z

    move-result v16

    .line 65
    invoke-virtual {v1}, Lcom/github/barteksc/pdfviewer/PDFView;->isOnLandscapeOrientation()Z
    ...
    iput-object v6, v0, Lcom/github/barteksc/pdfviewer/DecodingAsyncTask;->pdfFile:Lcom/github/barteksc/pdfviewer/PdfFile;
    ...
    const-string/jumbo v1, "pdfView == null"
...
.method protected onPostExecute(Ljava/lang/Throwable;)V
    ...
    .line 90
    iget-object p0, p0, Lcom/github/barteksc/pdfviewer/DecodingAsyncTask;->pdfFile:Lcom/github/barteksc/pdfviewer/PdfFile;

    invoke-virtual {v0, p0}, Lcom/github/barteksc/pdfviewer/PDFView;->loadComplete(Lcom/github/barteksc/pdfviewer/PdfFile;)V
