...
.method private getPageColsRows(Lcom/github/barteksc/pdfviewer/PagesLoader$GridSize;I)V
    ...
    invoke-virtual {v0, p2}, Lcom/github/barteksc/pdfviewer/PdfFile;->getPageSize(I)Landroid/util/SizeF;
    ...
    iget-object p0, p0, Lcom/github/barteksc/pdfviewer/PagesLoader;->pdfView:Lcom/github/barteksc/pdfviewer/PDFView;
    ...
    .line 105
    invoke-static {p0}, Lcom/github/barteksc/pdfviewer/util/MathUtils;->ceil(F)I

    move-result p0

    iput p0, p1, Lcom/github/barteksc/pdfviewer/PagesLoader$GridSize;->rows:I
    ...
    iput p0, p1, Lcom/github/barteksc/pdfviewer/PagesLoader$GridSize;->cols:I
...
.method private getRenderRangeList(FFFF)Ljava/util/List;
    ...
    invoke-virtual {v14, v11, v15}, Lcom/github/barteksc/pdfviewer/PdfFile;->getScaledPageSize(IF)Landroid/util/SizeF;
    ...
    invoke-virtual {v1, v9, v2}, Lcom/github/barteksc/pdfviewer/PdfFile;->getScaledPageSize(IF)Landroid/util/SizeF;
    ...
    invoke-virtual {v9, v11, v1}, Lcom/github/barteksc/pdfviewer/PdfFile;->getSecondaryPageOffset(IF)F
    ...
    iget v2, v12, Lcom/github/barteksc/pdfviewer/PagesLoader$RenderRange;->page:I
    ...
    iput v1, v9, Lcom/github/barteksc/pdfviewer/PagesLoader$Holder;->row:I

    .line 209
    iget-object v1, v12, Lcom/github/barteksc/pdfviewer/PagesLoader$RenderRange;->leftTop:Lcom/github/barteksc/pdfviewer/PagesLoader$Holder;

    sub-float v13, v13, p3

    const/4 v2, 0x0

    invoke-static {v13, v2}, Lcom/github/barteksc/pdfviewer/util/MathUtils;->min(FF)F
    ...
    iput v2, v1, Lcom/github/barteksc/pdfviewer/PagesLoader$Holder;->col:I
    ...
    iget v3, v12, Lcom/github/barteksc/pdfviewer/PagesLoader$RenderRange;->page:I
    ...
    invoke-virtual {v2, v3, v9}, Lcom/github/barteksc/pdfviewer/PdfFile;->getPageOffset(IF)F
    ...
    invoke-static {v14, v2}, Lcom/github/barteksc/pdfviewer/util/MathUtils;->min(FF)F
    ...
    invoke-static {v2}, Lcom/github/barteksc/pdfviewer/util/MathUtils;->floor(F)I
    ...
    invoke-static {v15, v2}, Lcom/github/barteksc/pdfviewer/util/MathUtils;->min(FF)F
    ...
    invoke-static {v2, v3}, Lcom/github/barteksc/pdfviewer/util/MathUtils;->min(FF)F
...
.method private loadCell(IIIFF)Z
    ...
    invoke-virtual {v1, v8, v11, v2}, Lcom/github/barteksc/pdfviewer/CacheManager;->upPartIfContained(ILandroid/graphics/RectF;I)Z
...
.method private loadThumbnail(I)V
    ...
    invoke-virtual {p0}, Lcom/github/barteksc/pdfviewer/PDFView;->isAnnotationRendering()Z
...
.method private loadVisible()V
    ...
    .line 244
    sget p0, Lcom/github/barteksc/pdfviewer/util/Constants$Cache;->CACHE_SIZE:I
