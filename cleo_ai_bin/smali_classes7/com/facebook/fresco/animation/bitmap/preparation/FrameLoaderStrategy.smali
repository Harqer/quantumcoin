...
.method private final calculateFrameSize(II)Lcom/facebook/fresco/animation/bitmap/preparation/FrameSize;
    ...
    iget p0, p0, Lcom/facebook/fresco/animation/bitmap/preparation/FrameLoaderStrategy;->animationHeight:I

    invoke-direct {p1, p2, p0}, Lcom/facebook/fresco/animation/bitmap/preparation/FrameSize;-><init>(II)V
    ...
    invoke-direct {p1, v0, p0}, Lcom/facebook/fresco/animation/bitmap/preparation/FrameSize;-><init>(II)V
...
.method private final getFrameLoader()Lcom/facebook/fresco/animation/bitmap/preparation/ondemandanimation/FrameLoader;
    ...
    .line 40
    :cond_0
    iget-object p0, p0, Lcom/facebook/fresco/animation/bitmap/preparation/FrameLoaderStrategy;->frameLoader:Lcom/facebook/fresco/animation/bitmap/preparation/ondemandanimation/FrameLoader;
...
.method public getBitmapFrame(III)Lcom/facebook/common/references/CloseableReference;
    ...
    iget-object p0, p0, Lcom/facebook/fresco/animation/bitmap/preparation/FrameLoaderStrategy;->dynamicFpsRender:Lcom/facebook/fresco/animation/bitmap/preparation/FrameLoaderStrategy$dynamicFpsRender$1;

    check-cast p0, Lcom/facebook/fresco/animation/bitmap/preparation/ondemandanimation/DynamicRenderingFps;

    invoke-virtual {p2, p0, p1}, Lcom/facebook/fresco/animation/bitmap/preparation/ondemandanimation/AnimationCoordinator;->onRenderFrame(Lcom/facebook/fresco/animation/bitmap/preparation/ondemandanimation/DynamicRenderingFps;Lcom/facebook/fresco/animation/bitmap/preparation/ondemandanimation/FrameResult;)V
...
.method public prepareFrames(IILkotlin/jvm/functions/Function0;)V
    ...
    :cond_1
    invoke-interface {p0, p2, p1, p3}, Lcom/facebook/fresco/animation/bitmap/preparation/ondemandanimation/FrameLoader;->prepareFrames(IILkotlin/jvm/functions/Function0;)V
