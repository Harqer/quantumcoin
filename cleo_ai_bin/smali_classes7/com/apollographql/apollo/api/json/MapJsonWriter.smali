...
.method public beginArray()Lcom/apollographql/apollo/api/json/JsonWriter;
    ...
    .line 51
    check-cast p0, Lcom/apollographql/apollo/api/json/JsonWriter;
...
.method public getPath()Ljava/lang/String;
    ...
    .line 152
    iget-object p0, p0, Lcom/apollographql/apollo/api/json/MapJsonWriter;->stack:Ljava/util/List;
    ...
    .line 195
    check-cast v1, Lcom/apollographql/apollo/api/json/MapJsonWriter$State;

    .line 154
    instance-of v2, v1, Lcom/apollographql/apollo/api/json/MapJsonWriter$State$List;

    if-eqz v2, :cond_0

    check-cast v1, Lcom/apollographql/apollo/api/json/MapJsonWriter$State$List;

    invoke-virtual {v1}, Lcom/apollographql/apollo/api/json/MapJsonWriter$State$List;->getList()Ljava/util/List;
    ...
    .line 155
    :cond_0
    instance-of v2, v1, Lcom/apollographql/apollo/api/json/MapJsonWriter$State$Map;

    if-eqz v2, :cond_2

    check-cast v1, Lcom/apollographql/apollo/api/json/MapJsonWriter$State$Map;

    invoke-virtual {v1}, Lcom/apollographql/apollo/api/json/MapJsonWriter$State$Map;->getName()Ljava/lang/String;
...
.method public final root()Ljava/lang/Object;
    ...
    .line 48
    iget-object p0, p0, Lcom/apollographql/apollo/api/json/MapJsonWriter;->root:Ljava/lang/Object;
