...
.method public final startScan()Lcom/google/android/gms/tasks/Task;
    ...
    const-string v0, "Code scanner module is not supported on current Google Play Services version, please upgrade."
    ...
    iget-object p0, v2, Lcom/google/mlkit/vision/codescanner/internal/zze;->zze:Landroid/content/Context;
    ...
    new-array v0, v0, [Lcom/google/android/gms/common/api/OptionalModuleApi;

    const/4 v1, 0x0

    sget-object v3, Lcom/google/mlkit/vision/codescanner/internal/zzc;->zza:Lcom/google/mlkit/vision/codescanner/internal/zzc;
    ...
    new-instance v0, Lcom/google/mlkit/vision/codescanner/internal/zzd;

    invoke-direct {v0, v2}, Lcom/google/mlkit/vision/codescanner/internal/zzd;-><init>(Lcom/google/mlkit/vision/codescanner/internal/zze;)V
...
.method final synthetic zza(Lcom/google/android/gms/common/moduleinstall/ModuleAvailabilityResponse;)Lcom/google/android/gms/tasks/Task;
    ...
    sget-object p0, Lcom/google/mlkit/vision/codescanner/internal/zze;->zza:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {v1, v3}, Lcom/google/android/gms/tasks/TaskCompletionSource;-><init>(Lcom/google/android/gms/tasks/CancellationToken;)V
    ...
    const-string v0, "extra_supported_formats"

    iget-object v3, v2, Lcom/google/mlkit/vision/codescanner/internal/zze;->zzf:Lcom/google/mlkit/vision/codescanner/GmsBarcodeScannerOptions;

    .line 20
    invoke-virtual {v3}, Lcom/google/mlkit/vision/codescanner/GmsBarcodeScannerOptions;->zza()I

    move-result v3

    invoke-virtual {p0, v0, v3}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;

    const-string v0, "extra_allow_manual_input"

    iget-object v3, v2, Lcom/google/mlkit/vision/codescanner/internal/zze;->zzf:Lcom/google/mlkit/vision/codescanner/GmsBarcodeScannerOptions;

    .line 21
    invoke-virtual {v3}, Lcom/google/mlkit/vision/codescanner/GmsBarcodeScannerOptions;->zzc()Z

    move-result v3

    invoke-virtual {p0, v0, v3}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;

    const-string v0, "extra_enable_auto_zoom"

    iget-object v3, v2, Lcom/google/mlkit/vision/codescanner/internal/zze;->zzf:Lcom/google/mlkit/vision/codescanner/GmsBarcodeScannerOptions;

    .line 22
    invoke-virtual {v3}, Lcom/google/mlkit/vision/codescanner/GmsBarcodeScannerOptions;->zzb()Z
