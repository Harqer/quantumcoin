...
.method public constructor <init>(Ljava/util/Set;Lcom/nimbusds/jwt/JWTClaimsSet;Ljava/util/Set;Ljava/util/Set;)V
    ...
    .line 214
    invoke-static {p1}, Lcom/nimbusds/jose/util/CollectionUtils;->containsNull(Ljava/util/Set;)Z
...
.method public verify(Lcom/nimbusds/jwt/JWTClaimsSet;Lcom/nimbusds/jose/proc/SecurityContext;)V
    ...
    .line 294
    iget-object v1, p0, Lcom/nimbusds/jwt/proc/DefaultJWTClaimsVerifier;->acceptedAudienceValues:Ljava/util/Set;
    ...
    const-string p1, "JWT aud claim rejected"
    ...
    invoke-static {p2}, Lcom/nimbusds/jose/util/CollectionUtils;->containsNull(Ljava/util/Set;)Z
    ...
    const-string p1, "JWT missing required aud claim"
    ...
    const-string p2, " claim value rejected"
    ...
    .line 342
    :cond_9
    new-instance p0, Lcom/nimbusds/jwt/proc/ExpiredJWTException;

    const-string p1, "Expired JWT"

    invoke-direct {p0, p1}, Lcom/nimbusds/jwt/proc/ExpiredJWTException;-><init>(Ljava/lang/String;)V
