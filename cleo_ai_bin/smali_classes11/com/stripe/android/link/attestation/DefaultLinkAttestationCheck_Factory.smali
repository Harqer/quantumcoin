...
.method private constructor <init>(Ldagger/internal/Provider;Ldagger/internal/Provider;Ldagger/internal/Provider;Ldagger/internal/Provider;Ldagger/internal/Provider;Ldagger/internal/Provider;)V
    ...
    .line 52
    iput-object p2, p0, Lcom/stripe/android/link/attestation/DefaultLinkAttestationCheck_Factory;->integrityRequestManagerProvider:Ldagger/internal/Provider;

    .line 53
    iput-object p3, p0, Lcom/stripe/android/link/attestation/DefaultLinkAttestationCheck_Factory;->linkAccountManagerProvider:Ldagger/internal/Provider;

    .line 54
    iput-object p4, p0, Lcom/stripe/android/link/attestation/DefaultLinkAttestationCheck_Factory;->linkConfigurationProvider:Ldagger/internal/Provider;

    .line 55
    iput-object p5, p0, Lcom/stripe/android/link/attestation/DefaultLinkAttestationCheck_Factory;->errorReporterProvider:Ldagger/internal/Provider;

    .line 56
    iput-object p6, p0, Lcom/stripe/android/link/attestation/DefaultLinkAttestationCheck_Factory;->workContextProvider:Ldagger/internal/Provider;

    return-void
.end method

.method public static create(Ldagger/internal/Provider;Ldagger/internal/Provider;Ldagger/internal/Provider;Ldagger/internal/Provider;Ldagger/internal/Provider;Ldagger/internal/Provider;)Lcom/stripe/android/link/attestation/DefaultLinkAttestationCheck_Factory;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct/range {v0 .. v6}, Lcom/stripe/android/link/attestation/DefaultLinkAttestationCheck_Factory;-><init>(Ldagger/internal/Provider;Ldagger/internal/Provider;Ldagger/internal/Provider;Ldagger/internal/Provider;Ldagger/internal/Provider;Ldagger/internal/Provider;)V

    return-object v0
.end method

.method public static newInstance(Lcom/stripe/android/link/gate/LinkGate;Lcom/stripe/attestation/IntegrityRequestManager;Lcom/stripe/android/link/account/LinkAccountManager;Lcom/stripe/android/link/LinkConfiguration;Lcom/stripe/android/payments/core/analytics/ErrorReporter;Lkotlin/coroutines/CoroutineContext;)Lcom/stripe/android/link/attestation/DefaultLinkAttestationCheck;
    .locals 7
    ...
    invoke-direct/range {v0 .. v6}, Lcom/stripe/android/link/attestation/DefaultLinkAttestationCheck;-><init>(Lcom/stripe/android/link/gate/LinkGate;Lcom/stripe/attestation/IntegrityRequestManager;Lcom/stripe/android/link/account/LinkAccountManager;Lcom/stripe/android/link/LinkConfiguration;Lcom/stripe/android/payments/core/analytics/ErrorReporter;Lkotlin/coroutines/CoroutineContext;)V
...
.method public get()Lcom/stripe/android/link/attestation/DefaultLinkAttestationCheck;
    ...
    iget-object p0, p0, Lcom/stripe/android/link/attestation/DefaultLinkAttestationCheck_Factory;->workContextProvider:Ldagger/internal/Provider;
    ...
    invoke-static/range {v1 .. v6}, Lcom/stripe/android/link/attestation/DefaultLinkAttestationCheck_Factory;->newInstance(Lcom/stripe/android/link/gate/LinkGate;Lcom/stripe/attestation/IntegrityRequestManager;Lcom/stripe/android/link/account/LinkAccountManager;Lcom/stripe/android/link/LinkConfiguration;Lcom/stripe/android/payments/core/analytics/ErrorReporter;Lkotlin/coroutines/CoroutineContext;)Lcom/stripe/android/link/attestation/DefaultLinkAttestationCheck;
