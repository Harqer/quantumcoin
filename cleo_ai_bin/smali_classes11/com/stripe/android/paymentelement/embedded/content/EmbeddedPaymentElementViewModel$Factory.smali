...
.method public create(Lkotlin/reflect/KClass;Landroidx/lifecycle/viewmodel/CreationExtras;)Landroidx/lifecycle/ViewModel;
    ...
    .line 39
    iget-object p0, p0, Lcom/stripe/android/paymentelement/embedded/content/EmbeddedPaymentElementViewModel$Factory;->statusBarColor:Ljava/lang/Integer;

    .line 35
    invoke-interface {p1, v0, p2, v1, p0}, Lcom/stripe/android/paymentelement/embedded/content/EmbeddedPaymentElementViewModelComponent$Factory;->build(Landroidx/lifecycle/SavedStateHandle;Landroid/app/Application;Ljava/lang/String;Ljava/lang/Integer;)Lcom/stripe/android/paymentelement/embedded/content/EmbeddedPaymentElementViewModelComponent;

    move-result-object p0

    .line 42
    invoke-interface {p0}, Lcom/stripe/android/paymentelement/embedded/content/EmbeddedPaymentElementViewModelComponent;->getViewModel()Lcom/stripe/android/paymentelement/embedded/content/EmbeddedPaymentElementViewModel;

    move-result-object p0

    const-string p1, "null cannot be cast to non-null type T of com.stripe.android.paymentelement.embedded.content.EmbeddedPaymentElementViewModel.Factory.create"
