...
# direct methods
.method public static synthetic $r8$lambda$EmxJ5_K4AOgwQ2LEPa9MOrGHOhk()Lkotlinx/serialization/KSerializer;
    .locals 1

    invoke-static {}, Lcom/stripe/android/financialconnections/model/Balance$Type;->_init_$_anonymous_()Lkotlinx/serialization/KSerializer;
...
.method private static final synthetic $values()[Lcom/stripe/android/financialconnections/model/Balance$Type;
    ...
    sget-object v0, Lcom/stripe/android/financialconnections/model/Balance$Type;->CASH:Lcom/stripe/android/financialconnections/model/Balance$Type;
    ...
    filled-new-array {v0, v1, v2}, [Lcom/stripe/android/financialconnections/model/Balance$Type;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v3, v1, v2}, Lcom/stripe/android/financialconnections/model/Balance$Type;-><init>(Ljava/lang/String;ILjava/lang/String;)V
    ...
    sput-object v0, Lcom/stripe/android/financialconnections/model/Balance$Type;->$ENTRIES:Lkotlin/enums/EnumEntries;

    new-instance v0, Lcom/stripe/android/financialconnections/model/Balance$Type$Companion;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lcom/stripe/android/financialconnections/model/Balance$Type$Companion;-><init>(Lkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    new-instance v1, Lcom/stripe/android/financialconnections/model/Balance$Type$$ExternalSyntheticLambda0;

    invoke-direct {v1}, Lcom/stripe/android/financialconnections/model/Balance$Type$$ExternalSyntheticLambda0;-><init>()V

    invoke-static {v0, v1}, Lkotlin/LazyKt;->lazy(Lkotlin/LazyThreadSafetyMode;Lkotlin/jvm/functions/Function0;)Lkotlin/Lazy;

    move-result-object v0

    sput-object v0, Lcom/stripe/android/financialconnections/model/Balance$Type;->$cachedSerializer$delegate:Lkotlin/Lazy;
...
.method public static final synthetic access$get$cachedSerializer$delegate$cp()Lkotlin/Lazy;
    ...
    .line 47
    sget-object v0, Lcom/stripe/android/financialconnections/model/Balance$Type;->$cachedSerializer$delegate:Lkotlin/Lazy;
...
.method public static getEntries()Lkotlin/enums/EnumEntries;
    ...
    sget-object v0, Lcom/stripe/android/financialconnections/model/Balance$Type;->$ENTRIES:Lkotlin/enums/EnumEntries;
...
.method public final getValue()Ljava/lang/String;
    ...
    .line 48
    iget-object p0, p0, Lcom/stripe/android/financialconnections/model/Balance$Type;->value:Ljava/lang/String;
