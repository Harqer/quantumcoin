...
.method private isHalfPrecisionEnough(F)Z
    ...
    .line 98
    invoke-virtual {p0, v0}, Lco/nstant/in/cbor/decoder/HalfPrecisionFloatDecoder;->decode(I)Lco/nstant/in/cbor/model/HalfPrecisionFloat;

    move-result-object p0

    .line 99
    invoke-virtual {p0}, Lco/nstant/in/cbor/model/HalfPrecisionFloat;->getValue()F
...
.method protected convert(D)Lco/nstant/in/cbor/model/DataItem;
    ...
    .line 80
    new-instance p0, Lco/nstant/in/cbor/model/DoublePrecisionFloat;

    invoke-direct {p0, p1, p2}, Lco/nstant/in/cbor/model/DoublePrecisionFloat;-><init>(D)V
...
.method protected convert(F)Lco/nstant/in/cbor/model/DataItem;
    ...
    .line 73
    new-instance p0, Lco/nstant/in/cbor/model/HalfPrecisionFloat;

    invoke-direct {p0, p1}, Lco/nstant/in/cbor/model/HalfPrecisionFloat;-><init>(F)V

    return-object p0

    .line 75
    :cond_0
    new-instance p0, Lco/nstant/in/cbor/model/SinglePrecisionFloat;

    invoke-direct {p0, p1}, Lco/nstant/in/cbor/model/SinglePrecisionFloat;-><init>(F)V
...
.method protected convert(J)Lco/nstant/in/cbor/model/DataItem;
    ...
    .line 41
    new-instance p0, Lco/nstant/in/cbor/model/UnsignedInteger;

    invoke-direct {p0, p1, p2}, Lco/nstant/in/cbor/model/UnsignedInteger;-><init>(J)V

    return-object p0

    .line 43
    :cond_0
    new-instance p0, Lco/nstant/in/cbor/model/NegativeInteger;

    invoke-direct {p0, p1, p2}, Lco/nstant/in/cbor/model/NegativeInteger;-><init>(J)V
...
.method protected convert(Ljava/math/BigInteger;)Lco/nstant/in/cbor/model/DataItem;
    ...
    invoke-direct {p0, p1}, Lco/nstant/in/cbor/model/NegativeInteger;-><init>(Ljava/math/BigInteger;)V
    ...
    invoke-direct {p0, p1}, Lco/nstant/in/cbor/model/UnsignedInteger;-><init>(Ljava/math/BigInteger;)V
...
.method protected getHalfPrecisionFloatDecoder(Ljava/io/InputStream;)Lco/nstant/in/cbor/decoder/HalfPrecisionFloatDecoder;
    ...
    .line 110
    new-instance p0, Lco/nstant/in/cbor/decoder/HalfPrecisionFloatDecoder;

    const/4 v0, 0x0

    invoke-direct {p0, v0, p1}, Lco/nstant/in/cbor/decoder/HalfPrecisionFloatDecoder;-><init>(Lco/nstant/in/cbor/CborDecoder;Ljava/io/InputStream;)V
...
.method protected getHalfPrecisionFloatEncoder(Ljava/io/OutputStream;)Lco/nstant/in/cbor/encoder/HalfPrecisionFloatEncoder;
    ...
    .line 106
    new-instance p0, Lco/nstant/in/cbor/encoder/HalfPrecisionFloatEncoder;

    const/4 v0, 0x0

    invoke-direct {p0, v0, p1}, Lco/nstant/in/cbor/encoder/HalfPrecisionFloatEncoder;-><init>(Lco/nstant/in/cbor/CborEncoder;Ljava/io/OutputStream;)V
...
.method protected tag(J)Lco/nstant/in/cbor/model/Tag;
    ...
    .line 84
    new-instance p0, Lco/nstant/in/cbor/model/Tag;

    invoke-direct {p0, p1, p2}, Lco/nstant/in/cbor/model/Tag;-><init>(J)V
