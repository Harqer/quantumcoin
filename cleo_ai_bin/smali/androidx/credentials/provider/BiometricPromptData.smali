...
.method public constructor <init>(Landroidx/biometric/BiometricPrompt$CryptoObject;IZ)V
    ...
    .line 114
    sget-object p0, Landroidx/credentials/provider/BiometricPromptData;->ALLOWED_AUTHENTICATOR_VALUES:Ljava/util/Set;
    ...
    const-string p1, "The allowed authenticator must be specified according to the BiometricPrompt spec."
    ...
    invoke-static {p0, p1}, Landroidx/credentials/provider/BiometricPromptData$Companion;->access$isStrongAuthenticationType(Landroidx/credentials/provider/BiometricPromptData$Companion;Ljava/lang/Integer;)Z
    ...
    const-string p1, "If the cryptoObject is non-null, the allowedAuthenticator value must be Authenticators.BIOMETRIC_STRONG."
