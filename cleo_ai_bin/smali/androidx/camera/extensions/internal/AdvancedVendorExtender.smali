...
.method public constructor <init>(I)V
    ...
    const-string p1, "Should not active ExtensionMode.NONE"
    ...
    const-string p1, "AdvancedExtenderImpl does not exist"
...
.method private getSupportedParameterKeys()Ljava/util/List;
    ...
    .line 183
    :try_start_0
    iget-object p0, p0, Landroidx/camera/extensions/internal/AdvancedVendorExtender;->mAdvancedExtenderImpl:Landroidx/camera/extensions/impl/advanced/AdvancedExtenderImpl;

    invoke-interface {p0}, Landroidx/camera/extensions/impl/advanced/AdvancedExtenderImpl;->getAvailableCaptureRequestKeys()Ljava/util/List;
...
.method public getAvailableCharacteristicsKeyValues()Ljava/util/List;
    ...
    invoke-interface {p0}, Landroidx/camera/extensions/impl/advanced/AdvancedExtenderImpl;->getAvailableCharacteristicsKeyValues()Ljava/util/List;
    ...
    const-string v1, "Failed to retrieve available characteristics key-values!"
...
.method public getEstimatedCaptureLatencyRange(Landroid/util/Size;)Landroid/util/Range;
    ...
    iget-object p0, p0, Landroidx/camera/extensions/internal/AdvancedVendorExtender;->mCameraId:Ljava/lang/String;

    const/16 v1, 0x100

    invoke-interface {v0, p0, p1, v1}, Landroidx/camera/extensions/impl/advanced/AdvancedExtenderImpl;->getEstimatedCaptureLatencyRange(Ljava/lang/String;Landroid/util/Size;I)Landroid/util/Range;
    ...
    .line 129
    const-string p1, "AdvancedVendorExtender"

    const-string v0, "AdvancedExtenderImpl.getEstimatedCaptureLatencyRange throws exceptions"
...
.method public getSupportedCaptureOutputResolutions()Ljava/util/List;
    ...
    const-string v1, "AdvancedExtenderImpl.getSupportedCaptureOutputResolutions throws exceptions"
...
.method public getSupportedCaptureResultKeys()Ljava/util/List;
    ...
    .line 199
    invoke-interface {p0}, Landroidx/camera/extensions/impl/advanced/AdvancedExtenderImpl;->getAvailableCaptureResultKeys()Ljava/util/List;
    ...
    const-string v1, "AdvancedExtenderImpl.getAvailableCaptureResultKeys throws exceptions"
...
.method public getSupportedPostviewResolutions(Landroid/util/Size;)Ljava/util/Map;
    ...
    .line 215
    invoke-interface {p0, p1}, Landroidx/camera/extensions/impl/advanced/AdvancedExtenderImpl;->getSupportedPostviewResolutions(Landroid/util/Size;)Ljava/util/Map;
    ...
    const-string v0, "AdvancedExtenderImpl.getSupportedPostviewResolutions throws exceptions"
...
.method public getSupportedPreviewOutputResolutions()Ljava/util/List;
    ...
    const-string v1, "AdvancedExtenderImpl.getSupportedPreviewOutputResolutions throws exceptions"
...
.method public init(Landroidx/camera/core/CameraInfo;)V
    ...
    invoke-interface {v0, p0, p1}, Landroidx/camera/extensions/impl/advanced/AdvancedExtenderImpl;->init(Ljava/lang/String;Ljava/util/Map;)V
...
.method public isCaptureProcessProgressAvailable()Z
    ...
    invoke-interface {p0}, Landroidx/camera/extensions/impl/advanced/AdvancedExtenderImpl;->isCaptureProcessProgressAvailable()Z
    ...
    const-string v1, "AdvancedExtenderImpl.isCaptureProcessProgressAvailable throws exceptions"
...
.method public isExtensionAvailable(Ljava/lang/String;Ljava/util/Map;)Z
    ...
    invoke-interface {p0, p1, p2}, Landroidx/camera/extensions/impl/advanced/AdvancedExtenderImpl;->isExtensionAvailable(Ljava/lang/String;Ljava/util/Map;)Z
...
.method public isPostviewAvailable()Z
    ...
    invoke-interface {p0}, Landroidx/camera/extensions/impl/advanced/AdvancedExtenderImpl;->isPostviewAvailable()Z
    ...
    const-string v1, "AdvancedExtenderImpl.isPostviewAvailable throws exceptions"
