...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 21
    const-string p0, "broadcast received for message"
    ...
    .line 26
    const-string p0, "broadcast intent received with no extras"
    ...
    invoke-direct {p0, p2}, Lcom/google/firebase/messaging/RemoteMessage;-><init>(Landroid/os/Bundle;)V
    ...
    .line 36
    invoke-virtual {v1}, Lio/invertase/firebase/messaging/ReactNativeFirebaseMessagingStoreHelper;->getMessagingStore()Lio/invertase/firebase/messaging/ReactNativeFirebaseMessagingStore;

    move-result-object v1

    .line 37
    invoke-interface {v1, p0}, Lio/invertase/firebase/messaging/ReactNativeFirebaseMessagingStore;->storeFirebaseMessage(Lcom/google/firebase/messaging/RemoteMessage;)V
    ...
    invoke-static {p0, p1}, Lio/invertase/firebase/messaging/ReactNativeFirebaseMessagingSerializer;->remoteMessageToEvent(Lcom/google/firebase/messaging/RemoteMessage;Ljava/lang/Boolean;)Lio/invertase/firebase/common/ReactNativeFirebaseEvent;

    move-result-object p0

    .line 44
    invoke-virtual {p2, p0}, Lio/invertase/firebase/common/ReactNativeFirebaseEventEmitter;->sendEvent(Lio/invertase/firebase/interfaces/NativeEvent;)V
    ...
    .line 63
    const-string p1, "Background messages only work if the message priority is set to \'high\'"
