...
.method public loadFilesInDirectory(Ljava/io/File;Ljava/lang/Class;Lio/intercom/android/sdk/persistence/JsonStorage$LoadHandler;Lio/intercom/android/sdk/persistence/JsonStorage$LoadFailureHandler;)V
    ...
    .line 59
    :try_start_1
    iget-object v2, p0, Lio/intercom/android/sdk/persistence/JsonStorage;->gson:Lcom/google/gson/Gson;

    invoke-virtual {v2, v5, p2}, Lcom/google/gson/Gson;->fromJson(Ljava/io/Reader;Ljava/lang/Class;)Ljava/lang/Object;
    ...
    :goto_1
    :try_start_2
    invoke-interface {p4, v4, v2}, Lio/intercom/android/sdk/persistence/JsonStorage$LoadFailureHandler;->onLoadFailed(Ljava/io/File;Ljava/lang/Exception;)V
    :try_end_2
...
.method public loadThenDelete(Ljava/io/File;Ljava/lang/Class;Lio/intercom/android/sdk/persistence/JsonStorage$LoadHandler;)V
    ...
    .line 33
    :try_start_1
    iget-object p0, p0, Lio/intercom/android/sdk/persistence/JsonStorage;->gson:Lcom/google/gson/Gson;

    invoke-virtual {p0, v1, p2}, Lcom/google/gson/Gson;->fromJson(Ljava/io/Reader;Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object p0

    invoke-interface {p3, p0}, Lio/intercom/android/sdk/persistence/JsonStorage$LoadHandler;->onLoad(Ljava/lang/Object;)V
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_0
...
.method public saveToFileAsJson(Ljava/lang/Object;Ljava/io/File;)V
    ...
    const-string v0, "Couldn\'t create missing parent dir at "

    const-string v1, "Couldn\'t delete existing file at "
    ...
    :goto_2
    :try_start_2
    sget-object p1, Lio/intercom/android/sdk/persistence/JsonStorage;->TWIG:Lcom/intercom/twig/Twig;
