...
.method constructor <init>(Lio/intercom/android/sdk/Provider;Lio/intercom/android/sdk/Provider;Ljava/util/concurrent/Executor;Lio/intercom/android/sdk/persistence/JsonStorage;Ljava/io/File;Ljava/io/File;ZLjava/lang/String;Lcom/intercom/twig/Twig;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method static synthetic access$800(Lio/intercom/android/sdk/metrics/MetricsStore;)Lcom/intercom/twig/Twig;
    .locals 0
...
.method private getFile(Lio/intercom/android/sdk/metrics/MetricObject;)Ljava/io/File;
    ...
    iget-object p0, p0, Lio/intercom/android/sdk/metrics/MetricsStore;->metricsDir:Ljava/io/File;
...
.method private getFile(Lio/intercom/android/sdk/metrics/ops/OpsMetricObject;)Ljava/io/File;
    ...
    iget-object p0, p0, Lio/intercom/android/sdk/metrics/MetricsStore;->opsMetricsDir:Ljava/io/File;
...
.method private hasReachedMetricStorageLimit()Z
    ...
    invoke-virtual {v0, p0}, Lio/intercom/android/sdk/persistence/JsonStorage;->getDirectoryFileCount(Ljava/io/File;)I
...
.method private isDisabled()Z
    ...
    .line 99
    iget-object p0, p0, Lio/intercom/android/sdk/metrics/MetricsStore;->appConfigProvider:Lio/intercom/android/sdk/Provider;
    ...
    invoke-virtual {p0}, Lio/intercom/android/sdk/identity/AppConfig;->isMetricsEnabled()Z
...
.method private uploadMetrics(Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-virtual {v0, p1, p2, v1}, Lio/intercom/android/sdk/api/Api;->sendMetrics(Ljava/util/List;Ljava/util/List;Lretrofit2/Callback;)V
...
.method loadMetrics()Ljava/util/List;
    ...
    iget-object p0, p0, Lio/intercom/android/sdk/metrics/MetricsStore;->deleteOnFailureHandler:Lio/intercom/android/sdk/persistence/JsonStorage$LoadFailureHandler;

    invoke-virtual {v1, v2, v3, v4, p0}, Lio/intercom/android/sdk/persistence/JsonStorage;->loadFilesInDirectory(Ljava/io/File;Ljava/lang/Class;Lio/intercom/android/sdk/persistence/JsonStorage$LoadHandler;Lio/intercom/android/sdk/persistence/JsonStorage$LoadFailureHandler;)V
