.class public final Lio/intercom/android/sdk/m5/components/TeamPresenceRowKt;
...
# direct methods
.method public static synthetic $r8$lambda$5Rn0AJV7y_opvTKdFRBOY55Zn-w(Landroidx/compose/ui/Modifier;Ljava/util/List;IILandroidx/compose/runtime/Composer;I)Lkotlin/Unit;
    .locals 0

    invoke-static/range {p0 .. p5}, Lio/intercom/android/sdk/m5/components/TeamPresenceRowKt;->TeamPresenceRow$lambda$1(Landroidx/compose/ui/Modifier;Ljava/util/List;IILandroidx/compose/runtime/Composer;I)Lkotlin/Unit;
...
.method public static synthetic $r8$lambda$gyZac6dL4TmOAY2uA33hw29_RN4(ILandroidx/compose/runtime/Composer;I)Lkotlin/Unit;
    .locals 0

    invoke-static {p0, p1, p2}, Lio/intercom/android/sdk/m5/components/TeamPresenceRowKt;->TeamPresenceRowPreview$lambda$2(ILandroidx/compose/runtime/Composer;I)Lkotlin/Unit;
...
.method public static final TeamPresenceRow(Landroidx/compose/ui/Modifier;Ljava/util/List;Landroidx/compose/runtime/Composer;II)V
    .locals 43
    ...
    const-string v7, "io.intercom.android.sdk.m5.components.TeamPresenceRow (TeamPresenceRow.kt:20)"

    invoke-static {v3, v6, v5, v7}, Landroidx/compose/runtime/ComposerKt;->traceEventStart(IIILjava/lang/String;)V
    ...
    .line 24
    invoke-static {v4, v3, v5}, Landroidx/compose/foundation/layout/PaddingKt;->padding-VpY3zN4(Landroidx/compose/ui/Modifier;FF)Landroidx/compose/ui/Modifier;

    move-result-object v3

    .line 25
    const-string v5, "team_presence_row"
    ...
    .line 64
    invoke-static {v6, v5, v9, v7}, Landroidx/compose/foundation/layout/RowKt;->rowMeasurePolicy(Landroidx/compose/foundation/layout/Arrangement$Horizontal;Landroidx/compose/ui/Alignment$Vertical;Landroidx/compose/runtime/Composer;I)Landroidx/compose/ui/layout/MeasurePolicy;
    ...
    invoke-virtual {v6, v9, v7}, Lio/intercom/android/sdk/ui/theme/IntercomTheme;->getTypography(Landroidx/compose/runtime/Composer;I)Lio/intercom/android/sdk/ui/theme/IntercomTypography;
    ...
    invoke-static {v8, v6, v11, v7}, Lio/intercom/android/sdk/utilities/ColorExtensionsKt;->toComposeColor$default(Ljava/lang/String;FILjava/lang/Object;)J
    ...
    new-instance v5, Lio/intercom/android/sdk/m5/components/TeamPresenceRowKt$$ExternalSyntheticLambda0;

    invoke-direct {v5, v3, v0, v1, v2}, Lio/intercom/android/sdk/m5/components/TeamPresenceRowKt$$ExternalSyntheticLambda0;-><init>(Landroidx/compose/ui/Modifier;Ljava/util/List;II)V
...
.method private static final TeamPresenceRow$lambda$1(Landroidx/compose/ui/Modifier;Ljava/util/List;IILandroidx/compose/runtime/Composer;I)Lkotlin/Unit;
    .locals 0
    ...
    invoke-static {p0, p1, p4, p2, p3}, Lio/intercom/android/sdk/m5/components/TeamPresenceRowKt;->TeamPresenceRow(Landroidx/compose/ui/Modifier;Ljava/util/List;Landroidx/compose/runtime/Composer;II)V
...
.method private static final TeamPresenceRowPreview(Landroidx/compose/runtime/Composer;I)V
    .locals 8
    .annotation runtime Lio/intercom/android/sdk/ui/IntercomPreviews;
    .end annotation

    const v0, 0x48336868    # 183713.62f
    ...
    const-string v1, "io.intercom.android.sdk.m5.components.TeamPresenceRowPreview (TeamPresenceRow.kt:42)"
    ...
    invoke-virtual {p0}, Lio/intercom/android/sdk/m5/components/ComposableSingletons$TeamPresenceRowKt;->getLambda-2$intercom_sdk_base_release()Lkotlin/jvm/functions/Function2;
    ...
    new-instance v0, Lio/intercom/android/sdk/m5/components/TeamPresenceRowKt$$ExternalSyntheticLambda1;

    invoke-direct {v0, p1}, Lio/intercom/android/sdk/m5/components/TeamPresenceRowKt$$ExternalSyntheticLambda1;-><init>(I)V
...
.method private static final TeamPresenceRowPreview$lambda$2(ILandroidx/compose/runtime/Composer;I)Lkotlin/Unit;
    .locals 0
    ...
    invoke-static {p1, p0}, Lio/intercom/android/sdk/m5/components/TeamPresenceRowKt;->TeamPresenceRowPreview(Landroidx/compose/runtime/Composer;I)V
