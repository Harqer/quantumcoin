...
.method private setRRWebEventDefaultsFrom(Lio/sentry/rrweb/RRWebBreadcrumbEvent;Lio/sentry/Breadcrumb;)V
    ...
    invoke-virtual {p1, p0}, Lio/sentry/rrweb/RRWebBreadcrumbEvent;->setLevel(Lio/sentry/SentryLevel;)V
    ...
    invoke-virtual {p1, p0}, Lio/sentry/rrweb/RRWebBreadcrumbEvent;->setData(Ljava/util/Map;)V
    ...
    invoke-virtual {p1, p0}, Lio/sentry/rrweb/RRWebBreadcrumbEvent;->setBreadcrumbType(Ljava/lang/String;)V
...
.method public convert(Lio/sentry/Breadcrumb;)Lio/sentry/rrweb/RRWebEvent;
    ...
    .line 45
    instance-of p1, p0, Lio/sentry/rrweb/RRWebBreadcrumbEvent;
    ...
    check-cast p1, Lio/sentry/rrweb/RRWebBreadcrumbEvent;

    .line 47
    invoke-virtual {p1}, Lio/sentry/rrweb/RRWebBreadcrumbEvent;->getCategory()Ljava/lang/String;
...
.method public convertNetworkBreadcrumb(Lio/sentry/Breadcrumb;)Lio/sentry/rrweb/RRWebEvent;
    ...
    .line 130
    const-string p0, "start_timestamp"

    invoke-virtual {p1, p0}, Lio/sentry/Breadcrumb;->getData(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-virtual {p1, v2}, Lio/sentry/Breadcrumb;->getData(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-virtual {p1, v3}, Lio/sentry/rrweb/RRWebSpanEvent;->setOp(Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v3, v4}, Lio/sentry/rrweb/RRWebSpanEvent;->setStartTimestamp(D)V
    ...
    invoke-virtual {p1, v3, v4}, Lio/sentry/rrweb/RRWebSpanEvent;->setEndTimestamp(D)V

    .line 165
    invoke-virtual {p1, v2}, Lio/sentry/rrweb/RRWebSpanEvent;->setDescription(Ljava/lang/String;)V

    .line 166
    invoke-virtual {p1, v1}, Lio/sentry/rrweb/RRWebSpanEvent;->setData(Ljava/util/Map;)V
