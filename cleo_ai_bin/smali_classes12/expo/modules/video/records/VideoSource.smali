...
.method public synthetic constructor <init>(Landroid/net/Uri;Lexpo/modules/video/records/DRMOptions;Lexpo/modules/video/records/VideoMetadata;Ljava/util/Map;ZLexpo/modules/video/enums/ContentType;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    .line 23
    :cond_5
    invoke-direct/range {p0 .. p6}, Lexpo/modules/video/records/VideoSource;-><init>(Landroid/net/Uri;Lexpo/modules/video/records/DRMOptions;Lexpo/modules/video/records/VideoMetadata;Ljava/util/Map;ZLexpo/modules/video/enums/ContentType;)V
...
.method private final parseLocalAssetId(Landroid/net/Uri;Landroid/content/Context;)Landroid/net/Uri;
    ...
    .line 96
    new-instance p0, Landroidx/media3/datasource/RawResourceDataSource;

    invoke-direct {p0, p2}, Landroidx/media3/datasource/RawResourceDataSource;-><init>(Landroid/content/Context;)V

    .line 97
    invoke-virtual {p0, v0}, Landroidx/media3/datasource/RawResourceDataSource;->open(Landroidx/media3/datasource/DataSpec;)J

    .line 98
    invoke-virtual {p0}, Landroidx/media3/datasource/RawResourceDataSource;->getUri()Landroid/net/Uri;
    ...
    .line 100
    const-string p2, "Error parsing local asset id, falling back to original uri"
...
.method private final toMediaId()Ljava/lang/String;
    ...
    .line 42
    :cond_7
    iget-object v0, v0, Lexpo/modules/video/records/VideoSource;->contentType:Lexpo/modules/video/enums/ContentType;

    invoke-virtual {v0}, Lexpo/modules/video/enums/ContentType;->getValue()Ljava/lang/String;
    ...
    const-string/jumbo v2, "}DRMHeadersValues:"
    ...
    const-string/jumbo v2, "}NotificationDataTitle:"
...
.method public final getContentType()Lexpo/modules/video/enums/ContentType;
    ...
    .line 29
    iget-object p0, p0, Lexpo/modules/video/records/VideoSource;->contentType:Lexpo/modules/video/enums/ContentType;
...
.method public final getDrm()Lexpo/modules/video/records/DRMOptions;
    ...
    .line 25
    iget-object p0, p0, Lexpo/modules/video/records/VideoSource;->drm:Lexpo/modules/video/records/DRMOptions;
...
.method public final getHeaders()Ljava/util/Map;
    ...
    .line 27
    iget-object p0, p0, Lexpo/modules/video/records/VideoSource;->headers:Ljava/util/Map;
...
.method public final getMetadata()Lexpo/modules/video/records/VideoMetadata;
    ...
    .line 26
    iget-object p0, p0, Lexpo/modules/video/records/VideoSource;->metadata:Lexpo/modules/video/records/VideoMetadata;
...
.method public final getUri()Landroid/net/Uri;
    ...
    .line 24
    iget-object p0, p0, Lexpo/modules/video/records/VideoSource;->uri:Landroid/net/Uri;
...
.method public final getUseCaching()Z
    ...
    .line 28
    iget-boolean p0, p0, Lexpo/modules/video/records/VideoSource;->useCaching:Z
...
.method public final toMediaItem(Landroid/content/Context;)Landroidx/media3/common/MediaItem;
    ...
    .line 61
    :cond_1
    new-instance p0, Lexpo/modules/video/UnsupportedDRMTypeException;

    invoke-virtual {p1}, Lexpo/modules/video/records/DRMOptions;->getType()Lexpo/modules/video/enums/DRMType;

    move-result-object p1

    invoke-direct {p0, p1}, Lexpo/modules/video/UnsupportedDRMTypeException;-><init>(Lexpo/modules/video/enums/DRMType;)V
    ...
    .line 67
    invoke-virtual {p0}, Lexpo/modules/video/records/VideoMetadata;->getTitle()Ljava/lang/String;

    move-result-object v1

    check-cast v1, Ljava/lang/CharSequence;

    invoke-virtual {p1, v1}, Landroidx/media3/common/MediaMetadata$Builder;->setTitle(Ljava/lang/CharSequence;)Landroidx/media3/common/MediaMetadata$Builder;

    .line 68
    invoke-virtual {p0}, Lexpo/modules/video/records/VideoMetadata;->getArtist()Ljava/lang/String;

    move-result-object v1

    check-cast v1, Ljava/lang/CharSequence;

    invoke-virtual {p1, v1}, Landroidx/media3/common/MediaMetadata$Builder;->setArtist(Ljava/lang/CharSequence;)Landroidx/media3/common/MediaMetadata$Builder;

    .line 69
    invoke-virtual {p0}, Lexpo/modules/video/records/VideoMetadata;->getArtwork()Landroid/net/Uri;
    ...
    .line 70
    invoke-virtual {p1, p0}, Landroidx/media3/common/MediaMetadata$Builder;->setArtworkUri(Landroid/net/Uri;)Landroidx/media3/common/MediaMetadata$Builder;
