...
.method public constructor <init>(Lexpo/modules/video/player/VideoPlayer;)V
    ...
    .line 36
    check-cast p0, Lexpo/modules/video/player/VideoPlayerListener;

    invoke-virtual {p1, p0}, Lexpo/modules/video/player/VideoPlayer;->addListener(Lexpo/modules/video/player/VideoPlayerListener;)V
...
.method private final applyAudioTrack(Lexpo/modules/video/records/AudioTrack;)V
    ...
    invoke-virtual {v1, v4}, Landroidx/media3/common/TrackSelectionParameters$Builder;->clearOverridesOfType(I)Landroidx/media3/common/TrackSelectionParameters$Builder;
    ...
    invoke-direct {v2, v5, p1}, Landroidx/media3/common/TrackSelectionOverride;-><init>(Landroidx/media3/common/TrackGroup;I)V
    ...
    .line 93
    invoke-virtual {p0, v4}, Lexpo/modules/video/player/VideoPlayerAudioTracks;->setAudioTracksEnabled(Z)V
...
.method private final findSelectedAudioFormat()Landroidx/media3/common/Format;
    ...
    const-string/jumbo v3, "trackIndices"
    ...
    .line 116
    iget-object p0, p0, Lexpo/modules/video/player/VideoPlayerAudioTracks;->formatsToGroups:Ljava/util/Map;
...
.method private final getVideoPlayer()Lexpo/modules/video/player/VideoPlayer;
    ...
    .line 20
    iget-object p0, p0, Lexpo/modules/video/player/VideoPlayerAudioTracks;->owner:Ljava/lang/ref/WeakReference;
...
.method public final getAvailableAudioTracks()Ljava/util/ArrayList;
    ...
    .line 33
    iget-object p0, p0, Lexpo/modules/video/player/VideoPlayerAudioTracks;->availableAudioTracks:Ljava/util/ArrayList;
...
.method public final getCurrentAudioTrack()Lexpo/modules/video/records/AudioTrack;
    ...
    iget-object p0, p0, Lexpo/modules/video/player/VideoPlayerAudioTracks;->currentAudioTrackFormat:Landroidx/media3/common/Format;

    invoke-virtual {v0, p0}, Lexpo/modules/video/records/AudioTrack$Companion;->fromFormat(Landroidx/media3/common/Format;)Lexpo/modules/video/records/AudioTrack;
...
.method public onTrackSelectionParametersChanged(Lexpo/modules/video/player/VideoPlayer;Landroidx/media3/common/TrackSelectionParameters;)V
    ...
    const-string/jumbo v0, "trackSelectionParameters"
...
.method public final setAudioTracksEnabled(Z)V
    ...
    invoke-interface {p0, v0}, Landroidx/media3/exoplayer/ExoPlayer;->setTrackSelectionParameters(Landroidx/media3/common/TrackSelectionParameters;)V
