...
.method private final assertModificationReleaseConditions()V
    ...
    invoke-virtual {p0}, Lexpo/modules/video/VideoManager;->hasRegisteredPlayers()Z
    ...
    .line 101
    const-string p0, "ExpoVideo"

    const-string v0, "Clearing cache on the main thread, this might cause performance issues"
    ...
    .line 97
    :cond_1
    new-instance p0, Lexpo/modules/video/VideoCacheException;

    const-string v0, "Cannot clear cache while there are active players"

    const/4 v1, 0x2

    const/4 v2, 0x0

    invoke-direct {p0, v0, v2, v1, v2}, Lexpo/modules/video/VideoCacheException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
...
.method private final getCacheDir()Ljava/io/File;
    ...
    const-string v2, "ExpoVideoCache"
...
.method private final getContext()Landroid/content/Context;
    ...
    .line 28
    iget-object p0, p0, Lexpo/modules/video/VideoCache;->weakContext:Ljava/lang/ref/WeakReference;
...
.method private final getFileSize(Ljava/io/File;)J
    ...
    new-instance p1, Lexpo/modules/video/VideoCache$$ExternalSyntheticLambda0;

    invoke-direct {p1}, Lexpo/modules/video/VideoCache$$ExternalSyntheticLambda0;-><init>()V
    ...
    new-instance p1, Lexpo/modules/video/VideoCache$$ExternalSyntheticLambda1;

    invoke-direct {p1}, Lexpo/modules/video/VideoCache$$ExternalSyntheticLambda1;-><init>()V
...
.method private final getMaxCacheSize()J
    ...
    .line 37
    iget-object p0, p0, Lexpo/modules/video/VideoCache;->sharedPreferences:Landroid/content/SharedPreferences;
...
.method public final getInstance()Landroidx/media3/datasource/cache/SimpleCache;
    ...
    .line 33
    iget-object p0, p0, Lexpo/modules/video/VideoCache;->instance:Landroidx/media3/datasource/cache/SimpleCache;
