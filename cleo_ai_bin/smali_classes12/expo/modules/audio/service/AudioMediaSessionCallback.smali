.class public final Lexpo/modules/audio/service/AudioMediaSessionCallback;
.super Ljava/lang/Object;
.source "AudioMediaSessionCallback.kt"
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lexpo/modules/audio/service/AudioMediaSessionCallback;",
...
.method public onConnect(Landroidx/media3/session/MediaSession;Landroidx/media3/session/MediaSession$ControllerInfo;)Landroidx/media3/session/MediaSession$ConnectionResult;
    ...
    .line 28
    invoke-virtual {p1, p2}, Landroidx/media3/common/Player$Commands$Builder;->remove(I)Landroidx/media3/common/Player$Commands$Builder;
    ...
    .line 21
    invoke-virtual {p0, p1}, Landroidx/media3/session/MediaSession$ConnectionResult$AcceptedResultBuilder;->setAvailablePlayerCommands(Landroidx/media3/common/Player$Commands;)Landroidx/media3/session/MediaSession$ConnectionResult$AcceptedResultBuilder;
    ...
    invoke-virtual {p1}, Landroidx/media3/session/SessionCommands;->buildUpon()Landroidx/media3/session/SessionCommands$Builder;

    move-result-object p1

    .line 36
    new-instance p2, Landroidx/media3/session/SessionCommand;

    const-string v0, "expo.modules.audio.action.SEEK_REWIND"

    sget-object v1, Landroid/os/Bundle;->EMPTY:Landroid/os/Bundle;

    invoke-direct {p2, v0, v1}, Landroidx/media3/session/SessionCommand;-><init>(Ljava/lang/String;Landroid/os/Bundle;)V

    invoke-virtual {p1, p2}, Landroidx/media3/session/SessionCommands$Builder;->add(Landroidx/media3/session/SessionCommand;)Landroidx/media3/session/SessionCommands$Builder;
    ...
    const-string v0, "expo.modules.audio.action.SEEK_FORWARD"
    ...
    .line 38
    invoke-virtual {p1}, Landroidx/media3/session/SessionCommands$Builder;->build()Landroidx/media3/session/SessionCommands;

    move-result-object p1

    .line 34
    invoke-virtual {p0, p1}, Landroidx/media3/session/MediaSession$ConnectionResult$AcceptedResultBuilder;->setAvailableSessionCommands(Landroidx/media3/session/SessionCommands;)Landroidx/media3/session/MediaSession$ConnectionResult$AcceptedResultBuilder;
...
.method public onCustomCommand(Landroidx/media3/session/MediaSession;Landroidx/media3/session/MediaSession$ControllerInfo;Landroidx/media3/session/SessionCommand;Landroid/os/Bundle;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    const-string/jumbo p1, "onCustomCommand(...)"
