...
.method private final convertFromReadableMap(Lcom/facebook/react/bridge/ReadableMap;Lexpo/modules/kotlin/AppContext;Z)Lexpo/modules/kotlin/records/Record;
    ...
    const-string/jumbo v1, "null cannot be cast to non-null type kotlin.reflect.KClass<*>"
    ...
    invoke-interface {v5, v3, p2, p3}, Lexpo/modules/kotlin/types/TypeConverter;->convert(Ljava/lang/Object;Lexpo/modules/kotlin/AppContext;Z)Ljava/lang/Object;
    ...
    .line 93
    :try_start_2
    invoke-virtual {v1}, Lexpo/modules/kotlin/records/RecordTypeConverter$PropertyDescriptor;->getValidators()Ljava/util/List;
    ...
    check-cast v5, Lexpo/modules/kotlin/records/FieldValidator;

    .line 96
    const-string/jumbo v6, "null cannot be cast to non-null type expo.modules.kotlin.records.FieldValidator<kotlin.Any>"

    invoke-static {v5, v6}, Lkotlin/jvm/internal/Intrinsics;->checkNotNull(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-interface {v5, v2}, Lexpo/modules/kotlin/records/FieldValidator;->validate(Ljava/lang/Object;)V
    ...
    .line 106
    :cond_7
    const-string/jumbo p0, "null cannot be cast to non-null type T of expo.modules.kotlin.records.RecordTypeConverter"
...
.method private final getValidators(Lkotlin/reflect/KProperty1;)Ljava/util/List;
    ...
    .line 167
    instance-of v6, v6, Lexpo/modules/kotlin/records/BindUsing;
    ...
    .line 169
    :goto_1
    check-cast v4, Lexpo/modules/kotlin/records/BindUsing;
    ...
    check-cast v1, Lexpo/modules/kotlin/records/BindUsing;

    .line 123
    invoke-interface {v1}, Lexpo/modules/kotlin/records/BindUsing;->binder()Ljava/lang/Class;
    ...
    invoke-static {v1}, Lkotlin/reflect/full/KClasses;->createInstance(Lkotlin/reflect/KClass;)Ljava/lang/Object;

    move-result-object v1

    const-string/jumbo v3, "null cannot be cast to non-null type expo.modules.kotlin.records.ValidationBinder"

    invoke-static {v1, v3}, Lkotlin/jvm/internal/Intrinsics;->checkNotNull(Ljava/lang/Object;Ljava/lang/String;)V

    check-cast v1, Lexpo/modules/kotlin/records/ValidationBinder;
    ...
    invoke-interface {v1, v2, v3}, Lexpo/modules/kotlin/records/ValidationBinder;->bind(Ljava/lang/annotation/Annotation;Lkotlin/reflect/KType;)Lexpo/modules/kotlin/records/FieldValidator;
