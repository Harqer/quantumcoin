...
.method public onProgress(JJZ)V
    ...
    .line 19
    :cond_0
    iget-object p0, p0, Lexpo/modules/image/events/OkHttpProgressListener;->expoImageViewWrapper:Ljava/lang/ref/WeakReference;
    ...
    invoke-virtual {p0}, Lexpo/modules/image/ExpoImageViewWrapper;->getOnProgress$expo_image_release()Lexpo/modules/kotlin/viewevent/ViewEventCallback;
    ...
    .line 20
    new-instance p5, Lexpo/modules/image/records/ImageProgressEvent;

    long-to-int p1, p1

    long-to-int p2, p3

    invoke-direct {p5, p1, p2}, Lexpo/modules/image/records/ImageProgressEvent;-><init>(II)V

    .line 19
    invoke-interface {p0, p5}, Lexpo/modules/kotlin/viewevent/ViewEventCallback;->invoke(Ljava/lang/Object;)V
