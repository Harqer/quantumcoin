...
.method public onFailure(Ljava/lang/Exception;)V
    ...
    iget-object v2, p0, Lexpo/modules/updates/procedures/StartupProcedure$loaderTask$1;->this$0:Lexpo/modules/updates/procedures/StartupProcedure;

    invoke-static {v2}, Lexpo/modules/updates/procedures/StartupProcedure;->access$getContext$p(Lexpo/modules/updates/procedures/StartupProcedure;)Landroid/content/Context;

    move-result-object v2

    iget-object v3, p0, Lexpo/modules/updates/procedures/StartupProcedure$loaderTask$1;->this$0:Lexpo/modules/updates/procedures/StartupProcedure;

    invoke-static {v3}, Lexpo/modules/updates/procedures/StartupProcedure;->access$getLogger$p(Lexpo/modules/updates/procedures/StartupProcedure;)Lexpo/modules/updates/logging/UpdatesLogger;

    move-result-object v3

    iget-object v4, p0, Lexpo/modules/updates/procedures/StartupProcedure$loaderTask$1;->this$0:Lexpo/modules/updates/procedures/StartupProcedure;

    invoke-static {v4}, Lexpo/modules/updates/procedures/StartupProcedure;->access$getProcedureScope$p(Lexpo/modules/updates/procedures/StartupProcedure;)Lkotlinx/coroutines/CoroutineScope;

    move-result-object v4

    invoke-direct {v1, v2, v3, p1, v4}, Lexpo/modules/updates/launcher/NoDatabaseLauncher;-><init>(Landroid/content/Context;Lexpo/modules/updates/logging/UpdatesLogger;Ljava/lang/Exception;Lkotlinx/coroutines/CoroutineScope;)V

    check-cast v1, Lexpo/modules/updates/launcher/Launcher;

    invoke-static {v0, v1}, Lexpo/modules/updates/procedures/StartupProcedure;->access$setLauncher$p(Lexpo/modules/updates/procedures/StartupProcedure;Lexpo/modules/updates/launcher/Launcher;)V
    ...
    .line 85
    iget-object p0, p0, Lexpo/modules/updates/procedures/StartupProcedure$loaderTask$1;->this$0:Lexpo/modules/updates/procedures/StartupProcedure;

    invoke-static {p0}, Lexpo/modules/updates/procedures/StartupProcedure;->access$notifyController(Lexpo/modules/updates/procedures/StartupProcedure;)V
...
.method public onFinishedAllLoading()V
    ...
    const-string/jumbo v2, "procedureContext"
    ...
    invoke-static {p0}, Lexpo/modules/updates/procedures/StartupProcedure;->access$getProcedureContext$p(Lexpo/modules/updates/procedures/StartupProcedure;)Lexpo/modules/updates/procedures/StateMachineProcedure$ProcedureContext;
...
.method public onRemoteCheckForUpdateFinished(Lexpo/modules/updates/loader/LoaderTask$RemoteCheckResult;)V
    ...
    const-string/jumbo p0, "procedureContext"
    ...
    :cond_2
    invoke-interface {p0, p1}, Lexpo/modules/updates/procedures/StateMachineProcedure$ProcedureContext;->processStateEvent(Lexpo/modules/updates/statemachine/UpdatesStateEvent;)V
...
.method public onRemoteCheckForUpdateStarted()V
    ...
    :cond_0
    new-instance v0, Lexpo/modules/updates/statemachine/UpdatesStateEvent$Check;

    invoke-direct {v0}, Lexpo/modules/updates/statemachine/UpdatesStateEvent$Check;-><init>()V
...
.method public onRemoteUpdateAssetLoaded(Lexpo/modules/updates/db/entity/AssetEntity;III)V
    ...
    .line 135
    const-string/jumbo v1, "successfulAssetCount"
    ...
    .line 137
    const-string/jumbo p2, "totalAssetCount"
    ...
    invoke-static {p0}, Lexpo/modules/updates/procedures/StartupProcedure;->access$getLogger$p(Lexpo/modules/updates/procedures/StartupProcedure;)Lexpo/modules/updates/logging/UpdatesLogger;

    move-result-object p0

    new-instance p3, Ljava/lang/StringBuilder;

    const-string p4, "AppController appLoaderTask didLoadAsset: "
    ...
    invoke-virtual {p0, p2, p3, p4, p1}, Lexpo/modules/updates/logging/UpdatesLogger;->info(Ljava/lang/String;Lexpo/modules/updates/logging/UpdatesErrorCode;Ljava/lang/String;Ljava/lang/String;)V
...
.method public onRemoteUpdateFinished(Lexpo/modules/updates/loader/LoaderTask$RemoteUpdateStatus;Lexpo/modules/updates/db/entity/UpdateEntity;Ljava/lang/Exception;)V
    ...
    invoke-interface {v1, p1}, Lexpo/modules/updates/procedures/StateMachineProcedure$ProcedureContext;->processStateEvent(Lexpo/modules/updates/statemachine/UpdatesStateEvent;)V
    ...
    const-string p1, "Background update with error status must have a nonnull update object"
    ...
    invoke-static {p0}, Lexpo/modules/updates/procedures/StartupProcedure;->access$getRemoteLoadStatus$p(Lexpo/modules/updates/procedures/StartupProcedure;)Lexpo/modules/updates/errorrecovery/ErrorRecoveryDelegate$RemoteLoadStatus;

    move-result-object p0

    invoke-virtual {p1, p0}, Lexpo/modules/updates/errorrecovery/ErrorRecovery;->notifyNewRemoteLoadStatus(Lexpo/modules/updates/errorrecovery/ErrorRecoveryDelegate$RemoteLoadStatus;)V
    ...
    const-string p1, "Background update with error status must have a nonnull exception object"
...
.method public onRemoteUpdateManifestResponseUpdateLoaded(Lexpo/modules/updates/manifest/Update;)V
    ...
    sget-object p1, Lexpo/modules/updates/errorrecovery/ErrorRecoveryDelegate$RemoteLoadStatus;->NEW_UPDATE_LOADING:Lexpo/modules/updates/errorrecovery/ErrorRecoveryDelegate$RemoteLoadStatus;

    invoke-static {p0, p1}, Lexpo/modules/updates/procedures/StartupProcedure;->access$setRemoteLoadStatus$p(Lexpo/modules/updates/procedures/StartupProcedure;Lexpo/modules/updates/errorrecovery/ErrorRecoveryDelegate$RemoteLoadStatus;)V
