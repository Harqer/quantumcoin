...
.method public getCurrentState()Lexpo/modules/updates/statemachine/UpdatesStateValue;
    ...
    .line 64
    iget-object p0, p0, Lexpo/modules/updates/procedures/StateMachineSerialExecutorQueue$executeProcedure$2;->this$0:Lexpo/modules/updates/procedures/StateMachineSerialExecutorQueue;

    invoke-static {p0}, Lexpo/modules/updates/procedures/StateMachineSerialExecutorQueue;->access$getStateMachineProcedureContext$p(Lexpo/modules/updates/procedures/StateMachineSerialExecutorQueue;)Lexpo/modules/updates/procedures/StateMachineProcedure$StateMachineProcedureContext;

    move-result-object p0

    invoke-interface {p0}, Lexpo/modules/updates/procedures/StateMachineProcedure$StateMachineProcedureContext;->getCurrentState()Lexpo/modules/updates/statemachine/UpdatesStateValue;
    ...
    const-string v0, "Cannot get state after procedure completion"
...
.method public onComplete()V
    ...
    .line 49
    iget-object p0, p0, Lexpo/modules/updates/procedures/StateMachineSerialExecutorQueue$executeProcedure$2;->$holder:Lexpo/modules/updates/procedures/StateMachineSerialExecutorQueue$ProcedureHolder;

    invoke-virtual {p0}, Lexpo/modules/updates/procedures/StateMachineSerialExecutorQueue$ProcedureHolder;->getOnComplete()Lkotlinx/coroutines/CompletableDeferred;
...
.method public processStateEvent(Lexpo/modules/updates/statemachine/UpdatesStateEvent;)V
    ...
    invoke-interface {p0, p1}, Lexpo/modules/updates/procedures/StateMachineProcedure$StateMachineProcedureContext;->processStateEvent(Lexpo/modules/updates/statemachine/UpdatesStateEvent;)V
    ...
    const-string p1, "Cannot set state after procedure completion"
...
.method public resetStateAfterRestart()V
    ...
    invoke-interface {p0}, Lexpo/modules/updates/procedures/StateMachineProcedure$StateMachineProcedureContext;->resetStateAfterRestart()V
    ...
    const-string v0, "Cannot reset state after procedure completion"
