...
.method public getCheckAutomaticallyConfiguration()Lexpo/modules/updates/UpdatesConfiguration$CheckAutomaticallyConfiguration;
    ...
    .line 302
    iget-object p0, p0, Lexpo/modules/updates/procedures/StartupProcedure$initializeErrorRecovery$1;->this$0:Lexpo/modules/updates/procedures/StartupProcedure;

    invoke-static {p0}, Lexpo/modules/updates/procedures/StartupProcedure;->access$getUpdatesConfiguration$p(Lexpo/modules/updates/procedures/StartupProcedure;)Lexpo/modules/updates/UpdatesConfiguration;
...
.method public getLaunchedUpdateSuccessfulLaunchCount()I
    ...
    invoke-virtual {p0}, Lexpo/modules/updates/db/entity/UpdateEntity;->getSuccessfulLaunchCount()I
...
.method public loadRemoteUpdate()V
    ...
    invoke-static {v0}, Lexpo/modules/updates/procedures/StartupProcedure;->access$getContext$p(Lexpo/modules/updates/procedures/StartupProcedure;)Landroid/content/Context;
    ...
    invoke-static {v0}, Lexpo/modules/updates/procedures/StartupProcedure;->access$getDatabaseHolder$p(Lexpo/modules/updates/procedures/StartupProcedure;)Lexpo/modules/updates/db/DatabaseHolder;
    ...
    invoke-static {v0}, Lexpo/modules/updates/procedures/StartupProcedure;->access$getFileDownloader$p(Lexpo/modules/updates/procedures/StartupProcedure;)Lexpo/modules/updates/loader/FileDownloader;

    move-result-object v7

    iget-object v0, p0, Lexpo/modules/updates/procedures/StartupProcedure$initializeErrorRecovery$1;->this$0:Lexpo/modules/updates/procedures/StartupProcedure;

    invoke-static {v0}, Lexpo/modules/updates/procedures/StartupProcedure;->access$getUpdatesDirectory$p(Lexpo/modules/updates/procedures/StartupProcedure;)Ljava/io/File;
    ...
    new-instance v0, Lexpo/modules/updates/procedures/StartupProcedure$initializeErrorRecovery$1$loadRemoteUpdate$1;

    iget-object p0, p0, Lexpo/modules/updates/procedures/StartupProcedure$initializeErrorRecovery$1;->this$0:Lexpo/modules/updates/procedures/StartupProcedure;

    const/4 v1, 0x0

    invoke-direct {v0, v2, p0, v1}, Lexpo/modules/updates/procedures/StartupProcedure$initializeErrorRecovery$1$loadRemoteUpdate$1;-><init>(Lexpo/modules/updates/loader/RemoteLoader;Lexpo/modules/updates/procedures/StartupProcedure;Lkotlin/coroutines/Continuation;)V
...
.method public markFailedLaunchForLaunchedUpdate()V
    ...
    invoke-direct {v0, p0, v2}, Lexpo/modules/updates/procedures/StartupProcedure$initializeErrorRecovery$1$markFailedLaunchForLaunchedUpdate$1;-><init>(Lexpo/modules/updates/procedures/StartupProcedure;Lkotlin/coroutines/Continuation;)V
...
.method public markSuccessfulLaunchForLaunchedUpdate()V
    ...
    invoke-direct {v0, p0, v2}, Lexpo/modules/updates/procedures/StartupProcedure$initializeErrorRecovery$1$markSuccessfulLaunchForLaunchedUpdate$1;-><init>(Lexpo/modules/updates/procedures/StartupProcedure;Lkotlin/coroutines/Continuation;)V
...
.method public relaunch(Lexpo/modules/updates/launcher/Launcher$LauncherCallback;)V
    ...
    invoke-static {p0}, Lexpo/modules/updates/procedures/StartupProcedure;->access$getCallback$p(Lexpo/modules/updates/procedures/StartupProcedure;)Lexpo/modules/updates/procedures/StartupProcedure$StartupProcedureCallback;

    move-result-object p0

    const/4 v0, 0x0

    invoke-interface {p0, v0, p1}, Lexpo/modules/updates/procedures/StartupProcedure$StartupProcedureCallback;->onRequestRelaunch(ZLexpo/modules/updates/launcher/Launcher$LauncherCallback;)V
