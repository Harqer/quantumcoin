...
.method public getObserver()Ljava/lang/ref/WeakReference;
    ...
    .line 9
    iget-object p0, p0, Lexpo/modules/updates/events/UpdatesEventManager;->observer:Ljava/lang/ref/WeakReference;
...
.method public sendStateMachineContextEvent(Lexpo/modules/updates/statemachine/UpdatesStateContext;)V
    ...
    .line 23
    iget-object p0, p0, Lexpo/modules/updates/events/UpdatesEventManager;->logger:Lexpo/modules/updates/logging/UpdatesLogger;

    .line 24
    const-string v0, "Could not send state machine context to observer"
    ...
    const-string p1, "Unable to send state machine context to observer, no observer"

    sget-object v0, Lexpo/modules/updates/logging/UpdatesErrorCode;->JSRuntimeError:Lexpo/modules/updates/logging/UpdatesErrorCode;

    invoke-virtual {p0, p1, v0}, Lexpo/modules/updates/logging/UpdatesLogger;->debug(Ljava/lang/String;Lexpo/modules/updates/logging/UpdatesErrorCode;)V
