...
.method protected bind(Landroidx/sqlite/db/SupportSQLiteStatement;Lexpo/modules/updates/db/entity/AssetEntity;)V
    ...
    .line 215
    :goto_8
    iget-object p0, p0, Lexpo/modules/updates/db/dao/AssetDao_Impl$3;->this$0:Lexpo/modules/updates/db/dao/AssetDao_Impl;
...
.method protected createQuery()Ljava/lang/String;
    ...
    .line 152
    const-string p0, "UPDATE OR ABORT `assets` SET `key` = ?,`type` = ?,`id` = ?,`url` = ?,`headers` = ?,`extra_request_headers` = ?,`metadata` = ?,`download_time` = ?,`relative_path` = ?,`hash` = ?,`hash_type` = ?,`expected_hash` = ?,`marked_for_deletion` = ? WHERE `id` = ?"
