...
.method public final loadAssetWithKey(Ljava/lang/String;)Lexpo/modules/updates/db/entity/AssetEntity;
    ...
    check-cast p0, Lexpo/modules/updates/db/entity/AssetEntity;
    ...
    .line 95
    :cond_0
    invoke-virtual {p0}, Lexpo/modules/updates/db/entity/AssetEntity;->getRelativePath()Ljava/lang/String;
    ...
    invoke-virtual {v0, p1}, Lexpo/modules/updates/utils/AndroidResourceAssetUtils;->parseAndroidResponseAssetFromPath(Ljava/lang/String;)Lexpo/modules/updates/utils/AndroidResourceAssetUtils$AndroidResourceAsset;

    move-result-object p1

    .line 96
    invoke-virtual {p1}, Lexpo/modules/updates/utils/AndroidResourceAssetUtils$AndroidResourceAsset;->component1()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p1}, Lexpo/modules/updates/utils/AndroidResourceAssetUtils$AndroidResourceAsset;->component2()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p1}, Lexpo/modules/updates/utils/AndroidResourceAssetUtils$AndroidResourceAsset;->component3()Ljava/lang/String;

    move-result-object p1

    .line 98
    invoke-virtual {p0, v0}, Lexpo/modules/updates/db/entity/AssetEntity;->setEmbeddedAssetFilename(Ljava/lang/String;)V

    .line 99
    invoke-virtual {p0, v1}, Lexpo/modules/updates/db/entity/AssetEntity;->setResourcesFolder(Ljava/lang/String;)V

    .line 100
    invoke-virtual {p0, p1}, Lexpo/modules/updates/db/entity/AssetEntity;->setResourcesFilename(Ljava/lang/String;)V
...
.method public final mergeAndUpdateAsset(Lexpo/modules/updates/db/entity/AssetEntity;Lexpo/modules/updates/db/entity/AssetEntity;)V
    ...
    const-string/jumbo v0, "newEntity"
    ...
    invoke-virtual {p1, p0}, Lexpo/modules/updates/db/entity/AssetEntity;->setLaunchAsset(Z)V
    ...
    invoke-virtual {p1, p0}, Lexpo/modules/updates/db/entity/AssetEntity;->setEmbeddedAssetFilename(Ljava/lang/String;)V
    ...
    invoke-virtual {p1, p0}, Lexpo/modules/updates/db/entity/AssetEntity;->setResourcesFilename(Ljava/lang/String;)V
    ...
    invoke-virtual {p1, p0}, Lexpo/modules/updates/db/entity/AssetEntity;->setResourcesFolder(Ljava/lang/String;)V
    ...
    invoke-virtual {p1, p0}, Lexpo/modules/updates/db/entity/AssetEntity;->setScale(Ljava/lang/Float;)V
    ...
    invoke-virtual {p1, p0}, Lexpo/modules/updates/db/entity/AssetEntity;->setScales([Ljava/lang/Float;)V
