...
.method private final registerContentAppearedListener()V
    ...
    .line 93
    iget-object p0, p0, Lexpo/modules/updates/errorrecovery/ErrorRecovery;->contentAppearedListener:Lcom/facebook/react/bridge/ReactMarker$MarkerListener;
...
.method private final registerErrorHandlerImplBridge(Lcom/facebook/react/devsupport/interfaces/DevSupportManager;)V
    ...
    .line 114
    iget-object p0, p0, Lexpo/modules/updates/errorrecovery/ErrorRecovery;->logger:Lexpo/modules/updates/logging/UpdatesLogger;

    const-string p1, "Unexpected type of ReactInstanceManager.DevSupportManager. expo-updates error recovery will not behave properly."

    const/4 v0, 0x2

    const/4 v1, 0x0

    invoke-static {p0, p1, v1, v0, v1}, Lexpo/modules/updates/logging/UpdatesLogger;->debug$default(Lexpo/modules/updates/logging/UpdatesLogger;Ljava/lang/String;Lexpo/modules/updates/logging/UpdatesErrorCode;ILjava/lang/Object;)V
    ...
    .line 125
    const-string/jumbo v0, "null cannot be cast to non-null type com.facebook.react.bridge.DefaultJSExceptionHandler"
...
.method private final unregisterErrorHandlerImplBridge()V
    ...
    const-string v0, "Unexpected type of ReactInstanceManager.DevSupportManager. expo-updates could not unregister its error handler"

    const/4 v1, 0x2

    invoke-static {p0, v0, v2, v1, v2}, Lexpo/modules/updates/logging/UpdatesLogger;->debug$default(Lexpo/modules/updates/logging/UpdatesLogger;Ljava/lang/String;Lexpo/modules/updates/logging/UpdatesErrorCode;ILjava/lang/Object;)V
...
.method public final getHandler$expo_updates_release()Landroid/os/Handler;
    ...
    .line 34
    iget-object p0, p0, Lexpo/modules/updates/errorrecovery/ErrorRecovery;->handler:Landroid/os/Handler;
...
.method public final notifyNewRemoteLoadStatus(Lexpo/modules/updates/errorrecovery/ErrorRecoveryDelegate$RemoteLoadStatus;)V
    ...
    const-string/jumbo v0, "newStatus"
