...
.method public final copyAssetAndGetHash(Lexpo/modules/updates/db/entity/AssetEntity;Ljava/io/File;Landroid/content/Context;)[B
    ...
    const-string p3, "Failed to copy embedded asset "
    ...
    const-string p2, " from APK assets or resources because not enough information was provided."
...
.method public final copyContextAssetAndGetHash$expo_updates_release(Lexpo/modules/updates/db/entity/AssetEntity;Ljava/io/File;Landroid/content/Context;)[B
    ...
    invoke-virtual {v0, p3, p2, v1}, Lexpo/modules/updates/UpdatesUtils;->verifySHA256AndWriteToFile(Ljava/io/InputStream;Ljava/io/File;Ljava/lang/String;)[B
    ...
    .line 56
    sget-object p2, Lexpo/modules/updates/loader/LoaderFiles;->TAG:Ljava/lang/String;
...
.method public final copyResourceAndGetHash$expo_updates_release(Lexpo/modules/updates/db/entity/AssetEntity;Ljava/io/File;Landroid/content/Context;)[B
    ...
    invoke-virtual {p3, p0}, Landroid/content/res/Resources;->openRawResource(I)Ljava/io/InputStream;
    ...
    const-string v1, "Failed to copy resource asset "
...
.method public final fileExists(Landroid/content/Context;Ljava/io/File;Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p1, p3}, Lexpo/modules/updates/utils/AndroidResourceAssetUtils;->isAndroidAssetOrResourceExisted(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public final readEmbeddedUpdate(Landroid/content/Context;Lexpo/modules/updates/UpdatesConfiguration;)Lexpo/modules/updates/manifest/Update;
    ...
    .line 32
    sget-object p0, Lexpo/modules/updates/manifest/EmbeddedManifestUtils;->INSTANCE:Lexpo/modules/updates/manifest/EmbeddedManifestUtils;

    invoke-virtual {p0, p1, p2}, Lexpo/modules/updates/manifest/EmbeddedManifestUtils;->getEmbeddedUpdate(Landroid/content/Context;Lexpo/modules/updates/UpdatesConfiguration;)Lexpo/modules/updates/manifest/EmbeddedUpdate;
