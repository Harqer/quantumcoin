...
.method private final isCodeSigningCertificate(Ljava/security/cert/X509Certificate;)Z
    ...
    .line 57
    const-string p1, "1.3.6.1.5.5.7.3.3"
...
.method private final validateChain(Ljava/util/List;)V
    ...
    const-string p1, "Certificates do not chain"
    ...
    const-string p1, "Expo project information must be a subset or equal of that of parent certificates"
    ...
    const-string/jumbo p1, "pathLenConstraint violated by intermediate certificate"
    ...
    const-string p1, "Non-leaf certificate subject must be a Certificate Authority"
    ...
    const-string p1, "Expo project information must be a subset of or equal to that of parent certificates"
    ...
    const-string p1, "Root certificate subject must be a Certificate Authority"
    ...
    const-string p1, "Root certificate not self-signed"
...
.method public final expoProjectInformation(Ljava/security/cert/X509Certificate;)Lexpo/modules/updates/codesigning/ExpoProjectInformation;
    ...
    .line 62
    const-string p0, "1.2.840.113556.1.8000.2554.43437.254.128.102.157.7894389.20439.2.1"
    ...
    .line 75
    new-instance p1, Lexpo/modules/updates/codesigning/ExpoProjectInformation;
    ...
    invoke-direct {p1, v1, p0}, Lexpo/modules/updates/codesigning/ExpoProjectInformation;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string p1, "Invalid Expo project information extension value"
