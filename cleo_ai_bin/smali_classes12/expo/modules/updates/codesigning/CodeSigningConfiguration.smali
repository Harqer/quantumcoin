...
.method private final getAlgorithmFromMetadata()Lexpo/modules/updates/codesigning/CodeSigningAlgorithm;
    ...
    .line 34
    iget-object p0, p0, Lexpo/modules/updates/codesigning/CodeSigningConfiguration;->algorithmFromMetadata$delegate:Lkotlin/Lazy;
...
.method private final getKeyIdFromMetadata()Ljava/lang/String;
    ...
    .line 42
    iget-object p0, p0, Lexpo/modules/updates/codesigning/CodeSigningConfiguration;->keyIdFromMetadata$delegate:Lkotlin/Lazy;
...
.method private final validateSignatureInternal(Lexpo/modules/updates/codesigning/SignatureHeaderInfo;[BLjava/lang/String;)Lexpo/modules/updates/codesigning/SignatureValidationResult;
    ...
    iget-object p0, p0, Lexpo/modules/updates/codesigning/CodeSigningConfiguration;->embeddedCertificateString:Ljava/lang/String;

    invoke-static {p3, p0}, Lkotlin/collections/CollectionsKt;->plus(Ljava/util/Collection;Ljava/lang/Object;)Ljava/util/List;

    move-result-object p0

    .line 65
    invoke-direct {v0, p0}, Lexpo/modules/updates/codesigning/CertificateChain;-><init>(Ljava/util/List;)V
    ...
    .line 99
    sget-object p0, Lexpo/modules/updates/codesigning/ValidationResult;->VALID:Lexpo/modules/updates/codesigning/ValidationResult;

    goto :goto_1

    :cond_3
    sget-object p0, Lexpo/modules/updates/codesigning/ValidationResult;->INVALID:Lexpo/modules/updates/codesigning/ValidationResult;

    .line 100
    :goto_1
    sget-object p2, Lexpo/modules/updates/codesigning/CertificateChain;->Companion:Lexpo/modules/updates/codesigning/CertificateChain$Companion;

    invoke-virtual {v0}, Lexpo/modules/updates/codesigning/CertificateChain;->getCodeSigningCertificate()Ljava/security/cert/X509Certificate;

    move-result-object p3

    invoke-virtual {p2, p3}, Lexpo/modules/updates/codesigning/CertificateChain$Companion;->expoProjectInformation(Ljava/security/cert/X509Certificate;)Lexpo/modules/updates/codesigning/ExpoProjectInformation;

    move-result-object p2

    .line 98
    invoke-direct {p1, p0, p2}, Lexpo/modules/updates/codesigning/SignatureValidationResult;-><init>(Lexpo/modules/updates/codesigning/ValidationResult;Lexpo/modules/updates/codesigning/ExpoProjectInformation;)V
    ...
    const-string p3, "Key with keyid="
    ...
    const-string p2, " from signature not found in client configuration"
...
.method public final getAcceptSignatureHeader()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lexpo/modules/updates/codesigning/CodeSigningAlgorithm;->getAlgorithmName()Ljava/lang/String;

    move-result-object p0

    invoke-static {p0}, Lexpo/modules/structuredheaders/StringItem;->valueOf(Ljava/lang/String;)Lexpo/modules/structuredheaders/StringItem;
    ...
    .line 105
    invoke-static {p0}, Lexpo/modules/structuredheaders/Dictionary;->valueOf(Ljava/util/Map;)Lexpo/modules/structuredheaders/Dictionary;

    move-result-object p0

    .line 111
    invoke-virtual {p0}, Lexpo/modules/structuredheaders/Dictionary;->serialize()Ljava/lang/String;
...
.method public final validateSignature(Ljava/lang/String;[BLjava/lang/String;)Lexpo/modules/updates/codesigning/SignatureValidationResult;
    ...
    .line 48
    iget-boolean p0, p0, Lexpo/modules/updates/codesigning/CodeSigningConfiguration;->allowUnsignedManifests:Z
    ...
    sget-object p1, Lexpo/modules/updates/codesigning/ValidationResult;->SKIPPED:Lexpo/modules/updates/codesigning/ValidationResult;
    ...
    const-string p1, "No expo-signature header specified"
