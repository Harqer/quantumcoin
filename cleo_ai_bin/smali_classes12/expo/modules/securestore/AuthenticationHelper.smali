...
.method private final getCurrentActivity()Landroid/app/Activity;
    ...
    .line 82
    iget-object p0, p0, Lexpo/modules/securestore/AuthenticationHelper;->moduleRegistry:Lexpo/modules/core/ModuleRegistry;
...
.method private final openAuthenticationPrompt(Ljavax/crypto/Cipher;Ljava/lang/String;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .line 38
    :cond_6
    new-instance p0, Lexpo/modules/securestore/AuthenticationException;

    const-string p1, "Authentication is already in progress"

    invoke-direct {p0, p1, v5, v2, v5}, Lexpo/modules/securestore/AuthenticationException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
...
.method public final assertBiometricsSupport()V
    ...
    .line 60
    iget-object p0, p0, Lexpo/modules/securestore/AuthenticationHelper;->context:Landroid/content/Context;
    ...
    const-string v0, "No biometrics are currently enrolled"

    invoke-direct {p0, v0, v3, v2, v3}, Lexpo/modules/securestore/AuthenticationException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    const-string v0, "An update is required before the biometrics can be used"
    ...
    const-string v0, "No hardware available for biometric authentication. Use expo-local-authentication to check if the device supports it"
    ...
    const-string v0, "Biometric authentication status is unknown"
    ...
    const-string v0, "Biometric authentication is unsupported"
...
.method public final authenticateCipher(Ljavax/crypto/Cipher;ZLjava/lang/String;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    const-string p1, "Couldn\'t get cipher from authentication result"

    const/4 p2, 0x2

    const/4 p3, 0x0

    invoke-direct {p0, p1, p3, p2, p3}, Lexpo/modules/securestore/AuthenticationException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
