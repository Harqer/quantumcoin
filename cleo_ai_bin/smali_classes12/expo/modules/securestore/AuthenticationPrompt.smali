...
.method private final convertErrorCode(I)Ljava/lang/String;
    ...
    .line 44
    const-string p0, "User canceled the authentication"
    ...
    .line 50
    :pswitch_1
    const-string p0, "No device credential"
    ...
    .line 47
    :pswitch_3
    const-string p0, "Hardware not present"

    return-object p0

    .line 49
    :pswitch_4
    const-string p0, "No biometrics enrolled"
    ...
    .line 52
    :pswitch_6
    const-string p0, "Lockout permanent"

    return-object p0

    .line 56
    :pswitch_7
    const-string p0, "Vendor error"
    ...
    .line 55
    :pswitch_b
    const-string p0, "Unable to process"

    return-object p0

    .line 48
    :pswitch_c
    const-string p0, "Hardware unavailable"
...
.method public final authenticate(Ljavax/crypto/Cipher;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .line 40
    iget-object p0, p0, Lexpo/modules/securestore/AuthenticationPrompt;->promptInfo:Landroidx/biometric/BiometricPrompt$PromptInfo;
    ...
    invoke-virtual {v2, p0, v1}, Landroidx/biometric/BiometricPrompt;->authenticate(Landroidx/biometric/BiometricPrompt$PromptInfo;Landroidx/biometric/BiometricPrompt$CryptoObject;)V
