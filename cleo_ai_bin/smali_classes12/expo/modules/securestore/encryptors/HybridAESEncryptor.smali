...
.method public createEncryptedItem(Ljava/lang/String;Ljava/security/KeyStore$PrivateKeyEntry;ZLjava/lang/String;Lexpo/modules/securestore/AuthenticationHelper;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .line 75
    new-instance p0, Lexpo/modules/securestore/EncryptException;

    const/16 p5, 0x8

    const/4 p6, 0x0

    const-string p1, "HybridAESEncryption should not be used on Android SDK >= 23. This shouldn\'t happen. If you see this message report an issue at https://github.com/expo/expo."
    ...
    invoke-direct/range {p0 .. p6}, Lexpo/modules/securestore/EncryptException;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
...
.method public decryptItem(Ljava/lang/String;Lorg/json/JSONObject;Ljava/security/KeyStore$PrivateKeyEntry;Lexpo/modules/securestore/SecureStoreOptions;Lexpo/modules/securestore/AuthenticationHelper;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .line 104
    iget-object p0, p0, Lexpo/modules/securestore/encryptors/HybridAESEncryptor;->mAESEncryptor:Lexpo/modules/securestore/encryptors/AESEncryptor;
...
.method public initializeKeyStoreEntry(Ljava/security/KeyStore;Lexpo/modules/securestore/SecureStoreOptions;)Ljava/security/KeyStore$PrivateKeyEntry;
    ...
    .line 60
    new-instance p0, Lexpo/modules/securestore/KeyStoreException;

    .line 61
    const-string p1, "Tried to initialize HybridAESEncryptor key store entry on Android SDK >= 23. This shouldn\'t happen. If you see this message report an issue at https://github.com/expo/expo."

    .line 60
    invoke-direct {p0, p1}, Lexpo/modules/securestore/KeyStoreException;-><init>(Ljava/lang/String;)V
