...
.method public disableExceptionHandler()V
    ...
    .line 43
    iget-object p0, p0, Lio/intercom/android/sdk/errorreporting/ErrorReporter;->reportStore:Lio/intercom/android/sdk/errorreporting/ErrorReportStore;

    invoke-virtual {p0}, Lio/intercom/android/sdk/errorreporting/ErrorReportStore;->deleteFromDisk()V
...
.method saveReport(Ljava/lang/Throwable;)V
    ...
    iget-object p0, p0, Lio/intercom/android/sdk/errorreporting/ErrorReporter;->exceptionParser:Lio/intercom/android/sdk/errorreporting/ExceptionParser;

    invoke-virtual {p0, p1}, Lio/intercom/android/sdk/errorreporting/ExceptionParser;->createReportFrom(Ljava/lang/Throwable;)Lio/intercom/android/sdk/errorreporting/ErrorReport;

    move-result-object p0

    invoke-virtual {v0, p0}, Lio/intercom/android/sdk/errorreporting/ErrorReportStore;->saveToDisk(Lio/intercom/android/sdk/errorreporting/ErrorReport;)V
...
.method public sendSavedReport()V
    ...
    iget-object p0, p0, Lio/intercom/android/sdk/errorreporting/ErrorReporter;->apiProvider:Lio/intercom/android/sdk/Provider;

    invoke-virtual {v0, p0}, Lio/intercom/android/sdk/errorreporting/ErrorReportStore;->sendSavedReport(Lio/intercom/android/sdk/Provider;)V
