...
.method public addAdditionalStore(Lorg/spongycastle/util/Store;)V
    ...
    .line 295
    iget-object p0, p0, Lorg/spongycastle/x509/ExtendedPKIXParameters;->additionalStores:Ljava/util/List;
...
.method public addStore(Lorg/spongycastle/util/Store;)V
    ...
    .line 272
    iget-object p0, p0, Lorg/spongycastle/x509/ExtendedPKIXParameters;->stores:Ljava/util/List;
...
.method public getAttrCertCheckers()Ljava/util/Set;
    ...
    .line 626
    iget-object p0, p0, Lorg/spongycastle/x509/ExtendedPKIXParameters;->attrCertCheckers:Ljava/util/Set;
...
.method public getNecessaryACAttributes()Ljava/util/Set;
    ...
    .line 537
    iget-object p0, p0, Lorg/spongycastle/x509/ExtendedPKIXParameters;->necessaryACAttributes:Ljava/util/Set;
...
.method public getProhibitedACAttributes()Ljava/util/Set;
    ...
    .line 582
    iget-object p0, p0, Lorg/spongycastle/x509/ExtendedPKIXParameters;->prohibitedACAttributes:Ljava/util/Set;
...
.method public getTargetConstraints()Lorg/spongycastle/util/Selector;
    ...
    .line 406
    iget-object p0, p0, Lorg/spongycastle/x509/ExtendedPKIXParameters;->selector:Lorg/spongycastle/util/Selector;

    if-eqz p0, :cond_0

    .line 408
    invoke-interface {p0}, Lorg/spongycastle/util/Selector;->clone()Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lorg/spongycastle/util/Selector;
...
.method public getTrustedACIssuers()Ljava/util/Set;
    ...
    .line 490
    iget-object p0, p0, Lorg/spongycastle/x509/ExtendedPKIXParameters;->trustedACIssuers:Ljava/util/Set;
...
.method public getValidityModel()I
    ...
    .line 201
    iget p0, p0, Lorg/spongycastle/x509/ExtendedPKIXParameters;->validityModel:I
...
.method public isAdditionalLocationsEnabled()Z
    ...
    .line 371
    iget-boolean p0, p0, Lorg/spongycastle/x509/ExtendedPKIXParameters;->additionalLocationsEnabled:Z
...
.method public isUseDeltasEnabled()Z
    ...
    .line 181
    iget-boolean p0, p0, Lorg/spongycastle/x509/ExtendedPKIXParameters;->useDeltas:Z
...
.method public setStores(Ljava/util/List;)V
    ...
    const-string p1, "All elements of list must be of type org.spongycastle.util.Store."
