...
.method private getCertificate()Lorg/spongycastle/x509/X509AttributeCertificate;
    ...
    .line 64
    new-instance p0, Lorg/spongycastle/x509/X509V2AttributeCertificate;
    ...
    invoke-direct {p0, v0}, Lorg/spongycastle/x509/X509V2AttributeCertificate;-><init>([B)V
...
.method private readDERCertificate(Ljava/io/InputStream;)Lorg/spongycastle/x509/X509AttributeCertificate;
    ...
    invoke-direct {p0, p1}, Lorg/spongycastle/x509/X509V2AttributeCertificate;-><init>([B)V
...
.method private readPEMCertificate(Ljava/io/InputStream;)Lorg/spongycastle/x509/X509AttributeCertificate;
    ...
    .line 77
    sget-object p0, Lorg/spongycastle/jce/provider/X509AttrCertParser;->PEM_PARSER:Lorg/spongycastle/jce/provider/PEMUtil;

    invoke-virtual {p0, p1}, Lorg/spongycastle/jce/provider/PEMUtil;->readPEMObject(Ljava/io/InputStream;)Lorg/spongycastle/asn1/ASN1Sequence;
    ...
    .line 81
    new-instance p1, Lorg/spongycastle/x509/X509V2AttributeCertificate;

    invoke-virtual {p0}, Lorg/spongycastle/asn1/ASN1Sequence;->getEncoded()[B

    move-result-object p0

    invoke-direct {p1, p0}, Lorg/spongycastle/x509/X509V2AttributeCertificate;-><init>([B)V
...
.method public engineRead()Ljava/lang/Object;
    ...
    invoke-direct {v0, v1, p0}, Lorg/spongycastle/x509/util/StreamParsingException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
