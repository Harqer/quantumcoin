...
.method private createGeneralizedTime(Ljava/util/Date;)Lorg/spongycastle/asn1/ASN1GeneralizedTime;
    ...
    iget p0, p0, Lorg/spongycastle/tsp/TimeStampTokenGenerator;->resolution:I
    ...
    invoke-direct {p1, p0}, Lorg/spongycastle/tsp/TSPException;-><init>(Ljava/lang/String;)V
...
.method public addAttributeCertificates(Lorg/spongycastle/util/Store;)V
    ...
    .line 261
    iget-object p0, p0, Lorg/spongycastle/tsp/TimeStampTokenGenerator;->attrCerts:Ljava/util/List;
...
.method public addCRLs(Lorg/spongycastle/util/Store;)V
    ...
    .line 251
    iget-object p0, p0, Lorg/spongycastle/tsp/TimeStampTokenGenerator;->crls:Ljava/util/List;
...
.method public addCertificates(Lorg/spongycastle/util/Store;)V
    ...
    .line 241
    iget-object p0, p0, Lorg/spongycastle/tsp/TimeStampTokenGenerator;->certs:Ljava/util/List;
...
.method public addOtherRevocationInfo(Lorg/spongycastle/asn1/ASN1ObjectIdentifier;Lorg/spongycastle/util/Store;)V
    ...
    .line 274
    iget-object p0, p0, Lorg/spongycastle/tsp/TimeStampTokenGenerator;->otherRevoc:Ljava/util/Map;

    const/4 v0, 0x0

    invoke-interface {p2, v0}, Lorg/spongycastle/util/Store;->getMatches(Lorg/spongycastle/util/Selector;)Ljava/util/Collection;
...
.method public generate(Lorg/spongycastle/tsp/TimeStampRequest;Ljava/math/BigInteger;Ljava/util/Date;Lorg/spongycastle/asn1/x509/Extensions;)Lorg/spongycastle/tsp/TimeStampToken;
    ...
    .line 364
    iget v3, v0, Lorg/spongycastle/tsp/TimeStampTokenGenerator;->accuracySeconds:I

    const/4 v4, 0x0

    if-gtz v3, :cond_1

    iget v5, v0, Lorg/spongycastle/tsp/TimeStampTokenGenerator;->accuracyMillis:I

    if-gtz v5, :cond_1

    iget v5, v0, Lorg/spongycastle/tsp/TimeStampTokenGenerator;->accuracyMicros:I
    ...
    iget v5, v0, Lorg/spongycastle/tsp/TimeStampTokenGenerator;->accuracySeconds:I

    int-to-long v5, v5

    invoke-direct {v3, v5, v6}, Lorg/spongycastle/asn1/ASN1Integer;-><init>(J)V
    ...
    iget v6, v0, Lorg/spongycastle/tsp/TimeStampTokenGenerator;->accuracyMillis:I
    ...
    .line 379
    :goto_2
    iget v6, v0, Lorg/spongycastle/tsp/TimeStampTokenGenerator;->accuracyMicros:I
    ...
    iget v7, v0, Lorg/spongycastle/tsp/TimeStampTokenGenerator;->accuracyMicros:I
    ...
    invoke-direct {v7, v3, v5, v6}, Lorg/spongycastle/asn1/tsp/Accuracy;-><init>(Lorg/spongycastle/asn1/ASN1Integer;Lorg/spongycastle/asn1/ASN1Integer;Lorg/spongycastle/asn1/ASN1Integer;)V

    move-object v11, v7

    .line 388
    :goto_4
    iget-boolean v3, v0, Lorg/spongycastle/tsp/TimeStampTokenGenerator;->ordering:Z
    ...
    invoke-direct {v4, v3}, Lorg/spongycastle/asn1/ASN1Integer;-><init>(Ljava/math/BigInteger;)V

    :cond_6
    move-object v13, v4

    .line 399
    iget-object v3, v0, Lorg/spongycastle/tsp/TimeStampTokenGenerator;->tsaPolicyOID:Lorg/spongycastle/asn1/ASN1ObjectIdentifier;
    ...
    .line 426
    iget v2, v0, Lorg/spongycastle/tsp/TimeStampTokenGenerator;->resolution:I

    if-nez v2, :cond_c

    .line 428
    iget-object v2, v0, Lorg/spongycastle/tsp/TimeStampTokenGenerator;->locale:Ljava/util/Locale;

    if-nez v2, :cond_b

    new-instance v2, Lorg/spongycastle/asn1/ASN1GeneralizedTime;

    invoke-direct {v2, v1}, Lorg/spongycastle/asn1/ASN1GeneralizedTime;-><init>(Ljava/util/Date;)V
    ...
    iget-object v3, v0, Lorg/spongycastle/tsp/TimeStampTokenGenerator;->locale:Ljava/util/Locale;

    invoke-direct {v2, v1, v3}, Lorg/spongycastle/asn1/ASN1GeneralizedTime;-><init>(Ljava/util/Date;Ljava/util/Locale;)V

    goto :goto_8

    .line 432
    :cond_c
    invoke-direct {v0, v1}, Lorg/spongycastle/tsp/TimeStampTokenGenerator;->createGeneralizedTime(Ljava/util/Date;)Lorg/spongycastle/asn1/ASN1GeneralizedTime;
    ...
    .line 435
    new-instance v6, Lorg/spongycastle/asn1/tsp/TSTInfo;

    new-instance v9, Lorg/spongycastle/asn1/ASN1Integer;

    move-object/from16 v1, p2

    invoke-direct {v9, v1}, Lorg/spongycastle/asn1/ASN1Integer;-><init>(Ljava/math/BigInteger;)V

    iget-object v14, v0, Lorg/spongycastle/tsp/TimeStampTokenGenerator;->tsa:Lorg/spongycastle/asn1/x509/GeneralName;
    ...
    .line 442
    :try_start_0
    new-instance v1, Lorg/spongycastle/cms/CMSSignedDataGenerator;

    invoke-direct {v1}, Lorg/spongycastle/cms/CMSSignedDataGenerator;-><init>()V
    ...
    .line 447
    new-instance v2, Lorg/spongycastle/util/CollectionStore;

    iget-object v3, v0, Lorg/spongycastle/tsp/TimeStampTokenGenerator;->certs:Ljava/util/List;

    invoke-direct {v2, v3}, Lorg/spongycastle/util/CollectionStore;-><init>(Ljava/util/Collection;)V

    invoke-virtual {v1, v2}, Lorg/spongycastle/cms/CMSSignedDataGenerator;->addCertificates(Lorg/spongycastle/util/Store;)V

    .line 448
    new-instance v2, Lorg/spongycastle/util/CollectionStore;

    iget-object v3, v0, Lorg/spongycastle/tsp/TimeStampTokenGenerator;->attrCerts:Ljava/util/List;

    invoke-direct {v2, v3}, Lorg/spongycastle/util/CollectionStore;-><init>(Ljava/util/Collection;)V

    invoke-virtual {v1, v2}, Lorg/spongycastle/cms/CMSSignedDataGenerator;->addAttributeCertificates(Lorg/spongycastle/util/Store;)V

    .line 451
    :cond_d
    new-instance v2, Lorg/spongycastle/util/CollectionStore;

    iget-object v3, v0, Lorg/spongycastle/tsp/TimeStampTokenGenerator;->crls:Ljava/util/List;

    invoke-direct {v2, v3}, Lorg/spongycastle/util/CollectionStore;-><init>(Ljava/util/Collection;)V

    invoke-virtual {v1, v2}, Lorg/spongycastle/cms/CMSSignedDataGenerator;->addCRLs(Lorg/spongycastle/util/Store;)V

    .line 453
    iget-object v2, v0, Lorg/spongycastle/tsp/TimeStampTokenGenerator;->otherRevoc:Ljava/util/Map;
    ...
    iget-object v5, v0, Lorg/spongycastle/tsp/TimeStampTokenGenerator;->otherRevoc:Ljava/util/Map;
    ...
    invoke-direct {v4, v5}, Lorg/spongycastle/util/CollectionStore;-><init>(Ljava/util/Collection;)V

    invoke-virtual {v1, v3, v4}, Lorg/spongycastle/cms/CMSSignedDataGenerator;->addOtherRevocationInfo(Lorg/spongycastle/asn1/ASN1ObjectIdentifier;Lorg/spongycastle/util/Store;)V

    goto :goto_9

    .line 463
    :cond_e
    iget-object v0, v0, Lorg/spongycastle/tsp/TimeStampTokenGenerator;->signerInfoGen:Lorg/spongycastle/cms/SignerInfoGenerator;

    invoke-virtual {v1, v0}, Lorg/spongycastle/cms/CMSSignedDataGenerator;->addSignerInfoGenerator(Lorg/spongycastle/cms/SignerInfoGenerator;)V

    .line 465
    const-string v0, "DER"

    invoke-virtual {v6, v0}, Lorg/spongycastle/asn1/tsp/TSTInfo;->getEncoded(Ljava/lang/String;)[B
    ...
    sget-object v3, Lorg/spongycastle/asn1/pkcs/PKCSObjectIdentifiers;->id_ct_TSTInfo:Lorg/spongycastle/asn1/ASN1ObjectIdentifier;
