...
.method public constructor <init>(Lcom/facebook/react/bridge/ReactApplicationContext;)V
    ...
    invoke-direct {v0, p0, v1}, Lcom/reactnativegooglesignin/RNGoogleSigninModule$RNGoogleSigninActivityEventListener;-><init>(Lcom/reactnativegooglesignin/RNGoogleSigninModule;Lcom/reactnativegooglesignin/RNGoogleSigninModule-IA;)V
...
.method static synthetic access$100(Lcom/reactnativegooglesignin/RNGoogleSigninModule;)Lcom/facebook/react/bridge/ReactApplicationContext;
    .locals 0
...
.method private handleSignInTaskResult(Lcom/google/android/gms/tasks/Task;Lcom/reactnativegooglesignin/PromiseWrapper;)V
    ...
    .line 171
    const-string p0, "GoogleSignInAccount instance was null"

    invoke-virtual {p2, p0}, Lcom/reactnativegooglesignin/PromiseWrapper;->reject(Ljava/lang/String;)V

    return-void

    .line 173
    :cond_0
    invoke-static {p0}, Lcom/reactnativegooglesignin/Utils;->getUserProperties(Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;)Lcom/facebook/react/bridge/WritableMap;

    move-result-object p0

    .line 174
    invoke-virtual {p2, p0}, Lcom/reactnativegooglesignin/PromiseWrapper;->resolve(Ljava/lang/Object;)V
    :try_end_0
    ...
    const-string p1, "DEVELOPER_ERROR: Follow troubleshooting instructions at https://react-native-google-signin.github.io/docs/troubleshooting"

    invoke-virtual {p2, p0, p1}, Lcom/reactnativegooglesignin/PromiseWrapper;->reject(Ljava/lang/String;Ljava/lang/String;)V

    goto :goto_0

    .line 180
    :cond_1
    invoke-virtual {p2, p0}, Lcom/reactnativegooglesignin/PromiseWrapper;->reject(Ljava/lang/Exception;)V
...
.method private handleSignOutOrRevokeAccessTask(Lcom/google/android/gms/tasks/Task;Lcom/facebook/react/bridge/Promise;)V
    ...
    .line 274
    invoke-static {p0}, Lcom/google/android/gms/auth/api/signin/GoogleSignInStatusCodes;->getStatusCodeString(I)Ljava/lang/String;
...
.method private rejectWithNullClientError(Lcom/facebook/react/bridge/Promise;)V
    ...
    const-string v0, "apiClient is null - call configure() first"
...
.method private rerunFailedAuthTokenTask()V
    ...
    new-array p0, p0, [Lcom/facebook/react/bridge/WritableMap;
    ...
    invoke-virtual {v1, p0}, Lcom/reactnativegooglesignin/RNGoogleSigninModule$AccessTokenRetrievalTask;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
    ...
    const-string v0, "rerunFailedAuthTokenTask: recovery failed"

    invoke-virtual {p0, v0}, Lcom/reactnativegooglesignin/PromiseWrapper;->reject(Ljava/lang/String;)V
...
.method public addScopes(Lcom/facebook/react/bridge/ReadableMap;Lcom/facebook/react/bridge/Promise;)V
    ...
    const-string v2, "addScopes"

    invoke-virtual {p0, p2, v2}, Lcom/reactnativegooglesignin/PromiseWrapper;->setPromiseWithInProgressCheck(Lcom/facebook/react/bridge/Promise;Ljava/lang/String;)V
    ...
    invoke-static {p0}, Lcom/reactnativegooglesignin/Utils;->createScopesArray(Lcom/facebook/react/bridge/ReadableArray;)[Lcom/google/android/gms/common/api/Scope;
    ...
    .line 221
    invoke-static {v0, p1, v1, p0}, Lcom/google/android/gms/auth/api/signin/GoogleSignIn;->requestPermissions(Landroid/app/Activity;ILcom/google/android/gms/auth/api/signin/GoogleSignInAccount;[Lcom/google/android/gms/common/api/Scope;)V
...
.method public clearCachedAccessToken(Ljava/lang/String;Lcom/facebook/react/bridge/Promise;)V
    ...
    invoke-virtual {p2, p0}, Lcom/reactnativegooglesignin/RNGoogleSigninModule$TokenClearingTask;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
...
.method public getTokenClearingPromiseWrapper()Lcom/reactnativegooglesignin/PromiseWrapper;
    ...
    .line 76
    iget-object p0, p0, Lcom/reactnativegooglesignin/RNGoogleSigninModule;->tokenClearingPromiseWrapper:Lcom/reactnativegooglesignin/PromiseWrapper;
...
.method public getTokens(Lcom/facebook/react/bridge/Promise;)V
    ...
    .line 318
    const-string p0, "getTokens requires a user to be signed in"
...
.method protected getTypedExportedConstants()Ljava/util/Map;
    ...
    .line 95
    const-string v0, "SCOPES_ALREADY_GRANTED"

    const-string v1, "NEVER_HAPPENS_ON_ANDROID"
    ...
    const-string v1, "ASYNC_OP_IN_PROGRESS"
...
.method public playServicesAvailable(ZLcom/facebook/react/bridge/Promise;)V
    ...
    const-string p1, "could not determine playServicesAvailable, activity is null"
    ...
    .line 120
    invoke-virtual {v0, p0, v1, p1}, Lcom/google/android/gms/common/GoogleApiAvailability;->getErrorDialog(Landroid/app/Activity;II)Landroid/app/Dialog;
    ...
    const-string p1, "Play services not available"
