.class public Lorg/bouncyseoncastle/jce/provider/X509CertParser;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/bouncyseoncastle/jce/provider/X509CertParser;->d:Lorg/bouncyseoncastle/jce/provider/PEMUtil;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lorg/bouncyseoncastle/jce/provider/X509CertParser;->a:Lorg/bouncyseoncastle/asn1/ASN1Set;

    const/4 v1, 0x0

    iput v1, p0, Lorg/bouncyseoncastle/jce/provider/X509CertParser;->b:I

    iput-object v0, p0, Lorg/bouncyseoncastle/jce/provider/X509CertParser;->c:Ljava/io/InputStream;
...
.method private b()Ljava/security/cert/Certificate;
    ...
    .line 1
    iget-object v0, p0, Lorg/bouncyseoncastle/jce/provider/X509CertParser;->a:Lorg/bouncyseoncastle/asn1/ASN1Set;

    if-eqz v0, :cond_1

    :cond_0
    iget v0, p0, Lorg/bouncyseoncastle/jce/provider/X509CertParser;->b:I

    iget-object v1, p0, Lorg/bouncyseoncastle/jce/provider/X509CertParser;->a:Lorg/bouncyseoncastle/asn1/ASN1Set;
    ...
    iget v1, p0, Lorg/bouncyseoncastle/jce/provider/X509CertParser;->b:I

    add-int/lit8 v2, v1, 0x1

    iput v2, p0, Lorg/bouncyseoncastle/jce/provider/X509CertParser;->b:I
    ...
    new-instance p0, Lorg/bouncyseoncastle/jce/provider/X509CertificateObject;
    ...
    invoke-direct {p0, v0}, Lorg/bouncyseoncastle/jce/provider/X509CertificateObject;-><init>(Lorg/bouncyseoncastle/asn1/x509/Certificate;)V
...
.method private b(Ljava/io/InputStream;)Ljava/security/cert/Certificate;
    ...
    iput-object p1, p0, Lorg/bouncyseoncastle/jce/provider/X509CertParser;->a:Lorg/bouncyseoncastle/asn1/ASN1Set;

    invoke-direct {p0}, Lorg/bouncyseoncastle/jce/provider/X509CertParser;->b()Ljava/security/cert/Certificate;
    ...
    invoke-direct {p0, p1}, Lorg/bouncyseoncastle/jce/provider/X509CertificateObject;-><init>(Lorg/bouncyseoncastle/asn1/x509/Certificate;)V
...
.method private c(Ljava/io/InputStream;)Ljava/security/cert/Certificate;
    ...
    sget-object p0, Lorg/bouncyseoncastle/jce/provider/X509CertParser;->d:Lorg/bouncyseoncastle/jce/provider/PEMUtil;
    ...
    new-instance p1, Lorg/bouncyseoncastle/jce/provider/X509CertificateObject;
    ...
    invoke-direct {p1, p0}, Lorg/bouncyseoncastle/jce/provider/X509CertificateObject;-><init>(Lorg/bouncyseoncastle/asn1/x509/Certificate;)V
...
.method public a()Ljava/lang/Object;
    ...
    iget v2, p0, Lorg/bouncyseoncastle/jce/provider/X509CertParser;->b:I
    ...
    :cond_0
    iput-object v1, p0, Lorg/bouncyseoncastle/jce/provider/X509CertParser;->a:Lorg/bouncyseoncastle/asn1/ASN1Set;

    const/4 v0, 0x0

    iput v0, p0, Lorg/bouncyseoncastle/jce/provider/X509CertParser;->b:I

    return-object v1

    :cond_1
    iget-object v0, p0, Lorg/bouncyseoncastle/jce/provider/X509CertParser;->c:Ljava/io/InputStream;
    ...
    invoke-direct {p0, v0}, Lorg/bouncyseoncastle/jce/provider/X509CertParser;->c(Ljava/io/InputStream;)Ljava/security/cert/Certificate;
    ...
    invoke-direct {p0, v0}, Lorg/bouncyseoncastle/jce/provider/X509CertParser;->b(Ljava/io/InputStream;)Ljava/security/cert/Certificate;
...
.method public a(Ljava/io/InputStream;)V
    ...
    .line 1
    iput-object p1, p0, Lorg/bouncyseoncastle/jce/provider/X509CertParser;->c:Ljava/io/InputStream;
