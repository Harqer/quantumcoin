.class public Lorg/bouncyseoncastle/jce/provider/X509CRLEntryObject;
...
# direct methods
.method public constructor <init>(Lorg/bouncyseoncastle/asn1/x509/TBSCertList$CRLEntry;ZLorg/bouncyseoncastle/asn1/x500/X500Name;)V
    .locals 0

    invoke-direct {p0}, Ljava/security/cert/X509CRLEntry;-><init>()V

    iput-object p1, p0, Lorg/bouncyseoncastle/jce/provider/X509CRLEntryObject;->N3:Lorg/bouncyseoncastle/asn1/x509/TBSCertList$CRLEntry;

    invoke-direct {p0, p2, p3}, Lorg/bouncyseoncastle/jce/provider/X509CRLEntryObject;->a(ZLorg/bouncyseoncastle/asn1/x500/X500Name;)Lorg/bouncyseoncastle/asn1/x500/X500Name;

    move-result-object p1

    iput-object p1, p0, Lorg/bouncyseoncastle/jce/provider/X509CRLEntryObject;->O3:Lorg/bouncyseoncastle/asn1/x500/X500Name;
...
.method private a(Z)Ljava/util/Set;
    ...
    .line 2
    iget-object p0, p0, Lorg/bouncyseoncastle/jce/provider/X509CRLEntryObject;->N3:Lorg/bouncyseoncastle/asn1/x509/TBSCertList$CRLEntry;
...
.method private a(ZLorg/bouncyseoncastle/asn1/x500/X500Name;)Lorg/bouncyseoncastle/asn1/x500/X500Name;
    ...
    invoke-direct {p0, p1}, Lorg/bouncyseoncastle/jce/provider/X509CRLEntryObject;->a(Lorg/bouncyseoncastle/asn1/ASN1ObjectIdentifier;)Lorg/bouncyseoncastle/asn1/x509/Extension;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    :cond_0
    instance-of v0, p1, Lorg/bouncyseoncastle/jce/provider/X509CRLEntryObject;

    if-eqz v0, :cond_1

    check-cast p1, Lorg/bouncyseoncastle/jce/provider/X509CRLEntryObject;

    iget-object p0, p0, Lorg/bouncyseoncastle/jce/provider/X509CRLEntryObject;->N3:Lorg/bouncyseoncastle/asn1/x509/TBSCertList$CRLEntry;

    iget-object p1, p1, Lorg/bouncyseoncastle/jce/provider/X509CRLEntryObject;->N3:Lorg/bouncyseoncastle/asn1/x509/TBSCertList$CRLEntry;
...
.method public getCertificateIssuer()Ljavax/security/auth/x500/X500Principal;
    ...
    iget-object v0, p0, Lorg/bouncyseoncastle/jce/provider/X509CRLEntryObject;->O3:Lorg/bouncyseoncastle/asn1/x500/X500Name;
    ...
    iget-object p0, p0, Lorg/bouncyseoncastle/jce/provider/X509CRLEntryObject;->O3:Lorg/bouncyseoncastle/asn1/x500/X500Name;
...
.method public getCriticalExtensionOIDs()Ljava/util/Set;
    ...
    invoke-direct {p0, v0}, Lorg/bouncyseoncastle/jce/provider/X509CRLEntryObject;->a(Z)Ljava/util/Set;
...
.method public getExtensionValue(Ljava/lang/String;)[B
    ...
    invoke-direct {p0, v0}, Lorg/bouncyseoncastle/jce/provider/X509CRLEntryObject;->a(Lorg/bouncyseoncastle/asn1/ASN1ObjectIdentifier;)Lorg/bouncyseoncastle/asn1/x509/Extension;
...
.method public hasUnsupportedCriticalExtension()Z
    ...
    invoke-virtual {p0}, Lorg/bouncyseoncastle/jce/provider/X509CRLEntryObject;->getCriticalExtensionOIDs()Ljava/util/Set;
...
.method public hashCode()I
    ...
    iget-boolean v0, p0, Lorg/bouncyseoncastle/jce/provider/X509CRLEntryObject;->Q3:Z
    ...
    iput v0, p0, Lorg/bouncyseoncastle/jce/provider/X509CRLEntryObject;->P3:I

    const/4 v0, 0x1

    iput-boolean v0, p0, Lorg/bouncyseoncastle/jce/provider/X509CRLEntryObject;->Q3:Z

    :cond_0
    iget p0, p0, Lorg/bouncyseoncastle/jce/provider/X509CRLEntryObject;->P3:I
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lorg/bouncyseoncastle/jce/provider/X509CRLEntryObject;->getSerialNumber()Ljava/math/BigInteger;
    ...
    invoke-virtual {p0}, Lorg/bouncyseoncastle/jce/provider/X509CRLEntryObject;->getRevocationDate()Ljava/util/Date;
    ...
    invoke-virtual {p0}, Lorg/bouncyseoncastle/jce/provider/X509CRLEntryObject;->getCertificateIssuer()Ljavax/security/auth/x500/X500Principal;
