.class Lorg/bouncyseoncastle/pqc/crypto/util/PublicKeyFactory$SPHINCSPlusConverter;
...
.method synthetic constructor <init>(Lorg/bouncyseoncastle/pqc/crypto/util/PublicKeyFactory$1;)V
    ...
    .line 2
    invoke-direct {p0}, Lorg/bouncyseoncastle/pqc/crypto/util/PublicKeyFactory$SPHINCSPlusConverter;-><init>()V
...
.method a(Lorg/bouncyseoncastle/asn1/x509/SubjectPublicKeyInfo;Ljava/lang/Object;)Lorg/bouncyseoncastle/crypto/params/AsymmetricKeyParameter;
    ...
    invoke-static {p2}, Lorg/bouncyseoncastle/pqc/crypto/util/Utils;->m(Lorg/bouncyseoncastle/asn1/ASN1ObjectIdentifier;)Lorg/bouncyseoncastle/pqc/crypto/sphincsplus/SPHINCSPlusParameters;

    move-result-object p2

    new-instance v0, Lorg/bouncyseoncastle/pqc/crypto/sphincsplus/SPHINCSPlusPublicKeyParameters;

    array-length v1, p0

    const/4 v2, 0x4

    invoke-static {p0, v2, v1}, Lorg/bouncyseoncastle/util/Arrays;->b([BII)[B

    move-result-object p0

    invoke-direct {v0, p2, p0}, Lorg/bouncyseoncastle/pqc/crypto/sphincsplus/SPHINCSPlusPublicKeyParameters;-><init>(Lorg/bouncyseoncastle/pqc/crypto/sphincsplus/SPHINCSPlusParameters;[B)V
    :try_end_0
    ...
    invoke-static {p1}, Lorg/bouncyseoncastle/pqc/crypto/util/Utils;->m(Lorg/bouncyseoncastle/asn1/ASN1ObjectIdentifier;)Lorg/bouncyseoncastle/pqc/crypto/sphincsplus/SPHINCSPlusParameters;

    move-result-object p1

    new-instance p2, Lorg/bouncyseoncastle/pqc/crypto/sphincsplus/SPHINCSPlusPublicKeyParameters;

    invoke-direct {p2, p1, p0}, Lorg/bouncyseoncastle/pqc/crypto/sphincsplus/SPHINCSPlusPublicKeyParameters;-><init>(Lorg/bouncyseoncastle/pqc/crypto/sphincsplus/SPHINCSPlusParameters;[B)V
