.class public Lorg/bouncyseoncastle/crypto/modes/NISTCTSBlockCipher;
...
.method public a([BI)I
    ...
    iget-boolean v4, p0, Lorg/bouncyseoncastle/crypto/DefaultBufferedBlockCipher;->j:Z
    ...
    iget v4, p0, Lorg/bouncyseoncastle/crypto/modes/NISTCTSBlockCipher;->o:I
    ...
    :cond_0
    iget-object v4, p0, Lorg/bouncyseoncastle/crypto/DefaultBufferedBlockCipher;->h:[B

    invoke-static {v4, v7, v3, v7, v0}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    iget-object v4, p0, Lorg/bouncyseoncastle/crypto/DefaultBufferedBlockCipher;->k:Lorg/bouncyseoncastle/crypto/BlockCipher;

    invoke-interface {v4, v3, v7, v3, v7}, Lorg/bouncyseoncastle/crypto/BlockCipher;->a([BI[BI)I
    ...
    iget-object v3, p0, Lorg/bouncyseoncastle/crypto/DefaultBufferedBlockCipher;->k:Lorg/bouncyseoncastle/crypto/BlockCipher;

    invoke-interface {v3, v1, v7, v1, v7}, Lorg/bouncyseoncastle/crypto/BlockCipher;->a([BI[BI)I
    ...
    iget-object v5, p0, Lorg/bouncyseoncastle/crypto/DefaultBufferedBlockCipher;->h:[B

    invoke-interface {v4, v5, v7, v3, v7}, Lorg/bouncyseoncastle/crypto/BlockCipher;->a([BI[BI)I
    ...
    invoke-interface {v4, v1, v7, v1, v7}, Lorg/bouncyseoncastle/crypto/BlockCipher;->a([BI[BI)I
    ...
    invoke-interface {v1, v2, v7, v3, v7}, Lorg/bouncyseoncastle/crypto/BlockCipher;->a([BI[BI)I
    ...
    iget v8, p0, Lorg/bouncyseoncastle/crypto/modes/NISTCTSBlockCipher;->o:I
    ...
    check-cast v1, Lorg/bouncyseoncastle/crypto/modes/CBCModeCipher;

    invoke-interface {v1}, Lorg/bouncyseoncastle/crypto/modes/CBCModeCipher;->c()Lorg/bouncyseoncastle/crypto/BlockCipher;

    move-result-object v1

    iget-object v5, p0, Lorg/bouncyseoncastle/crypto/DefaultBufferedBlockCipher;->h:[B

    iget v6, p0, Lorg/bouncyseoncastle/crypto/DefaultBufferedBlockCipher;->i:I

    sub-int/2addr v6, v0

    invoke-interface {v1, v5, v6, v4, v7}, Lorg/bouncyseoncastle/crypto/BlockCipher;->a([BI[BI)I
    ...
    invoke-interface {v1, v3, v7, v3, v7}, Lorg/bouncyseoncastle/crypto/BlockCipher;->a([BI[BI)I
    ...
    instance-of v5, v1, Lorg/bouncyseoncastle/crypto/modes/CBCModeCipher;
    ...
    invoke-interface {v1, v5, v7, v3, v7}, Lorg/bouncyseoncastle/crypto/BlockCipher;->a([BI[BI)I
    ...
    :goto_4
    iget v5, p0, Lorg/bouncyseoncastle/crypto/DefaultBufferedBlockCipher;->i:I
    ...
    iget-object v8, p0, Lorg/bouncyseoncastle/crypto/DefaultBufferedBlockCipher;->h:[B
    ...
    invoke-interface {v1, v3, v7, p1, p2}, Lorg/bouncyseoncastle/crypto/BlockCipher;->a([BI[BI)I
...
.method public a([BII[BI)I
    ...
    invoke-virtual {p0, p3}, Lorg/bouncyseoncastle/crypto/modes/NISTCTSBlockCipher;->b(I)I
    ...
    invoke-interface {v2, v3, v4, p4, v5}, Lorg/bouncyseoncastle/crypto/BlockCipher;->a([BI[BI)I
