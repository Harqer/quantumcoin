.class Lorg/bouncyseoncastle/crypto/util/PublicKeyFactory$DHAgreementConverter;
...
.method synthetic constructor <init>(Lorg/bouncyseoncastle/crypto/util/PublicKeyFactory$1;)V
    ...
    .line 2
    invoke-direct {p0}, Lorg/bouncyseoncastle/crypto/util/PublicKeyFactory$DHAgreementConverter;-><init>()V
...
.method a(Lorg/bouncyseoncastle/asn1/x509/SubjectPublicKeyInfo;Ljava/lang/Object;)Lorg/bouncyseoncastle/crypto/params/AsymmetricKeyParameter;
    ...
    invoke-static {p0}, Lorg/bouncyseoncastle/asn1/pkcs/DHParameter;->a(Ljava/lang/Object;)Lorg/bouncyseoncastle/asn1/pkcs/DHParameter;
    ...
    invoke-virtual {p0}, Lorg/bouncyseoncastle/asn1/pkcs/DHParameter;->j()Ljava/math/BigInteger;

    move-result-object v1

    invoke-virtual {p0}, Lorg/bouncyseoncastle/asn1/pkcs/DHParameter;->h()Ljava/math/BigInteger;

    move-result-object p0

    const/4 v2, 0x0

    invoke-direct {v0, v1, p0, v2, p2}, Lorg/bouncyseoncastle/crypto/params/DHParameters;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;I)V

    new-instance p0, Lorg/bouncyseoncastle/crypto/params/DHPublicKeyParameters;

    invoke-virtual {p1}, Lorg/bouncyseoncastle/asn1/ASN1Integer;->l()Ljava/math/BigInteger;

    move-result-object p1

    invoke-direct {p0, p1, v0}, Lorg/bouncyseoncastle/crypto/params/DHPublicKeyParameters;-><init>(Ljava/math/BigInteger;Lorg/bouncyseoncastle/crypto/params/DHParameters;)V
