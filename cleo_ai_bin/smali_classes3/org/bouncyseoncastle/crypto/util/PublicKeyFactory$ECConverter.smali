.class Lorg/bouncyseoncastle/crypto/util/PublicKeyFactory$ECConverter;
...
.method synthetic constructor <init>(Lorg/bouncyseoncastle/crypto/util/PublicKeyFactory$1;)V
    ...
    .line 2
    invoke-direct {p0}, Lorg/bouncyseoncastle/crypto/util/PublicKeyFactory$ECConverter;-><init>()V
...
.method a(Lorg/bouncyseoncastle/asn1/x509/SubjectPublicKeyInfo;Ljava/lang/Object;)Lorg/bouncyseoncastle/crypto/params/AsymmetricKeyParameter;
    ...
    invoke-static {p0}, Lorg/bouncyseoncastle/asn1/x9/X962Parameters;->a(Ljava/lang/Object;)Lorg/bouncyseoncastle/asn1/x9/X962Parameters;

    move-result-object p0

    invoke-virtual {p0}, Lorg/bouncyseoncastle/asn1/x9/X962Parameters;->j()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-virtual {p0}, Lorg/bouncyseoncastle/asn1/x9/X962Parameters;->h()Lorg/bouncyseoncastle/asn1/ASN1Primitive;
    ...
    invoke-direct {v0, p0, p2}, Lorg/bouncyseoncastle/crypto/params/ECNamedDomainParameters;-><init>(Lorg/bouncyseoncastle/asn1/ASN1ObjectIdentifier;Lorg/bouncyseoncastle/asn1/x9/X9ECParameters;)V

    goto :goto_0

    :cond_1
    invoke-virtual {p0}, Lorg/bouncyseoncastle/asn1/x9/X962Parameters;->i()Z
    ...
    check-cast v0, Lorg/bouncyseoncastle/crypto/params/ECDomainParameters;
    ...
    invoke-direct {v0, p0}, Lorg/bouncyseoncastle/crypto/params/ECDomainParameters;-><init>(Lorg/bouncyseoncastle/asn1/x9/X9ECParameters;)V
    ...
    invoke-direct {p1, p0}, Lorg/bouncyseoncastle/asn1/DEROctetString;-><init>([B)V
    ...
    :cond_3
    new-instance p2, Lorg/bouncyseoncastle/asn1/x9/X9IntegerConverter;

    invoke-direct {p2}, Lorg/bouncyseoncastle/asn1/x9/X9IntegerConverter;-><init>()V

    invoke-virtual {v0}, Lorg/bouncyseoncastle/crypto/params/ECDomainParameters;->a()Lorg/bouncyseoncastle/math/ec/ECCurve;

    move-result-object v2

    invoke-virtual {p2, v2}, Lorg/bouncyseoncastle/asn1/x9/X9IntegerConverter;->a(Lorg/bouncyseoncastle/math/ec/ECCurve;)I
    ...
    :cond_4
    :goto_1
    new-instance p0, Lorg/bouncyseoncastle/asn1/x9/X9ECPoint;

    invoke-virtual {v0}, Lorg/bouncyseoncastle/crypto/params/ECDomainParameters;->a()Lorg/bouncyseoncastle/math/ec/ECCurve;

    move-result-object p2

    invoke-direct {p0, p2, p1}, Lorg/bouncyseoncastle/asn1/x9/X9ECPoint;-><init>(Lorg/bouncyseoncastle/math/ec/ECCurve;Lorg/bouncyseoncastle/asn1/ASN1OctetString;)V
