.class Lorg/bouncyseoncastle/crypto/engines/RSACoreEngine;
.super Ljava/lang/Object;
.source "SourceFile"


# instance fields
.field private a:Lorg/bouncyseoncastle/crypto/params/RSAKeyParameters;
...
.method private a(ZZ)Lorg/bouncyseoncastle/crypto/CryptoServicePurpose;
    .locals 3
...
.method public a()I
    ...
    .line 3
    iget-object v0, p0, Lorg/bouncyseoncastle/crypto/engines/RSACoreEngine;->a:Lorg/bouncyseoncastle/crypto/params/RSAKeyParameters;
    ...
    iget-boolean p0, p0, Lorg/bouncyseoncastle/crypto/engines/RSACoreEngine;->b:Z
...
.method public a([BII)Ljava/math/BigInteger;
    ...
    iget-boolean v0, p0, Lorg/bouncyseoncastle/crypto/engines/RSACoreEngine;->b:Z
    ...
    iget-object p0, p0, Lorg/bouncyseoncastle/crypto/engines/RSACoreEngine;->a:Lorg/bouncyseoncastle/crypto/params/RSAKeyParameters;
...
.method public a(ZLorg/bouncyseoncastle/crypto/CipherParameters;)V
    ...
    :cond_0
    iput-boolean p1, p0, Lorg/bouncyseoncastle/crypto/engines/RSACoreEngine;->b:Z

    check-cast p2, Lorg/bouncyseoncastle/crypto/params/RSAKeyParameters;

    iput-object p2, p0, Lorg/bouncyseoncastle/crypto/engines/RSACoreEngine;->a:Lorg/bouncyseoncastle/crypto/params/RSAKeyParameters;

    invoke-virtual {p2}, Lorg/bouncyseoncastle/crypto/params/RSAKeyParameters;->c()Ljava/math/BigInteger;

    move-result-object p2

    invoke-static {p2}, Lorg/bouncyseoncastle/crypto/constraints/ConstraintUtils;->a(Ljava/math/BigInteger;)I
    ...
    invoke-direct {p0, v0, p1}, Lorg/bouncyseoncastle/crypto/engines/RSACoreEngine;->a(ZZ)Lorg/bouncyseoncastle/crypto/CryptoServicePurpose;
    ...
    invoke-direct {v0, v1, p2, p0, p1}, Lorg/bouncyseoncastle/crypto/constraints/DefaultServiceProperties;-><init>(Ljava/lang/String;ILjava/lang/Object;Lorg/bouncyseoncastle/crypto/CryptoServicePurpose;)V
...
.method public b(Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    invoke-virtual {v0}, Lorg/bouncyseoncastle/crypto/params/RSAPrivateCrtKeyParameters;->f()Ljava/math/BigInteger;

    move-result-object p0

    invoke-virtual {v0}, Lorg/bouncyseoncastle/crypto/params/RSAPrivateCrtKeyParameters;->h()Ljava/math/BigInteger;

    move-result-object v2

    invoke-virtual {v0}, Lorg/bouncyseoncastle/crypto/params/RSAPrivateCrtKeyParameters;->d()Ljava/math/BigInteger;

    move-result-object v3

    invoke-virtual {v0}, Lorg/bouncyseoncastle/crypto/params/RSAPrivateCrtKeyParameters;->e()Ljava/math/BigInteger;

    move-result-object v4

    invoke-virtual {v0}, Lorg/bouncyseoncastle/crypto/params/RSAPrivateCrtKeyParameters;->i()Ljava/math/BigInteger;
    ...
    invoke-virtual {p0, v4}, Ljava/math/BigInteger;->add(Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    invoke-virtual {v0}, Lorg/bouncyseoncastle/crypto/params/RSAKeyParameters;->b()Ljava/math/BigInteger;
