.class Lorg/bouncyseoncastle/asn1/sec/SECNamedCurves$12;
...
.method protected a()Lorg/bouncyseoncastle/math/ec/ECCurve;
    ...
    invoke-static {v0}, Lorg/bouncyseoncastle/asn1/sec/SECNamedCurves;->a(Ljava/lang/String;)Ljava/math/BigInteger;
    ...
    new-instance v0, Lorg/bouncyseoncastle/math/ec/endo/GLVTypeBParameters;
    ...
    new-instance v10, Lorg/bouncyseoncastle/math/ec/endo/ScalarSplitParameters;
    ...
    invoke-direct/range {v10 .. v15}, Lorg/bouncyseoncastle/math/ec/endo/ScalarSplitParameters;-><init>([Ljava/math/BigInteger;[Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;I)V

    invoke-direct {v0, v1, v7, v10}, Lorg/bouncyseoncastle/math/ec/endo/GLVTypeBParameters;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Lorg/bouncyseoncastle/math/ec/endo/ScalarSplitParameters;)V

    new-instance v1, Lorg/bouncyseoncastle/math/ec/ECCurve$Fp;

    const/4 v7, 0x1

    invoke-direct/range {v1 .. v7}, Lorg/bouncyseoncastle/math/ec/ECCurve$Fp;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Z)V

    invoke-static {v1, v0}, Lorg/bouncyseoncastle/asn1/sec/SECNamedCurves;->a(Lorg/bouncyseoncastle/math/ec/ECCurve;Lorg/bouncyseoncastle/math/ec/endo/GLVTypeBParameters;)Lorg/bouncyseoncastle/math/ec/ECCurve;
