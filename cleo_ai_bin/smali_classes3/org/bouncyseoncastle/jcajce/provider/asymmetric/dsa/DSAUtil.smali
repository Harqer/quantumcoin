.class public Lorg/bouncyseoncastle/jcajce/provider/asymmetric/dsa/DSAUtil;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/dsa/DSAUtil;->a:[Lorg/bouncyseoncastle/asn1/ASN1ObjectIdentifier;
...
.method static a(Ljava/math/BigInteger;Ljava/security/interfaces/DSAParams;)Ljava/lang/String;
    ...
    invoke-static {p0, v1, v2, p1}, Lorg/bouncyseoncastle/util/Arrays;->a([B[B[B[B)[B
...
.method public static a(Ljava/security/PrivateKey;)Lorg/bouncyseoncastle/crypto/params/AsymmetricKeyParameter;
    ...
    invoke-direct {v2, v3, v4, p0}, Lorg/bouncyseoncastle/crypto/params/DSAParameters;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    invoke-direct {v0, v1, v2}, Lorg/bouncyseoncastle/crypto/params/DSAPrivateKeyParameters;-><init>(Ljava/math/BigInteger;Lorg/bouncyseoncastle/crypto/params/DSAParameters;)V
...
.method public static a(Ljava/security/PublicKey;)Lorg/bouncyseoncastle/crypto/params/AsymmetricKeyParameter;
    ...
    .line 3
    instance-of v0, p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;

    if-eqz v0, :cond_0

    check-cast p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;

    invoke-virtual {p0}, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;->a()Lorg/bouncyseoncastle/crypto/params/DSAPublicKeyParameters;
    ...
    invoke-direct {v0, p0}, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;-><init>(Ljava/security/interfaces/DSAPublicKey;)V

    invoke-virtual {v0}, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;->a()Lorg/bouncyseoncastle/crypto/params/DSAPublicKeyParameters;
    ...
    new-instance v1, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;
    ...
    invoke-direct {v1, v0}, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;-><init>(Lorg/bouncyseoncastle/asn1/x509/SubjectPublicKeyInfo;)V

    invoke-virtual {v1}, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;->a()Lorg/bouncyseoncastle/crypto/params/DSAPublicKeyParameters;
...
.method static a(Ljava/security/interfaces/DSAParams;)Lorg/bouncyseoncastle/crypto/params/DSAParameters;
    .locals 3

    if-eqz p0, :cond_0

    .line 5
    new-instance v0, Lorg/bouncyseoncastle/crypto/params/DSAParameters;
    ...
    invoke-direct {v0, v1, v2, p0}, Lorg/bouncyseoncastle/crypto/params/DSAParameters;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V
...
.method public static a(Lorg/bouncyseoncastle/asn1/ASN1ObjectIdentifier;)Z
    ...
    .line 4
    :goto_0
    sget-object v2, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/dsa/DSAUtil;->a:[Lorg/bouncyseoncastle/asn1/ASN1ObjectIdentifier;
