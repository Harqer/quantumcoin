.class public Lorg/bouncyseoncastle/jcajce/provider/asymmetric/dsa/AlgorithmParametersSpi;
...
.method protected a(Ljava/lang/Class;)Ljava/security/spec/AlgorithmParameterSpec;
    ...
    :cond_1
    :goto_0
    iget-object p0, p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/dsa/AlgorithmParametersSpi;->a:Ljava/security/spec/DSAParameterSpec;
...
.method protected engineGetEncoded()[B
    ...
    iget-object v1, p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/dsa/AlgorithmParametersSpi;->a:Ljava/security/spec/DSAParameterSpec;

    invoke-virtual {v1}, Ljava/security/spec/DSAParameterSpec;->getP()Ljava/math/BigInteger;

    move-result-object v1

    iget-object v2, p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/dsa/AlgorithmParametersSpi;->a:Ljava/security/spec/DSAParameterSpec;
    ...
    invoke-direct {v0, v1, v2, p0}, Lorg/bouncyseoncastle/asn1/x509/DSAParameter;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V
...
.method protected engineGetEncoded(Ljava/lang/String;)[B
    ...
    .line 2
    invoke-virtual {p0, p1}, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/dsa/AlgorithmParametersSpi;->a(Ljava/lang/String;)Z

    move-result p1

    if-eqz p1, :cond_0

    invoke-virtual {p0}, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/dsa/AlgorithmParametersSpi;->engineGetEncoded()[B
...
.method protected engineGetParameterSpec(Ljava/lang/Class;)Ljava/security/spec/AlgorithmParameterSpec;
    ...
    invoke-virtual {p0, p1}, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/dsa/AlgorithmParametersSpi;->a(Ljava/lang/Class;)Ljava/security/spec/AlgorithmParameterSpec;
...
.method protected engineInit(Ljava/security/spec/AlgorithmParameterSpec;)V
    ...
    iput-object p1, p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/dsa/AlgorithmParametersSpi;->a:Ljava/security/spec/DSAParameterSpec;
...
.method protected engineInit([B)V
    ...
    iput-object v1, p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/dsa/AlgorithmParametersSpi;->a:Ljava/security/spec/DSAParameterSpec;
    :try_end_0
...
.method protected engineInit([BLjava/lang/String;)V
    ...
    .line 3
    invoke-virtual {p0, p2}, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/dsa/AlgorithmParametersSpi;->a(Ljava/lang/String;)Z
    ...
    :cond_1
    :goto_0
    invoke-virtual {p0, p1}, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/dsa/AlgorithmParametersSpi;->engineInit([B)V
