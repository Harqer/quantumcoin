.class public Lorg/bouncyseoncastle/jcajce/provider/asymmetric/elgamal/BCElGamalPrivateKey;
...
.field private transient O3:Lorg/bouncyseoncastle/jce/spec/ElGamalParameterSpec;
...
.method constructor <init>(Ljavax/crypto/interfaces/DHPrivateKey;)V
    ...
    iput-object v0, p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/elgamal/BCElGamalPrivateKey;->P3:Lorg/bouncyseoncastle/jcajce/provider/asymmetric/util/PKCS12BagAttributeCarrierImpl;

    invoke-interface {p1}, Ljavax/crypto/interfaces/DHPrivateKey;->getX()Ljava/math/BigInteger;

    move-result-object v0

    iput-object v0, p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/elgamal/BCElGamalPrivateKey;->N3:Ljava/math/BigInteger;

    new-instance v0, Lorg/bouncyseoncastle/jce/spec/ElGamalParameterSpec;
    ...
    invoke-direct {v0, v1, p1}, Lorg/bouncyseoncastle/jce/spec/ElGamalParameterSpec;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    iput-object v0, p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/elgamal/BCElGamalPrivateKey;->O3:Lorg/bouncyseoncastle/jce/spec/ElGamalParameterSpec;
...
.method constructor <init>(Lorg/bouncyseoncastle/asn1/pkcs/PrivateKeyInfo;)V
    ...
    iput-object p1, p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/elgamal/BCElGamalPrivateKey;->N3:Ljava/math/BigInteger;

    new-instance p1, Lorg/bouncyseoncastle/jce/spec/ElGamalParameterSpec;
    ...
    invoke-direct {p1, v1, v0}, Lorg/bouncyseoncastle/jce/spec/ElGamalParameterSpec;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    iput-object p1, p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/elgamal/BCElGamalPrivateKey;->O3:Lorg/bouncyseoncastle/jce/spec/ElGamalParameterSpec;

    return-void
.end method

.method constructor <init>(Lorg/bouncyseoncastle/crypto/params/ElGamalPrivateKeyParameters;)V
    .locals 2
    ...
    invoke-virtual {p1}, Lorg/bouncyseoncastle/crypto/params/ElGamalPrivateKeyParameters;->c()Ljava/math/BigInteger;
...
.method constructor <init>(Lorg/bouncyseoncastle/jce/interfaces/ElGamalPrivateKey;)V
    .locals 1
    ...
    invoke-interface {p1}, Lorg/bouncyseoncastle/jce/interfaces/ElGamalPrivateKey;->getX()Ljava/math/BigInteger;
...
.method constructor <init>(Lorg/bouncyseoncastle/jce/spec/ElGamalPrivateKeySpec;)V
    .locals 2
    ...
    invoke-virtual {p1}, Lorg/bouncyseoncastle/jce/spec/ElGamalPrivateKeySpec;->b()Ljava/math/BigInteger;
    ...
    invoke-virtual {p1}, Lorg/bouncyseoncastle/jce/spec/ElGamalKeySpec;->a()Lorg/bouncyseoncastle/jce/spec/ElGamalParameterSpec;
...
.method public a(Lorg/bouncyseoncastle/asn1/ASN1ObjectIdentifier;)Lorg/bouncyseoncastle/asn1/ASN1Encodable;
    ...
    .line 1
    iget-object p0, p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/elgamal/BCElGamalPrivateKey;->P3:Lorg/bouncyseoncastle/jcajce/provider/asymmetric/util/PKCS12BagAttributeCarrierImpl;
...
.method public a()Lorg/bouncyseoncastle/jce/spec/ElGamalParameterSpec;
    ...
    .line 2
    iget-object p0, p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/elgamal/BCElGamalPrivateKey;->O3:Lorg/bouncyseoncastle/jce/spec/ElGamalParameterSpec;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0}, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/elgamal/BCElGamalPrivateKey;->getX()Ljava/math/BigInteger;
    ...
    invoke-virtual {p0}, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/elgamal/BCElGamalPrivateKey;->getParams()Ljavax/crypto/spec/DHParameterSpec;
...
.method public getEncoded()[B
    ...
    new-instance v3, Lorg/bouncyseoncastle/internal/asn1/oiw/ElGamalParameter;

    iget-object v4, p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/elgamal/BCElGamalPrivateKey;->O3:Lorg/bouncyseoncastle/jce/spec/ElGamalParameterSpec;

    invoke-virtual {v4}, Lorg/bouncyseoncastle/jce/spec/ElGamalParameterSpec;->b()Ljava/math/BigInteger;

    move-result-object v4

    iget-object v5, p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/elgamal/BCElGamalPrivateKey;->O3:Lorg/bouncyseoncastle/jce/spec/ElGamalParameterSpec;

    invoke-virtual {v5}, Lorg/bouncyseoncastle/jce/spec/ElGamalParameterSpec;->a()Ljava/math/BigInteger;

    move-result-object v5

    invoke-direct {v3, v4, v5}, Lorg/bouncyseoncastle/internal/asn1/oiw/ElGamalParameter;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;)V
...
.method public getParams()Ljavax/crypto/spec/DHParameterSpec;
    ...
    iget-object v1, p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/elgamal/BCElGamalPrivateKey;->O3:Lorg/bouncyseoncastle/jce/spec/ElGamalParameterSpec;
...
.method public getX()Ljava/math/BigInteger;
    ...
    iget-object p0, p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/elgamal/BCElGamalPrivateKey;->N3:Ljava/math/BigInteger;
