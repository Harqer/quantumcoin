.class public Lorg/bouncyseoncastle/jcajce/provider/asymmetric/elgamal/AlgorithmParameterGeneratorSpi;
...
.method protected engineGenerateParameters()Ljava/security/AlgorithmParameters;
    ...
    iget-object v1, p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/elgamal/AlgorithmParameterGeneratorSpi;->b:Ljava/security/SecureRandom;

    const/16 v2, 0x14

    if-eqz v1, :cond_0

    iget v3, p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/elgamal/AlgorithmParameterGeneratorSpi;->c:I

    invoke-virtual {v0, v3, v2, v1}, Lorg/bouncyseoncastle/crypto/generators/ElGamalParametersGenerator;->a(IILjava/security/SecureRandom;)V

    goto :goto_0

    :cond_0
    iget v1, p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/elgamal/AlgorithmParameterGeneratorSpi;->c:I
    ...
    invoke-virtual {v0}, Lorg/bouncyseoncastle/crypto/params/ElGamalParameters;->a()Ljava/math/BigInteger;

    move-result-object v0

    iget p0, p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/elgamal/AlgorithmParameterGeneratorSpi;->d:I
...
.method protected engineInit(ILjava/security/SecureRandom;)V
    ...
    .line 1
    iput p1, p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/elgamal/AlgorithmParameterGeneratorSpi;->c:I

    iput-object p2, p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/elgamal/AlgorithmParameterGeneratorSpi;->b:Ljava/security/SecureRandom;
...
.method protected engineInit(Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    iput v0, p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/elgamal/AlgorithmParameterGeneratorSpi;->c:I

    invoke-virtual {p1}, Ljavax/crypto/spec/DHGenParameterSpec;->getExponentSize()I

    move-result p1

    iput p1, p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/elgamal/AlgorithmParameterGeneratorSpi;->d:I
