.class public Lorg/bouncyseoncastle/jcajce/provider/asymmetric/edec/BCXDHPrivateKey;
.super Ljava/lang/Object;
.source "SourceFile"

# interfaces
.implements Lorg/bouncyseoncastle/jcajce/interfaces/XDHPrivateKey;
...
.method constructor <init>(Lorg/bouncyseoncastle/asn1/pkcs/PrivateKeyInfo;)V
    ...
    iput-boolean v0, p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/edec/BCXDHPrivateKey;->Q3:Z
    ...
    :goto_0
    iput-object v0, p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/edec/BCXDHPrivateKey;->R3:[B

    invoke-direct {p0, p1}, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/edec/BCXDHPrivateKey;->a(Lorg/bouncyseoncastle/asn1/pkcs/PrivateKeyInfo;)V
...
.method constructor <init>(Lorg/bouncyseoncastle/crypto/params/AsymmetricKeyParameter;)V
    ...
    iput-object p1, p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/edec/BCXDHPrivateKey;->N3:Lorg/bouncyseoncastle/crypto/params/AsymmetricKeyParameter;
    ...
    invoke-virtual {p1}, Lorg/bouncyseoncastle/crypto/params/X448PrivateKeyParameters;->b()Lorg/bouncyseoncastle/crypto/params/X448PublicKeyParameters;
    ...
    invoke-virtual {p1}, Lorg/bouncyseoncastle/crypto/params/X25519PrivateKeyParameters;->b()Lorg/bouncyseoncastle/crypto/params/X25519PublicKeyParameters;

    move-result-object p1

    :goto_0
    iput-object p1, p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/edec/BCXDHPrivateKey;->O3:Lorg/bouncyseoncastle/crypto/params/AsymmetricKeyParameter;

    invoke-direct {p0}, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/edec/BCXDHPrivateKey;->a()I

    move-result p1

    iput p1, p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/edec/BCXDHPrivateKey;->P3:I
...
.method private a()I
    ...
    .line 1
    iget-object v0, p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/edec/BCXDHPrivateKey;->O3:Lorg/bouncyseoncastle/crypto/params/AsymmetricKeyParameter;

    instance-of v1, v0, Lorg/bouncyseoncastle/crypto/params/X448PublicKeyParameters;

    if-eqz v1, :cond_0

    check-cast v0, Lorg/bouncyseoncastle/crypto/params/X448PublicKeyParameters;

    invoke-virtual {v0}, Lorg/bouncyseoncastle/crypto/params/X448PublicKeyParameters;->b()[B
    ...
    :cond_0
    check-cast v0, Lorg/bouncyseoncastle/crypto/params/X25519PublicKeyParameters;

    invoke-virtual {v0}, Lorg/bouncyseoncastle/crypto/params/X25519PublicKeyParameters;->b()[B

    move-result-object v0

    :goto_0
    invoke-virtual {p0}, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/edec/BCXDHPrivateKey;->getAlgorithm()Ljava/lang/String;
...
.method private a(Lorg/bouncyseoncastle/asn1/pkcs/PrivateKeyInfo;)V
    ...
    .line 2
    invoke-virtual {p1}, Lorg/bouncyseoncastle/asn1/pkcs/PrivateKeyInfo;->k()I
    ...
    new-instance p1, Lorg/bouncyseoncastle/crypto/params/X448PrivateKeyParameters;

    invoke-direct {p1, v0}, Lorg/bouncyseoncastle/crypto/params/X448PrivateKeyParameters;-><init>([B)V
    ...
    :cond_2
    new-instance p1, Lorg/bouncyseoncastle/crypto/params/X25519PrivateKeyParameters;

    invoke-direct {p1, v0}, Lorg/bouncyseoncastle/crypto/params/X25519PrivateKeyParameters;-><init>([B)V
...
.method private p()Lorg/bouncyseoncastle/asn1/pkcs/PrivateKeyInfo;
    ...
    :try_start_0
    iget-object v0, p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/edec/BCXDHPrivateKey;->R3:[B

    invoke-static {v0}, Lorg/bouncyseoncastle/asn1/ASN1Set;->a(Ljava/lang/Object;)Lorg/bouncyseoncastle/asn1/ASN1Set;

    move-result-object v0

    iget-object v1, p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/edec/BCXDHPrivateKey;->N3:Lorg/bouncyseoncastle/crypto/params/AsymmetricKeyParameter;
    ...
    iget-boolean p0, p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/edec/BCXDHPrivateKey;->Q3:Z
...
.method public equals(Ljava/lang/Object;)Z
    ...
    invoke-direct {p0}, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/edec/BCXDHPrivateKey;->p()Lorg/bouncyseoncastle/asn1/pkcs/PrivateKeyInfo;

    move-result-object p0

    instance-of v0, p1, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/edec/BCXDHPrivateKey;

    if-eqz v0, :cond_2

    check-cast p1, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/edec/BCXDHPrivateKey;

    invoke-direct {p1}, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/edec/BCXDHPrivateKey;->p()Lorg/bouncyseoncastle/asn1/pkcs/PrivateKeyInfo;
...
.method public getAlgorithm()Ljava/lang/String;
    ...
    :cond_0
    iget-object p0, p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/edec/BCXDHPrivateKey;->N3:Lorg/bouncyseoncastle/crypto/params/AsymmetricKeyParameter;

    instance-of p0, p0, Lorg/bouncyseoncastle/crypto/params/X448PrivateKeyParameters;
...
.method public hashCode()I
    ...
    iget p0, p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/edec/BCXDHPrivateKey;->P3:I
...
.method public toString()Ljava/lang/String;
    ...
    iget-object p0, p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/edec/BCXDHPrivateKey;->O3:Lorg/bouncyseoncastle/crypto/params/AsymmetricKeyParameter;
