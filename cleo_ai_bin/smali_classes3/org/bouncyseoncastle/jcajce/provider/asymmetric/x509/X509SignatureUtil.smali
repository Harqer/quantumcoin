.class Lorg/bouncyseoncastle/jcajce/provider/asymmetric/x509/X509SignatureUtil;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/x509/X509SignatureUtil;->a:Ljava/util/Map;
...
.method private static a(Ljava/security/Provider;Lorg/bouncyseoncastle/asn1/ASN1ObjectIdentifier;)Ljava/lang/String;
    .locals 2
...
.method private static a(Lorg/bouncyseoncastle/asn1/ASN1ObjectIdentifier;)Ljava/lang/String;
    ...
    invoke-static {v0, p0}, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/x509/X509SignatureUtil;->a(Ljava/security/Provider;Lorg/bouncyseoncastle/asn1/ASN1ObjectIdentifier;)Ljava/lang/String;
    ...
    invoke-static {v3, p0}, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/x509/X509SignatureUtil;->a(Ljava/security/Provider;Lorg/bouncyseoncastle/asn1/ASN1ObjectIdentifier;)Ljava/lang/String;
...
.method static a(Lorg/bouncyseoncastle/asn1/x509/AlgorithmIdentifier;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/x509/X509SignatureUtil;->a(Lorg/bouncyseoncastle/asn1/ASN1Encodable;)Z
    ...
    invoke-static {p0}, Lorg/bouncyseoncastle/asn1/pkcs/RSASSAPSSparams;->a(Ljava/lang/Object;)Lorg/bouncyseoncastle/asn1/pkcs/RSASSAPSSparams;
    ...
    invoke-static {p0}, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/x509/X509SignatureUtil;->b(Lorg/bouncyseoncastle/asn1/ASN1ObjectIdentifier;)Ljava/lang/String;
    ...
    :cond_0
    sget-object v1, Lorg/bouncyseoncastle/asn1/x9/X9ObjectIdentifiers;->J2:Lorg/bouncyseoncastle/asn1/ASN1ObjectIdentifier;
    ...
    :cond_1
    sget-object p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/x509/X509SignatureUtil;->a:Ljava/util/Map;
    ...
    :cond_2
    invoke-static {v0}, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/x509/X509SignatureUtil;->a(Lorg/bouncyseoncastle/asn1/ASN1ObjectIdentifier;)Ljava/lang/String;
...
.method static a(Ljava/security/Signature;Lorg/bouncyseoncastle/asn1/ASN1Encodable;)V
    ...
    .line 7
    invoke-static {p1}, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/x509/X509SignatureUtil;->a(Lorg/bouncyseoncastle/asn1/ASN1Encodable;)Z
...
.method static a([BLjava/lang/StringBuffer;Ljava/lang/String;)V
    .locals 4
    ...
    invoke-static {p0, v1, v2}, Lorg/bouncyseoncastle/util/encoders/Hex;->b([BII)Ljava/lang/String;
    ...
    invoke-static {p0, v0, v2}, Lorg/bouncyseoncastle/util/encoders/Hex;->b([BII)Ljava/lang/String;
    ...
    invoke-static {p0, v0, v3}, Lorg/bouncyseoncastle/util/encoders/Hex;->b([BII)Ljava/lang/String;
...
.method private static a(Lorg/bouncyseoncastle/asn1/ASN1Encodable;)Z
    .locals 1
    ...
    invoke-virtual {v0, p0}, Lorg/bouncyseoncastle/asn1/ASN1Primitive;->a(Lorg/bouncyseoncastle/asn1/ASN1Encodable;)Z
...
.method static a(Lorg/bouncyseoncastle/asn1/x509/AlgorithmIdentifier;Lorg/bouncyseoncastle/asn1/x509/AlgorithmIdentifier;)Z
    .locals 2
    ...
    :cond_0
    const-string v0, "org.bouncyseoncastle.x509.allow_absent_equiv_NULL"
    ...
    invoke-static {v0}, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/x509/X509SignatureUtil;->a(Lorg/bouncyseoncastle/asn1/ASN1Encodable;)Z
    ...
    invoke-static {p0, p1}, Lorg/bouncyseoncastle/util/Objects;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method private static b(Lorg/bouncyseoncastle/asn1/ASN1ObjectIdentifier;)Ljava/lang/String;
    .locals 3

    .line 1
    invoke-static {p0}, Lorg/bouncyseoncastle/jcajce/util/MessageDigestUtils;->a(Lorg/bouncyseoncastle/asn1/ASN1ObjectIdentifier;)Ljava/lang/String;
...
.method static b(Lorg/bouncyseoncastle/asn1/x509/AlgorithmIdentifier;)Z
    .locals 1

    .line 2
    sget-object v0, Lorg/bouncyseoncastle/internal/asn1/misc/MiscObjectIdentifiers;->P:Lorg/bouncyseoncastle/asn1/ASN1ObjectIdentifier;
