.class public Lorg/bouncyseoncastle/jcajce/provider/asymmetric/rsa/KeyFactorySpi;
...
.method public a(Lorg/bouncyseoncastle/asn1/pkcs/PrivateKeyInfo;)Ljava/security/PrivateKey;
    ...
    invoke-static {p0}, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/rsa/RSAUtil;->a(Lorg/bouncyseoncastle/asn1/ASN1ObjectIdentifier;)Z
    ...
    new-instance v0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateKey;

    invoke-virtual {p1}, Lorg/bouncyseoncastle/asn1/pkcs/PrivateKeyInfo;->j()Lorg/bouncyseoncastle/asn1/x509/AlgorithmIdentifier;

    move-result-object p1

    invoke-direct {v0, p1, p0}, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateKey;-><init>(Lorg/bouncyseoncastle/asn1/x509/AlgorithmIdentifier;Lorg/bouncyseoncastle/asn1/pkcs/RSAPrivateKey;)V

    return-object v0

    :cond_0
    new-instance p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateCrtKey;

    invoke-direct {p0, p1}, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateCrtKey;-><init>(Lorg/bouncyseoncastle/asn1/pkcs/PrivateKeyInfo;)V
...
.method public a(Lorg/bouncyseoncastle/asn1/x509/SubjectPublicKeyInfo;)Ljava/security/PublicKey;
    ...
    new-instance p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/rsa/BCRSAPublicKey;

    invoke-direct {p0, p1}, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/rsa/BCRSAPublicKey;-><init>(Lorg/bouncyseoncastle/asn1/x509/SubjectPublicKeyInfo;)V
...
.method protected engineGeneratePrivate(Ljava/security/spec/KeySpec;)Ljava/security/PrivateKey;
    ...
    invoke-static {v0}, Lorg/bouncyseoncastle/asn1/pkcs/PrivateKeyInfo;->a(Ljava/lang/Object;)Lorg/bouncyseoncastle/asn1/pkcs/PrivateKeyInfo;

    move-result-object v0

    invoke-virtual {p0, v0}, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/rsa/KeyFactorySpi;->a(Lorg/bouncyseoncastle/asn1/pkcs/PrivateKeyInfo;)Ljava/security/PrivateKey;
    ...
    :try_start_1
    new-instance v0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateCrtKey;
    ...
    invoke-direct {v0, p1}, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateCrtKey;-><init>(Lorg/bouncyseoncastle/asn1/pkcs/RSAPrivateKey;)V
    :try_end_1
    ...
    :catch_1
    new-instance p1, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/util/ExtendedInvalidKeySpecException;
    ...
    invoke-direct {p1, v0, p0}, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/util/ExtendedInvalidKeySpecException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {p0, p1}, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateCrtKey;-><init>(Ljava/security/spec/RSAPrivateCrtKeySpec;)V
    ...
    new-instance p0, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateKey;

    check-cast p1, Ljava/security/spec/RSAPrivateKeySpec;

    invoke-direct {p0, p1}, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateKey;-><init>(Ljava/security/spec/RSAPrivateKeySpec;)V

    return-object p0

    :cond_2
    instance-of p0, p1, Lorg/bouncyseoncastle/jcajce/spec/OpenSSHPrivateKeySpec;
    ...
    instance-of p1, p0, Lorg/bouncyseoncastle/crypto/params/RSAPrivateCrtKeyParameters;

    if-eqz p1, :cond_3

    new-instance p1, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateCrtKey;

    check-cast p0, Lorg/bouncyseoncastle/crypto/params/RSAPrivateCrtKeyParameters;

    invoke-direct {p1, p0}, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateCrtKey;-><init>(Lorg/bouncyseoncastle/crypto/params/RSAPrivateCrtKeyParameters;)V
...
.method protected engineGeneratePublic(Ljava/security/spec/KeySpec;)Ljava/security/PublicKey;
    ...
    invoke-direct {p0, p1}, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/rsa/BCRSAPublicKey;-><init>(Ljava/security/spec/RSAPublicKeySpec;)V
    ...
    instance-of p1, p0, Lorg/bouncyseoncastle/crypto/params/RSAKeyParameters;

    if-eqz p1, :cond_1

    new-instance p1, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/rsa/BCRSAPublicKey;

    check-cast p0, Lorg/bouncyseoncastle/crypto/params/RSAKeyParameters;

    invoke-direct {p1, p0}, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/rsa/BCRSAPublicKey;-><init>(Lorg/bouncyseoncastle/crypto/params/RSAKeyParameters;)V
...
.method protected engineGetKeySpec(Ljava/security/Key;Ljava/lang/Class;)Ljava/security/spec/KeySpec;
    ...
    new-instance p2, Lorg/bouncyseoncastle/crypto/params/RSAKeyParameters;
    ...
    invoke-direct {p2, v2, v0, p1}, Lorg/bouncyseoncastle/crypto/params/RSAKeyParameters;-><init>(ZLjava/math/BigInteger;Ljava/math/BigInteger;)V
    ...
    new-instance v2, Lorg/bouncyseoncastle/crypto/params/RSAPrivateCrtKeyParameters;
    ...
    invoke-direct/range {v2 .. v10}, Lorg/bouncyseoncastle/crypto/params/RSAPrivateCrtKeyParameters;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    invoke-static {v2}, Lorg/bouncyseoncastle/crypto/util/OpenSSHPrivateKeyUtil;->a(Lorg/bouncyseoncastle/crypto/params/AsymmetricKeyParameter;)[B
...
.method protected engineTranslateKey(Ljava/security/Key;)Ljava/security/Key;
    ...
    invoke-direct {p0, p1}, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/rsa/BCRSAPublicKey;-><init>(Ljava/security/interfaces/RSAPublicKey;)V
    ...
    invoke-direct {p0, p1}, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateCrtKey;-><init>(Ljava/security/interfaces/RSAPrivateCrtKey;)V
    ...
    invoke-direct {p0, p1}, Lorg/bouncyseoncastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateKey;-><init>(Ljava/security/interfaces/RSAPrivateKey;)V
