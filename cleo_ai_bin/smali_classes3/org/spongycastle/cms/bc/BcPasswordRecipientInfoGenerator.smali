...
.method protected calculateDerivedKey(ILorg/spongycastle/asn1/x509/AlgorithmIdentifier;I)[B
    ...
    .line 29
    iget-object p0, p0, Lorg/spongycastle/cms/bc/BcPasswordRecipientInfoGenerator;->password:[C
    ...
    invoke-virtual {p1, p0, v0, p2}, Lorg/spongycastle/crypto/generators/PKCS5S2ParametersGenerator;->init([B[BI)V
...
.method public generateEncryptedBytes(Lorg/spongycastle/asn1/x509/AlgorithmIdentifier;[BLorg/spongycastle/operator/GenericKey;)[B
    ...
    invoke-static {p3}, Lorg/spongycastle/cms/bc/EnvelopedDataHelper;->createRFC3211Wrapper(Lorg/spongycastle/asn1/ASN1ObjectIdentifier;)Lorg/spongycastle/crypto/Wrapper;
    ...
    invoke-interface {p3, p1, v0}, Lorg/spongycastle/crypto/Wrapper;->init(ZLorg/spongycastle/crypto/CipherParameters;)V
    ...
    invoke-interface {p3, p0, p1, p2}, Lorg/spongycastle/crypto/Wrapper;->wrap([BII)[B
