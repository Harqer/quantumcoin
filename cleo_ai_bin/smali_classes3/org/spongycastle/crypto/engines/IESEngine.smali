...
.method private decryptBlock([BII)[B
    ...
    .line 342
    invoke-virtual {p0, v0}, Lorg/spongycastle/crypto/engines/IESEngine;->getLengthTag([B)[B
    ...
    invoke-static {v6, v7, v5}, Lorg/spongycastle/util/Arrays;->copyOfRange([BII)[B
    ...
    invoke-interface {v4, v6, p2, p3}, Lorg/spongycastle/crypto/Mac;->update([BII)V
    ...
    invoke-interface {p2, v0, v1, p3}, Lorg/spongycastle/crypto/Mac;->update([BII)V
    ...
    invoke-interface {p2, v2, v1, p3}, Lorg/spongycastle/crypto/Mac;->update([BII)V

    .line 361
    :cond_6
    iget-object p2, p0, Lorg/spongycastle/crypto/engines/IESEngine;->mac:Lorg/spongycastle/crypto/Mac;

    invoke-interface {p2, v8, v1}, Lorg/spongycastle/crypto/Mac;->doFinal([BI)I

    .line 363
    invoke-static {v5, v8}, Lorg/spongycastle/util/Arrays;->constantTimeAreEqual([B[B)Z
    ...
    .line 374
    :cond_7
    invoke-virtual {p0, v3, p1}, Lorg/spongycastle/crypto/BufferedBlockCipher;->doFinal([BI)I
    ...
    .line 376
    invoke-static {v3, v1, p1}, Lorg/spongycastle/util/Arrays;->copyOfRange([BII)[B
