...
.method public createEntry(Ljava/lang/String;ILorg/spongycastle/cert/X509CertificateHolder;)Lorg/spongycastle/cert/dane/DANEEntry;
    ...
    .line 53
    iget-object p0, p0, Lorg/spongycastle/cert/dane/DANEEntryFactory;->selectorFactory:Lorg/spongycastle/cert/dane/DANEEntrySelectorFactory;

    invoke-virtual {p0, p1}, Lorg/spongycastle/cert/dane/DANEEntrySelectorFactory;->createSelector(Ljava/lang/String;)Lorg/spongycastle/cert/dane/DANEEntrySelector;
    ...
    .line 60
    new-instance p1, Lorg/spongycastle/cert/dane/DANEEntry;

    invoke-virtual {p0}, Lorg/spongycastle/cert/dane/DANEEntrySelector;->getDomainName()Ljava/lang/String;

    move-result-object p0

    invoke-direct {p1, p0, p2, p3}, Lorg/spongycastle/cert/dane/DANEEntry;-><init>(Ljava/lang/String;[BLorg/spongycastle/cert/X509CertificateHolder;)V

    return-object p1

    .line 50
    :cond_0
    new-instance p0, Lorg/spongycastle/cert/dane/DANEException;
    ...
    invoke-direct {p0, p1}, Lorg/spongycastle/cert/dane/DANEException;-><init>(Ljava/lang/String;)V
