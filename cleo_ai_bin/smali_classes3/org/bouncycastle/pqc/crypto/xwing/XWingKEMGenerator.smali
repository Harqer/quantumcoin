...
.method public generateEncapsulated(Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;)Lorg/bouncycastle/crypto/SecretWithEncapsulation;
    ...
    iget-object p0, p0, Lorg/bouncycastle/pqc/crypto/xwing/XWingKEMGenerator;->sr:Ljava/security/SecureRandom;

    invoke-direct {v7, p0}, Lorg/bouncycastle/crypto/params/X25519KeyGenerationParameters;-><init>(Ljava/security/SecureRandom;)V
    ...
    invoke-virtual {v1, v5, v4, v2}, Lorg/bouncycastle/crypto/agreement/X25519Agreement;->calculateAgreement(Lorg/bouncycastle/crypto/CipherParameters;[BI)V
    ...
    invoke-virtual {v1, v2, v6, v5}, Lorg/bouncycastle/crypto/digests/SHA3Digest;->update([BII)V

    invoke-virtual {v1, v4, v6, v3}, Lorg/bouncycastle/crypto/digests/SHA3Digest;->update([BII)V
    ...
    invoke-virtual {v1, v2, v6, v3}, Lorg/bouncycastle/crypto/digests/SHA3Digest;->update([BII)V
    ...
    invoke-virtual {v1, p1, v6, v3}, Lorg/bouncycastle/crypto/digests/SHA3Digest;->update([BII)V

    new-array p1, v3, [B

    invoke-virtual {v1, p1, v6}, Lorg/bouncycastle/crypto/digests/SHA3Digest;->doFinal([BI)I
    ...
    invoke-direct {v1, p1, p0}, Lorg/bouncycastle/pqc/crypto/util/SecretWithEncapsulationImpl;-><init>([B[B)V
