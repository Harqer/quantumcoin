...
.method public kem_dec([B[B[B)V
    ...
    invoke-static {v1, v8, v3}, Lorg/bouncycastle/util/Arrays;->copyOfRange([BII)[B
    ...
    iget v1, v0, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->D:I
    ...
    invoke-static {v2, v3, v1}, Lorg/bouncycastle/util/Arrays;->copyOfRange([BII)[B
    ...
    :goto_1
    iget v14, v0, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->n:I
    ...
    invoke-static {v1, v14}, Lorg/bouncycastle/util/Pack;->littleEndianToShort([BI)S
    ...
    invoke-direct {v0, v4, v7, v1}, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->matrix_transpose([SII)[S
    ...
    invoke-direct {v0, v15, v2, v7, v7}, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->matrix_sub([S[SII)[S
    ...
    invoke-interface {v4, v14, v8, v5}, Lorg/bouncycastle/crypto/Xof;->update([BII)V

    iget-object v4, v0, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->digest:Lorg/bouncycastle/crypto/Xof;

    iget v5, v0, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->len_mu_bytes:I

    invoke-interface {v4, v2, v8, v5}, Lorg/bouncycastle/crypto/Xof;->update([BII)V
    ...
    invoke-interface {v6, v7}, Lorg/bouncycastle/crypto/Xof;->update(B)V

    iget-object v6, v0, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->digest:Lorg/bouncycastle/crypto/Xof;

    iget v7, v0, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->len_seedSE_bytes:I

    invoke-interface {v6, v3, v8, v7}, Lorg/bouncycastle/crypto/Xof;->update([BII)V

    iget-object v3, v0, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->digest:Lorg/bouncycastle/crypto/Xof;

    invoke-interface {v3, v5, v8, v4}, Lorg/bouncycastle/crypto/Xof;->doFinal([BII)I
    ...
    invoke-direct {v0, v7, v8, v4, v3}, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->sample_matrix([SIII)[S
    ...
    invoke-direct {v0, v7, v6, v4, v5}, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->sample_matrix([SIII)[S
    ...
    invoke-virtual {v6, v12}, Lorg/bouncycastle/pqc/crypto/frodo/FrodoMatrixGenerator;->genMatrix([B)[S
    ...
    invoke-direct {v0, v2, v10, v9, v3}, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->matrix_add([S[SII)[S
    ...
    invoke-direct {v0, v7, v2, v9, v9}, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->sample_matrix([SIII)[S

    move-result-object v7

    iget v2, v0, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->n:I

    invoke-direct {v0, v13, v2, v9}, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->unpack([BII)[S
    ...
    invoke-direct {v0, v1, v7, v9, v9}, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->matrix_add([S[SII)[S
    ...
    invoke-direct {v0, v1, v2, v9, v9}, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->matrix_add([S[SII)[S

    move-result-object v1

    invoke-direct {v0, v12, v15, v10, v1}, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->ctverify([S[S[S[S)S

    move-result v1

    invoke-direct {v0, v14, v11, v1}, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->ctselect([B[BS)[B
    ...
    invoke-interface {v2, v3, v5, v4}, Lorg/bouncycastle/crypto/Xof;->update([BII)V
    ...
    invoke-interface {v2, v1, v5, v3}, Lorg/bouncycastle/crypto/Xof;->update([BII)V
...
.method public kem_enc([B[B[BLjava/security/SecureRandom;)V
    ...
    invoke-static {v1, v7, v8}, Lorg/bouncycastle/util/Arrays;->copyOfRange([BII)[B
    ...
    iget v3, p0, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->len_mu_bytes:I
    ...
    invoke-interface {v1, v3, v7, v4}, Lorg/bouncycastle/crypto/Xof;->doFinal([BII)I

    iget v1, p0, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->len_seedSE:I
    ...
    invoke-interface {v4, v3, v7, v5}, Lorg/bouncycastle/crypto/Xof;->update([BII)V
    ...
    invoke-interface {v3, v10, v7, v4}, Lorg/bouncycastle/crypto/Xof;->update([BII)V
    ...
    invoke-interface {v3, v1, v7, v4}, Lorg/bouncycastle/crypto/Xof;->doFinal([BII)I

    iget v3, p0, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->len_seedSE_bytes:I

    invoke-static {v1, v7, v3}, Lorg/bouncycastle/util/Arrays;->copyOfRange([BII)[B
    ...
    invoke-interface {v5, v3, v7, v6}, Lorg/bouncycastle/crypto/Xof;->update([BII)V

    iget-object v3, p0, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->digest:Lorg/bouncycastle/crypto/Xof;

    invoke-interface {v3, v4, v7, v1}, Lorg/bouncycastle/crypto/Xof;->doFinal([BII)I
    ...
    invoke-direct {p0, v12, v7, v13, v1}, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->sample_matrix([SIII)[S
    ...
    invoke-virtual {v3, v2}, Lorg/bouncycastle/pqc/crypto/frodo/FrodoMatrixGenerator;->genMatrix([B)[S
    ...
    invoke-direct {p0, v9, v2, v13}, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->unpack([BII)[S
    ...
    invoke-direct {p0, v1, v8, v13, v13}, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->matrix_add([S[SII)[S

    move-result-object v1

    invoke-direct {p0, v10}, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->encode([B)[S
    ...
    invoke-static {v14, v1}, Lorg/bouncycastle/util/Arrays;->concatenate([B[B)[B
    ...
    invoke-interface {v2, v14, v7, v3}, Lorg/bouncycastle/crypto/Xof;->update([BII)V

    iget-object v2, p0, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->digest:Lorg/bouncycastle/crypto/Xof;

    array-length v3, v1

    invoke-interface {v2, v1, v7, v3}, Lorg/bouncycastle/crypto/Xof;->update([BII)V

    iget-object v1, p0, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->digest:Lorg/bouncycastle/crypto/Xof;

    iget v2, p0, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->len_k_bytes:I

    invoke-interface {v1, v11, v7, v2}, Lorg/bouncycastle/crypto/Xof;->update([BII)V
    ...
    invoke-interface {v1, v2, v7, v0}, Lorg/bouncycastle/crypto/Xof;->doFinal([BII)I
...
.method public kem_keypair([B[BLjava/security/SecureRandom;)V
    ...
    invoke-direct {v5, p0, v1, v6, v3}, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->matrix_add([S[SII)[S
    ...
    invoke-static {v4, p0}, Lorg/bouncycastle/util/Arrays;->concatenate([B[B)[B

    move-result-object p0

    iget v1, v5, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->len_pk_bytes:I
    ...
    invoke-interface {v4, v1, v2, p0}, Lorg/bouncycastle/crypto/Xof;->doFinal([BII)I
    ...
    :goto_2
    iget p3, v5, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->n:I
    ...
    iget v4, v5, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->len_s_bytes:I

    iget v6, v5, Lorg/bouncycastle/pqc/crypto/frodo/FrodoEngine;->len_pk_bytes:I
