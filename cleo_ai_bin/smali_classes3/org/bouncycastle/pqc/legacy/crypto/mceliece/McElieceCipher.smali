...
.method private computeMessageRepresentative([B)Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Vector;
    ...
    iget p0, p0, Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McElieceCipher;->k:I

    invoke-static {p0, v0}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Vector;->OS2VP(I[B)Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Vector;
...
.method private initCipherDecrypt(Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McEliecePrivateKeyParameters;)V
    ...
    iput p1, p0, Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McElieceCipher;->k:I

    shr-int/lit8 p1, p1, 0x3

    iput p1, p0, Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McElieceCipher;->maxPlainTextSize:I

    iget p1, p0, Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McElieceCipher;->n:I

    shr-int/lit8 p1, p1, 0x3

    iput p1, p0, Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McElieceCipher;->cipherTextSize:I
...
.method private initCipherEncrypt(Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McEliecePublicKeyParameters;)V
    ...
    iput p1, p0, Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McElieceCipher;->t:I
    ...
    iget p1, p0, Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McElieceCipher;->k:I
...
.method public getKeySize(Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McElieceKeyParameters;)I
    ...
    instance-of p0, p1, Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McEliecePublicKeyParameters;
    ...
    :cond_0
    instance-of p0, p1, Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McEliecePrivateKeyParameters;
...
.method public init(ZLorg/bouncycastle/crypto/CipherParameters;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McElieceCipher;->sr:Ljava/security/SecureRandom;
    ...
    iput-object p1, p0, Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McElieceCipher;->key:Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McElieceKeyParameters;

    move-object p2, p1

    check-cast p2, Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McEliecePublicKeyParameters;

    invoke-direct {p0, p1}, Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McElieceCipher;->initCipherEncrypt(Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McEliecePublicKeyParameters;)V
    ...
    invoke-direct {p0, p2}, Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McElieceCipher;->initCipherEncrypt(Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McEliecePublicKeyParameters;)V
    ...
    invoke-direct {p0, p2}, Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McElieceCipher;->initCipherDecrypt(Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McEliecePrivateKeyParameters;)V
...
.method public messageDecrypt([B)[B
    ...
    invoke-virtual {v4, v5}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/Permutation;->rightMultiply(Lorg/bouncycastle/pqc/legacy/math/linearalgebra/Permutation;)Lorg/bouncycastle/pqc/legacy/math/linearalgebra/Permutation;

    move-result-object v5

    invoke-virtual {v5}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/Permutation;->computeInverse()Lorg/bouncycastle/pqc/legacy/math/linearalgebra/Permutation;

    move-result-object v7

    invoke-virtual {p1, v7}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Vector;->multiply(Lorg/bouncycastle/pqc/legacy/math/linearalgebra/Permutation;)Lorg/bouncycastle/pqc/legacy/math/linearalgebra/Vector;

    move-result-object p1

    check-cast p1, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Vector;

    invoke-virtual {v6, p1}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Matrix;->rightMultiply(Lorg/bouncycastle/pqc/legacy/math/linearalgebra/Vector;)Lorg/bouncycastle/pqc/legacy/math/linearalgebra/Vector;

    move-result-object v6

    check-cast v6, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Vector;
    ...
    invoke-virtual {p1, v0}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Vector;->add(Lorg/bouncycastle/pqc/legacy/math/linearalgebra/Vector;)Lorg/bouncycastle/pqc/legacy/math/linearalgebra/Vector;

    move-result-object p1

    check-cast p1, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Vector;

    invoke-virtual {p1, v4}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Vector;->multiply(Lorg/bouncycastle/pqc/legacy/math/linearalgebra/Permutation;)Lorg/bouncycastle/pqc/legacy/math/linearalgebra/Vector;
    ...
    invoke-virtual {p1, v0}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Vector;->extractRightVector(I)Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Vector;

    move-result-object p1

    invoke-virtual {v3, p1}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Matrix;->leftMultiply(Lorg/bouncycastle/pqc/legacy/math/linearalgebra/Vector;)Lorg/bouncycastle/pqc/legacy/math/linearalgebra/Vector;

    move-result-object p1

    check-cast p1, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Vector;

    invoke-direct {p0, p1}, Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McElieceCipher;->computeMessage(Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Vector;)[B
...
.method public messageEncrypt([B)[B
    ...
    iget v1, p0, Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McElieceCipher;->n:I

    iget v2, p0, Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McElieceCipher;->t:I

    iget-object v3, p0, Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McElieceCipher;->sr:Ljava/security/SecureRandom;

    invoke-direct {v0, v1, v2, v3}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Vector;-><init>(IILjava/security/SecureRandom;)V

    iget-object p0, p0, Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McElieceCipher;->key:Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McElieceKeyParameters;

    check-cast p0, Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McEliecePublicKeyParameters;

    invoke-virtual {p0}, Lorg/bouncycastle/pqc/legacy/crypto/mceliece/McEliecePublicKeyParameters;->getG()Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Matrix;

    move-result-object p0

    invoke-virtual {p0, p1}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Matrix;->leftMultiply(Lorg/bouncycastle/pqc/legacy/math/linearalgebra/Vector;)Lorg/bouncycastle/pqc/legacy/math/linearalgebra/Vector;

    move-result-object p0

    invoke-virtual {p0, v0}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/Vector;->add(Lorg/bouncycastle/pqc/legacy/math/linearalgebra/Vector;)Lorg/bouncycastle/pqc/legacy/math/linearalgebra/Vector;
