...
.method public constructor <init>(IILorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSDigestProvider;)V
    ...
    iput-object p3, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSRootCalc;->messDigestTree:Lorg/bouncycastle/crypto/Digest;

    invoke-interface {p3}, Lorg/bouncycastle/crypto/Digest;->getDigestSize()I

    move-result p3

    iput p3, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSRootCalc;->mdLength:I
    ...
    iput-object p1, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSRootCalc;->AuthPath:[[B

    iget p1, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSRootCalc;->mdLength:I

    new-array p1, p1, [B

    iput-object p1, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSRootCalc;->root:[B

    iget p1, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSRootCalc;->K:I

    sub-int/2addr p1, v1

    new-array p1, p1, [Ljava/util/Vector;

    iput-object p1, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSRootCalc;->retain:[Ljava/util/Vector;
    ...
    iget-object p1, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSRootCalc;->retain:[Ljava/util/Vector;
...
.method public getAuthPath()[[B
    ...
    iget-object p0, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSRootCalc;->AuthPath:[[B

    invoke-static {p0}, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSUtils;->clone([[B)[[B
...
.method public getRetain()[Ljava/util/Vector;
    ...
    iget-object p0, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSRootCalc;->retain:[Ljava/util/Vector;

    invoke-static {p0}, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSUtils;->clone([Ljava/util/Vector;)[Ljava/util/Vector;
...
.method public getRoot()[B
    ...
    iget-object p0, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSRootCalc;->root:[B
...
.method public getStack()Ljava/util/Vector;
    ...
    iget-object p0, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSRootCalc;->tailStack:Ljava/util/Vector;
...
.method public getStatByte()[[B
    ...
    iget-object v4, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSRootCalc;->root:[B
    ...
    :goto_1
    iget v5, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSRootCalc;->heightOfTree:I
...
.method public getStatInt()[I
    ...
    iget-object v5, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSRootCalc;->index:[I
...
.method public getTreehash()[Lorg/bouncycastle/pqc/legacy/crypto/gmss/Treehash;
    ...
    iget-object p0, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSRootCalc;->treehash:[Lorg/bouncycastle/pqc/legacy/crypto/gmss/Treehash;

    invoke-static {p0}, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSUtils;->clone([Lorg/bouncycastle/pqc/legacy/crypto/gmss/Treehash;)[Lorg/bouncycastle/pqc/legacy/crypto/gmss/Treehash;
...
.method public initialize(Ljava/util/Vector;)V
    ...
    iget v3, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSRootCalc;->K:I

    sub-int v3, v2, v3

    if-ge v1, v3, :cond_0

    iget-object v2, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSRootCalc;->treehash:[Lorg/bouncycastle/pqc/legacy/crypto/gmss/Treehash;

    new-instance v3, Lorg/bouncycastle/pqc/legacy/crypto/gmss/Treehash;

    iget-object v4, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSRootCalc;->digestProvider:Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSDigestProvider;

    invoke-interface {v4}, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSDigestProvider;->get()Lorg/bouncycastle/crypto/Digest;

    move-result-object v4

    invoke-direct {v3, p1, v1, v4}, Lorg/bouncycastle/pqc/legacy/crypto/gmss/Treehash;-><init>(Ljava/util/Vector;ILorg/bouncycastle/crypto/Digest;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSRootCalc;->index:[I
    ...
    iput-object p1, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSRootCalc;->tailStack:Ljava/util/Vector;

    new-instance p1, Ljava/util/Vector;

    invoke-direct {p1}, Ljava/util/Vector;-><init>()V

    iput-object p1, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSRootCalc;->heightOfNodes:Ljava/util/Vector;

    iput-boolean v3, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSRootCalc;->isInitialized:Z

    iput-boolean v0, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSRootCalc;->isFinished:Z
    ...
    iput p1, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSRootCalc;->indexForNextSeed:I
...
.method public initializeTreehashSeed([BI)V
    ...
    invoke-virtual {p0, p1}, Lorg/bouncycastle/pqc/legacy/crypto/gmss/Treehash;->initializeSeed([B)V
...
.method public toString()Ljava/lang/String;
    ...
    iget-object p0, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSRootCalc;->digestProvider:Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSDigestProvider;

    invoke-interface {p0}, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSDigestProvider;->get()Lorg/bouncycastle/crypto/Digest;
...
.method public update([B)V
    ...
    iget-object v2, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSRootCalc;->AuthPath:[[B
    ...
    invoke-virtual {v2, p1}, Lorg/bouncycastle/pqc/legacy/crypto/gmss/Treehash;->setFirstNode([B)V
    ...
    iget-object p0, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSRootCalc;->heightOfNodes:Ljava/util/Vector;
    ...
    iget-object v2, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSRootCalc;->messDigestTree:Lorg/bouncycastle/crypto/Digest;
    ...
    invoke-virtual {v2, v4}, Lorg/bouncycastle/pqc/legacy/crypto/gmss/Treehash;->setFirstNode([B)V
    ...
    iget-object p1, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSRootCalc;->tailStack:Ljava/util/Vector;
...
.method public update([B[B)V
    ...
    iget v1, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSRootCalc;->indexForNextSeed:I
    ...
    iget p1, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSRootCalc;->heightOfNextSeed:I

    add-int/lit8 p1, p1, 0x1

    iput p1, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSRootCalc;->heightOfNextSeed:I

    iget p1, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSRootCalc;->indexForNextSeed:I
...
.method public wasFinished()Z
    ...
    iget-boolean p0, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSRootCalc;->isFinished:Z
...
.method public wasInitialized()Z
    ...
    iget-boolean p0, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSRootCalc;->isInitialized:Z
