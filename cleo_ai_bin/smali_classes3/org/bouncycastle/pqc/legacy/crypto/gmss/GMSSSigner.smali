...
.method public constructor <init>(Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSDigestProvider;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSSigner;->messDigestTrees:Lorg/bouncycastle/crypto/Digest;

    iput-object p1, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSSigner;->messDigestOTS:Lorg/bouncycastle/crypto/Digest;

    invoke-interface {p1}, Lorg/bouncycastle/crypto/Digest;->getDigestSize()I

    move-result p1

    iput p1, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSSigner;->mdLength:I
    ...
    iput-object p1, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSSigner;->gmssRandom:Lorg/bouncycastle/pqc/legacy/crypto/gmss/util/GMSSRandom;
...
.method private initSign()V
    ...
    iget-object v2, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSSigner;->gmssRandom:Lorg/bouncycastle/pqc/legacy/crypto/gmss/util/GMSSRandom;

    invoke-virtual {v2, v5}, Lorg/bouncycastle/pqc/legacy/crypto/gmss/util/GMSSRandom;->nextSeed([B)[B

    move-result-object v2

    new-instance v3, Lorg/bouncycastle/pqc/legacy/crypto/gmss/util/WinternitzOTSignature;

    iget-object v5, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSSigner;->digestProvider:Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSDigestProvider;

    invoke-interface {v5}, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSDigestProvider;->get()Lorg/bouncycastle/crypto/Digest;

    move-result-object v5

    iget-object v6, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSSigner;->gmssPS:Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSParameters;

    invoke-virtual {v6}, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSParameters;->getWinternitzParameter()[I
    ...
    invoke-direct {v3, v2, v5, v6}, Lorg/bouncycastle/pqc/legacy/crypto/gmss/util/WinternitzOTSignature;-><init>([BLorg/bouncycastle/crypto/Digest;I)V

    iput-object v3, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSSigner;->ots:Lorg/bouncycastle/pqc/legacy/crypto/gmss/util/WinternitzOTSignature;
    ...
    iput-object v3, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSSigner;->currentAuthPaths:[[[B

    move v3, v1

    :goto_0
    iget v5, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSSigner;->numLayer:I

    if-ge v3, v5, :cond_1

    iget-object v5, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSSigner;->currentAuthPaths:[[[B

    aget-object v6, v2, v3

    array-length v6, v6

    iget v7, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSSigner;->mdLength:I
    ...
    iget-object v7, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSSigner;->currentAuthPaths:[[[B

    aget-object v7, v7, v3

    aget-object v7, v7, v5

    iget v8, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSSigner;->mdLength:I
    ...
    iput-object v2, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSSigner;->index:[I
    ...
    iget v2, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSSigner;->numLayer:I

    sub-int/2addr v2, v4

    new-array v2, v2, [[B

    iput-object v2, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSSigner;->subtreeRootSig:[[B
    ...
    invoke-virtual {v0, v2}, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSPrivateKeyParameters;->getSubtreeRootSig(I)[B

    move-result-object v3

    iget-object v5, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSSigner;->subtreeRootSig:[[B
...
.method private initVerify()V
    ...
    iput-object v0, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSSigner;->gmssPS:Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSParameters;

    invoke-virtual {v0}, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSParameters;->getNumOfLayers()I

    move-result v0

    iput v0, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSSigner;->numLayer:I
...
.method public generateSignature([B)[B
    ...
    iget-object v0, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSSigner;->ots:Lorg/bouncycastle/pqc/legacy/crypto/gmss/util/WinternitzOTSignature;

    invoke-virtual {v0, p1}, Lorg/bouncycastle/pqc/legacy/crypto/gmss/util/WinternitzOTSignature;->getSignature([B)[B

    move-result-object p1

    iget-object v0, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSSigner;->gmssUtil:Lorg/bouncycastle/pqc/legacy/crypto/gmss/util/GMSSUtil;

    iget-object v1, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSSigner;->currentAuthPaths:[[[B
    ...
    invoke-virtual {v0, v1}, Lorg/bouncycastle/pqc/legacy/crypto/gmss/util/GMSSUtil;->concatenateArray([[B)[B
    ...
    iget-object v2, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSSigner;->index:[I
    ...
    invoke-virtual {v1, v2}, Lorg/bouncycastle/pqc/legacy/crypto/gmss/util/GMSSUtil;->intToBytesLittleEndian(I)[B
    ...
    iget v0, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSSigner;->numLayer:I
    ...
    iget-object v4, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSSigner;->currentAuthPaths:[[[B

    aget-object v4, v4, v0

    invoke-virtual {v1, v4}, Lorg/bouncycastle/pqc/legacy/crypto/gmss/util/GMSSUtil;->concatenateArray([[B)[B

    move-result-object v1

    iget-object v4, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSSigner;->gmssUtil:Lorg/bouncycastle/pqc/legacy/crypto/gmss/util/GMSSUtil;

    iget-object v6, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSSigner;->index:[I

    aget v6, v6, v0

    invoke-virtual {v4, v6}, Lorg/bouncycastle/pqc/legacy/crypto/gmss/util/GMSSUtil;->intToBytesLittleEndian(I)[B
    ...
    iget-object v7, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSSigner;->subtreeRootSig:[[B
    ...
    iget-object v4, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSSigner;->subtreeRootSig:[[B
...
.method public init(ZLorg/bouncycastle/crypto/CipherParameters;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSSigner;->random:Ljava/security/SecureRandom;

    invoke-virtual {p2}, Lorg/bouncycastle/crypto/params/ParametersWithRandom;->getParameters()Lorg/bouncycastle/crypto/CipherParameters;

    move-result-object p1

    check-cast p1, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSPrivateKeyParameters;

    iput-object p1, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSSigner;->key:Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSKeyParameters;
    ...
    check-cast p2, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSPrivateKeyParameters;

    iput-object p2, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSSigner;->key:Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSKeyParameters;
    ...
    :cond_1
    check-cast p2, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSPublicKeyParameters;
...
.method public verifySignature([B[B)Z
    ...
    iget-object v0, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSSigner;->messDigestOTS:Lorg/bouncycastle/crypto/Digest;
    ...
    new-instance v4, Lorg/bouncycastle/pqc/legacy/crypto/gmss/util/WinternitzOTSVerify;
    ...
    invoke-direct {v4, v5, v6}, Lorg/bouncycastle/pqc/legacy/crypto/gmss/util/WinternitzOTSVerify;-><init>(Lorg/bouncycastle/crypto/Digest;I)V

    invoke-virtual {v4}, Lorg/bouncycastle/pqc/legacy/crypto/gmss/util/WinternitzOTSVerify;->getSignatureLength()I

    move-result v5

    iget-object v6, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSSigner;->gmssUtil:Lorg/bouncycastle/pqc/legacy/crypto/gmss/util/GMSSUtil;

    invoke-virtual {v6, p2, v3}, Lorg/bouncycastle/pqc/legacy/crypto/gmss/util/GMSSUtil;->bytesToIntLittleEndian([BI)I
    ...
    invoke-virtual {v4, p1, v7}, Lorg/bouncycastle/pqc/legacy/crypto/gmss/util/WinternitzOTSVerify;->Verify([B[B)[B
    ...
    :cond_0
    iget-object v4, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSSigner;->gmssPS:Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSParameters;
    ...
    iget v9, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSSigner;->mdLength:I
    ...
    :goto_3
    iget-object p1, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSSigner;->messDigestTrees:Lorg/bouncycastle/crypto/Digest;
    ...
    iget-object v8, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSSigner;->messDigestTrees:Lorg/bouncycastle/crypto/Digest;
    ...
    :cond_4
    iget-object p0, p0, Lorg/bouncycastle/pqc/legacy/crypto/gmss/GMSSSigner;->pubKeyBytes:[B
