...
.method public constructor <init>(ILjava/security/SecureRandom;)V
    ...
    iget p1, p0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nONBField;->mDegree:I

    const/16 v0, 0x40

    div-int/2addr p1, v0

    iput p1, p0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nONBField;->mLength:I
    ...
    iput v0, p0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nONBField;->mBit:I

    goto :goto_0

    :cond_0
    iget p1, p0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nONBField;->mLength:I
    ...
    iput-object p1, p0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nONBField;->fields:Ljava/util/Vector;

    new-instance p1, Ljava/util/Vector;

    invoke-direct {p1}, Ljava/util/Vector;-><init>()V

    iput-object p1, p0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nONBField;->matrices:Ljava/util/Vector;
    ...
    iget p0, p0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nONBField;->mType:I
...
.method private computeMultMatrix()V
    ...
    :cond_1
    invoke-direct {p0, v3, v1}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nONBField;->elementOfOrder(II)I
    ...
    :goto_2
    iget v11, p0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nONBField;->mDegree:I
    ...
    const-string v0, "only type 1 or type 2 implemented"
    ...
    const-string v0, "bisher nur fuer Gausssche Normalbasen implementiert"
...
.method private computeType()V
    ...
    invoke-static {v2, v1}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/IntegerFunctions;->gcd(II)I
    ...
    const-string v0, "The extension degree is divisible by 8!"
...
.method private elementOfOrder(II)I
    ...
    :cond_1
    invoke-static {v0, p2}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/IntegerFunctions;->order(II)I
...
.method protected computeCOBMatrix(Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nField;)V
    ...
    invoke-virtual {v5}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nElement;->square()Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nElement;
    ...
    invoke-virtual {v6, v5}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nElement;->testBit(I)Z
    ...
    invoke-virtual {v6, v7}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Polynomial;->setBit(I)V
    ...
    :cond_4
    iget-object v1, p0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nONBField;->fields:Ljava/util/Vector;

    invoke-virtual {v1, p1}, Ljava/util/Vector;->addElement(Ljava/lang/Object;)V

    iget-object v1, p0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nONBField;->matrices:Ljava/util/Vector;
    ...
    const-string p1, "GF2nField.computeCOBMatrix: B1 has a different degree and thus cannot be coverted to!"
...
.method protected computeFieldPolynomial()V
    ...
    invoke-direct {v2, v3, v4}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Polynomial;-><init>(ILjava/lang/String;)V
...
.method getONBBit()I
    ...
    iget p0, p0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nONBField;->mBit:I
...
.method getONBLength()I
    ...
    iget p0, p0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nONBField;->mLength:I
...
.method protected getRandomRoot(Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Polynomial;)Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nElement;
    ...
    iget-object v2, p0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nONBField;->random:Ljava/security/SecureRandom;
