...
.method public constructor <init>(ILjava/security/SecureRandom;)V
    ...
    iput-boolean p2, p0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nPolynomialField;->isTrinomial:Z

    iput-boolean p2, p0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nPolynomialField;->isPentanomial:Z

    const/4 p2, 0x3

    new-array v0, p2, [I

    iput-object v0, p0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nPolynomialField;->pc:[I
    ...
    iput-object p1, p0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nPolynomialField;->fields:Ljava/util/Vector;

    new-instance p1, Ljava/util/Vector;

    invoke-direct {p1}, Ljava/util/Vector;-><init>()V

    iput-object p1, p0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nPolynomialField;->matrices:Ljava/util/Vector;
    ...
    const-string p1, "k must be at least 3"
...
.method public constructor <init>(ILjava/security/SecureRandom;Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Polynomial;)V
    ...
    :goto_0
    iget-object v1, p0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nPolynomialField;->fieldPolynomial:Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Polynomial;
    ...
    invoke-virtual {v1, v0}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Polynomial;->testBit(I)Z
    ...
    iput v0, p0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nPolynomialField;->tc:I
    ...
    iput-boolean p1, p0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nPolynomialField;->isTrinomial:Z

    :cond_4
    if-ne p3, v2, :cond_5

    iput-boolean p1, p0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nPolynomialField;->isPentanomial:Z
    ...
    const-string p1, "degree must be at least 3"
...
.method private computeSquaringMatrix()V
    ...
    new-instance v5, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Polynomial;

    iget v6, p0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nPolynomialField;->mDegree:I

    const-string v7, "ZERO"

    invoke-direct {v5, v6, v7}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Polynomial;-><init>(ILjava/lang/String;)V
...
.method private testPentanomials()Z
    ...
    iget v1, p0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nPolynomialField;->mDegree:I
    ...
    iput-object v0, p0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nPolynomialField;->fieldPolynomial:Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Polynomial;

    iget-object v0, p0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nPolynomialField;->fieldPolynomial:Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Polynomial;
    ...
    invoke-virtual {v0, v3}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Polynomial;->setBit(I)V
    ...
    invoke-virtual {v4, v0}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Polynomial;->setBit(I)V
    ...
    :goto_2
    iget v9, p0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nPolynomialField;->mDegree:I
    ...
    iget-object v9, p0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nPolynomialField;->fieldPolynomial:Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Polynomial;

    invoke-virtual {v9, v8}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Polynomial;->setBit(I)V
    ...
    iput-boolean v2, p0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nPolynomialField;->isPentanomial:Z

    iget-object p0, p0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nPolynomialField;->pc:[I
    ...
    invoke-virtual {v9, v8}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Polynomial;->resetBit(I)V
    ...
    invoke-virtual {v5, v0}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Polynomial;->resetBit(I)V
...
.method private testRandom()Z
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Polynomial;->randomize()V
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Polynomial;->isIrreducible()Z
...
.method private testTrinomials()Z
    ...
    invoke-virtual {v1, v0}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Polynomial;->setBit(I)V

    iget-object v1, p0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nPolynomialField;->fieldPolynomial:Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Polynomial;

    invoke-virtual {v1}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Polynomial;->isIrreducible()Z

    move-result v1

    if-eqz v1, :cond_0

    iput-boolean v2, p0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nPolynomialField;->isTrinomial:Z
    ...
    invoke-virtual {v1, v0}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Polynomial;->resetBit(I)V
...
.method protected computeCOBMatrix(Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nField;)V
    ...
    invoke-virtual {p1, v3}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nField;->getRandomRoot(Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Polynomial;)Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nElement;

    move-result-object v3

    invoke-virtual {v3}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nElement;->isZero()Z

    move-result v4

    if-nez v4, :cond_1

    instance-of v4, v3, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nONBElement;

    if-eqz v4, :cond_2

    iget v4, p0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nPolynomialField;->mDegree:I

    new-array v4, v4, [Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nONBElement;
    ...
    invoke-static {v6}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nONBElement;->ONE(Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nONBField;)Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nONBElement;
    ...
    new-array v4, v4, [Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nPolynomialElement;
    ...
    invoke-static {v6}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nPolynomialElement;->ONE(Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nPolynomialField;)Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nPolynomialElement;
    ...
    invoke-virtual {v6, v3}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nElement;->multiply(Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GFElement;)Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GFElement;
    ...
    invoke-virtual {v5, v3}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nElement;->testBit(I)Z
    ...
    :cond_9
    iget-object v0, p0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nPolynomialField;->fields:Ljava/util/Vector;

    invoke-virtual {v0, p1}, Ljava/util/Vector;->addElement(Ljava/lang/Object;)V

    iget-object v0, p0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nPolynomialField;->matrices:Ljava/util/Vector;

    invoke-virtual {v0, v1}, Ljava/util/Vector;->addElement(Ljava/lang/Object;)V

    iget-object v0, p1, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nField;->fields:Ljava/util/Vector;

    invoke-virtual {v0, p0}, Ljava/util/Vector;->addElement(Ljava/lang/Object;)V

    iget-object p1, p1, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nField;->matrices:Ljava/util/Vector;

    invoke-virtual {p0, v1}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nPolynomialField;->invertMatrix([Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Polynomial;)[Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Polynomial;
    ...
    const-string p1, "GF2nPolynomialField.computeCOBMatrix: B1 has a different degree and thus cannot be coverted to!"
...
.method protected getRandomRoot(Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Polynomial;)Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nElement;
    ...
    iget-object v2, p0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nPolynomialField;->random:Ljava/security/SecureRandom;

    invoke-direct {p1, p0, v2}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nPolynomialElement;-><init>(Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nPolynomialField;Ljava/util/Random;)V
    ...
    invoke-virtual {v0, p0}, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nPolynomial;->at(I)Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nElement;
...
.method public getSquaringVector(I)Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Polynomial;
    ...
    iget-object p0, p0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nPolynomialField;->squaringMatrix:[Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2Polynomial;
...
.method public getTc()I
    ...
    iget p0, p0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nPolynomialField;->tc:I
...
.method public isPentanomial()Z
    ...
    iget-boolean p0, p0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nPolynomialField;->isPentanomial:Z
...
.method public isTrinomial()Z
    ...
    iget-boolean p0, p0, Lorg/bouncycastle/pqc/legacy/math/linearalgebra/GF2nPolynomialField;->isTrinomial:Z
