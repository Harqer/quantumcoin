...
.method static constructor <clinit>()V
    ...
    sput v0, Lorg/bouncycastle/crypto/digests/Blake2bDigest;->ROUNDS:I
...
.method public constructor <init>(ILorg/bouncycastle/crypto/CryptoServicePurpose;)V
    ...
    const-string p1, "BLAKE2b digest bit length must be a multiple of 8 and not greater than 512"
...
.method public constructor <init>([BI[B[BLorg/bouncycastle/crypto/CryptoServicePurpose;)V
    ...
    const-string p1, "salt length must be exactly 16 bytes"
    ...
    const-string p1, "personalization length must be exactly 16 bytes"
    ...
    const-string p1, "Keys > 64 are not supported"
    ...
    const-string p1, "Invalid digest length (required: 1 - 64)"
...
.method public doFinal([BI)I
    ...
    invoke-static {v6, v7, v5, v1}, Lorg/bouncycastle/util/Pack;->longToLittleEndian(J[BI)V
