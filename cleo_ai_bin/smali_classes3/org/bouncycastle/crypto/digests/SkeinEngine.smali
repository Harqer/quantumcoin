...
.method private checkInitialised()V
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->ubi:Lorg/bouncycastle/crypto/digests/SkeinEngine$UBI;
...
.method private initParams(Ljava/util/Hashtable;)V
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->postMessageParameters:[Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;

    invoke-static {p0}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->sort([Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;)V
...
.method private output(J[BII)V
    ...
    invoke-virtual {p0, p1}, Lorg/bouncycastle/crypto/digests/SkeinEngine$UBI;->doFinal([J)V
    ...
    invoke-static {v4, v5, p3, v3}, Lorg/bouncycastle/util/Pack;->longToLittleEndian(J[BI)V
...
.method private ubiFinal()V
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->chain:[J

    invoke-virtual {v0, p0}, Lorg/bouncycastle/crypto/digests/SkeinEngine$UBI;->doFinal([J)V
...
.method private ubiInit(I)V
    ...
    invoke-virtual {p0, p1}, Lorg/bouncycastle/crypto/digests/SkeinEngine$UBI;->reset(I)V
...
.method public doFinal([BI)I
    ...
    invoke-virtual {v5}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->reset()V

    iget p0, v5, Lorg/bouncycastle/crypto/digests/SkeinEngine;->outputSizeBytes:I
...
.method public getBlockSize()I
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->threefish:Lorg/bouncycastle/crypto/engines/ThreefishEngine;

    invoke-virtual {p0}, Lorg/bouncycastle/crypto/engines/ThreefishEngine;->getBlockSize()I
...
.method public getOutputSize()I
    ...
    iget p0, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->outputSizeBytes:I
...
.method public update([BII)V
    ...
    invoke-virtual {v0, p1, p2, p3, p0}, Lorg/bouncycastle/crypto/digests/SkeinEngine$UBI;->update([BII[J)V
