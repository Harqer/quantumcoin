...
.method private ROUND(J)V
    ...
    invoke-static {v5, v6, v13}, Lorg/bouncycastle/util/Longs;->rotateRight(JI)J

    move-result-wide v5

    xor-long/2addr v5, v9

    iput-wide v5, v0, Lorg/bouncycastle/crypto/engines/AsconEngine;->x0:J
    ...
    invoke-static {v11, v12, v9}, Lorg/bouncycastle/util/Longs;->rotateRight(JI)J

    move-result-wide v9

    xor-long/2addr v5, v9

    iput-wide v5, v0, Lorg/bouncycastle/crypto/engines/AsconEngine;->x1:J
...
.method public doFinal([BI)I
    ...
    iget p0, v3, Lorg/bouncycastle/crypto/engines/AsconEngine;->CRYPTO_ABYTES:I

    new-array p0, p0, [B

    iput-object p0, v3, Lorg/bouncycastle/crypto/engines/AsconEngine;->mac:[B

    iget-wide p1, v3, Lorg/bouncycastle/crypto/engines/AsconEngine;->x3:J

    const/4 v1, 0x0

    invoke-static {p1, p2, p0, v1}, Lorg/bouncycastle/util/Pack;->longToBigEndian(J[BI)V

    iget-wide p0, v3, Lorg/bouncycastle/crypto/engines/AsconEngine;->x4:J

    iget-object p2, v3, Lorg/bouncycastle/crypto/engines/AsconEngine;->mac:[B

    invoke-static {p0, p1, p2, v2}, Lorg/bouncycastle/util/Pack;->longToBigEndian(J[BI)V

    iget-object p0, v3, Lorg/bouncycastle/crypto/engines/AsconEngine;->mac:[B

    iget p1, v3, Lorg/bouncycastle/crypto/engines/AsconEngine;->m_bufPos:I

    add-int p2, v8, p1

    iget p1, v3, Lorg/bouncycastle/crypto/engines/AsconEngine;->CRYPTO_ABYTES:I

    invoke-static {p0, v1, v7, p2, p1}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    invoke-direct {v3, v1}, Lorg/bouncycastle/crypto/engines/AsconEngine;->reset(Z)V
    ...
    invoke-direct {p0, v1}, Lorg/bouncycastle/crypto/OutputLengthException;-><init>(Ljava/lang/String;)V
    ...
    iget p0, v3, Lorg/bouncycastle/crypto/engines/AsconEngine;->m_bufPos:I
    ...
    iput v10, v3, Lorg/bouncycastle/crypto/engines/AsconEngine;->m_bufPos:I
    ...
    iget-object v8, v3, Lorg/bouncycastle/crypto/engines/AsconEngine;->m_buf:[B
    ...
    invoke-direct/range {v7 .. v12}, Lorg/bouncycastle/crypto/engines/AsconEngine;->processFinalDecrypt([BII[BI)V

    iget-wide p0, v3, Lorg/bouncycastle/crypto/engines/AsconEngine;->x3:J

    iget-object p2, v3, Lorg/bouncycastle/crypto/engines/AsconEngine;->m_buf:[B

    iget v0, v3, Lorg/bouncycastle/crypto/engines/AsconEngine;->m_bufPos:I
    ...
    iput-wide p0, v3, Lorg/bouncycastle/crypto/engines/AsconEngine;->x3:J
    ...
    iput-wide p0, v3, Lorg/bouncycastle/crypto/engines/AsconEngine;->x4:J

    iget-wide v0, v3, Lorg/bouncycastle/crypto/engines/AsconEngine;->x3:J
    ...
    invoke-direct {v3, p0}, Lorg/bouncycastle/crypto/engines/AsconEngine;->reset(Z)V
    ...
    invoke-virtual {v3}, Lorg/bouncycastle/crypto/engines/AsconEngine;->getAlgorithmName()Ljava/lang/String;
...
.method public getAlgorithmName()Ljava/lang/String;
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/engines/AsconEngine;->algorithmName:Ljava/lang/String;
...
.method public getIVBytesSize()I
    ...
    iget p0, p0, Lorg/bouncycastle/crypto/engines/AsconEngine;->CRYPTO_ABYTES:I
...
.method public getKeyBytesSize()I
    ...
    iget p0, p0, Lorg/bouncycastle/crypto/engines/AsconEngine;->CRYPTO_KEYBYTES:I
...
.method public getMac()[B
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/engines/AsconEngine;->mac:[B
...
.method public getUpdateOutputSize(I)I
    ...
    :goto_1
    iget p0, p0, Lorg/bouncycastle/crypto/engines/AsconEngine;->ASCON_AEAD_RATE:I
