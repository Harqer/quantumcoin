...
.method public doFinal([BI)I
    ...
    :try_start_0
    iget-object p0, p0, Lorg/bouncycastle/crypto/macs/GMac;->cipher:Lorg/bouncycastle/crypto/modes/GCMModeCipher;

    invoke-interface {p0, p1, p2}, Lorg/bouncycastle/crypto/modes/GCMModeCipher;->doFinal([BI)I
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/crypto/InvalidCipherTextException;->toString()Ljava/lang/String;
...
.method public getAlgorithmName()Ljava/lang/String;
    ...
    invoke-interface {p0}, Lorg/bouncycastle/crypto/modes/GCMModeCipher;->getUnderlyingCipher()Lorg/bouncycastle/crypto/BlockCipher;
...
.method public getMacSize()I
    ...
    iget p0, p0, Lorg/bouncycastle/crypto/macs/GMac;->macSizeBits:I
...
.method public init(Lorg/bouncycastle/crypto/CipherParameters;)V
    ...
    invoke-interface {v1, p0, v2}, Lorg/bouncycastle/crypto/modes/GCMModeCipher;->init(ZLorg/bouncycastle/crypto/CipherParameters;)V
...
.method public reset()V
    ...
    invoke-interface {p0}, Lorg/bouncycastle/crypto/modes/GCMModeCipher;->reset()V
...
.method public update(B)V
    ...
    invoke-interface {p0, p1}, Lorg/bouncycastle/crypto/modes/GCMModeCipher;->processAADByte(B)V
...
.method public update([BII)V
    ...
    invoke-interface {p0, p1, p2, p3}, Lorg/bouncycastle/crypto/modes/GCMModeCipher;->processAADBytes([BII)V
