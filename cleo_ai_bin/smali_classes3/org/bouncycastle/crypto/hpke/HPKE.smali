...
.method private VerifyPSKInputs(B[B[B)V
    ...
    const-string p1, "PSK input provided when not needed"
    ...
    const-string p1, "Missing required PSK input"
    ...
    const-string p1, "Inconsistent PSK inputs"
...
.method public deriveKeyPair([B)Lorg/bouncycastle/crypto/AsymmetricCipherKeyPair;
    ...
    iget-object p0, p0, Lorg/bouncycastle/crypto/hpke/HPKE;->dhkem:Lorg/bouncycastle/crypto/hpke/DHKEM;

    invoke-virtual {p0, p1}, Lorg/bouncycastle/crypto/hpke/DHKEM;->DeriveKeyPair([B)Lorg/bouncycastle/crypto/AsymmetricCipherKeyPair;
...
.method public deserializePrivateKey([B[B)Lorg/bouncycastle/crypto/AsymmetricCipherKeyPair;
    ...
    invoke-virtual {p0, p1, p2}, Lorg/bouncycastle/crypto/hpke/DHKEM;->DeserializePrivateKey([B[B)Lorg/bouncycastle/crypto/AsymmetricCipherKeyPair;
...
.method public generatePrivateKey()Lorg/bouncycastle/crypto/AsymmetricCipherKeyPair;
    ...
    invoke-virtual {p0}, Lorg/bouncycastle/crypto/hpke/DHKEM;->GeneratePrivateKey()Lorg/bouncycastle/crypto/AsymmetricCipherKeyPair;
...
.method public getEncSize()I
    ...
    iget-short p0, p0, Lorg/bouncycastle/crypto/hpke/HPKE;->kemId:S
...
.method public seal(Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;[B[B[B[B[BLorg/bouncycastle/crypto/AsymmetricCipherKeyPair;)[[B
    ...
    :goto_0
    invoke-virtual {p0, p3, p4}, Lorg/bouncycastle/crypto/hpke/HPKEContextWithEncapsulation;->seal([B[B)[B
...
.method public sendExport(Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;[B[BI[B[BLorg/bouncycastle/crypto/AsymmetricCipherKeyPair;)[[B
    ...
    invoke-virtual {p0, p3, p4}, Lorg/bouncycastle/crypto/hpke/HPKEContextWithEncapsulation;->export([BI)[B
...
.method public serializePrivateKey(Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;)[B
    ...
    invoke-virtual {p0, p1}, Lorg/bouncycastle/crypto/hpke/DHKEM;->SerializePrivateKey(Lorg/bouncycastle/crypto/params/AsymmetricKeyParameter;)[B
