...
.method public final invoke(Lorg/kodein/di/DirectDI;)Ljava/lang/Object;
    ...
    iget-object v0, p0, Lorg/kodein/di/BindSingletonKt$bindSingletonOf$6;->$constructor:Lkotlin/jvm/functions/Function5;
    ...
    new-instance v2, Lorg/kodein/di/BindSingletonKt$bindSingletonOf$6$invoke$$inlined$new$1;

    invoke-direct {v2}, Lorg/kodein/di/BindSingletonKt$bindSingletonOf$6$invoke$$inlined$new$1;-><init>()V

    invoke-virtual {v2}, Lorg/kodein/di/BindSingletonKt$bindSingletonOf$6$invoke$$inlined$new$1;->getSuperType()Ljava/lang/reflect/Type;
    ...
    new-instance v6, Lorg/kodein/di/BindSingletonKt$bindSingletonOf$6$invoke$$inlined$new$2;

    invoke-direct {v6}, Lorg/kodein/di/BindSingletonKt$bindSingletonOf$6$invoke$$inlined$new$2;-><init>()V

    invoke-virtual {v6}, Lorg/kodein/di/BindSingletonKt$bindSingletonOf$6$invoke$$inlined$new$2;->getSuperType()Ljava/lang/reflect/Type;
    ...
    new-instance v7, Lorg/kodein/di/BindSingletonKt$bindSingletonOf$6$invoke$$inlined$new$3;

    invoke-direct {v7}, Lorg/kodein/di/BindSingletonKt$bindSingletonOf$6$invoke$$inlined$new$3;-><init>()V

    invoke-virtual {v7}, Lorg/kodein/di/BindSingletonKt$bindSingletonOf$6$invoke$$inlined$new$3;->getSuperType()Ljava/lang/reflect/Type;
    ...
    new-instance v8, Lorg/kodein/di/BindSingletonKt$bindSingletonOf$6$invoke$$inlined$new$4;

    invoke-direct {v8}, Lorg/kodein/di/BindSingletonKt$bindSingletonOf$6$invoke$$inlined$new$4;-><init>()V

    invoke-virtual {v8}, Lorg/kodein/di/BindSingletonKt$bindSingletonOf$6$invoke$$inlined$new$4;->getSuperType()Ljava/lang/reflect/Type;
    ...
    new-instance v8, Lorg/kodein/di/BindSingletonKt$bindSingletonOf$6$invoke$$inlined$new$5;

    invoke-direct {v8}, Lorg/kodein/di/BindSingletonKt$bindSingletonOf$6$invoke$$inlined$new$5;-><init>()V

    invoke-virtual {v8}, Lorg/kodein/di/BindSingletonKt$bindSingletonOf$6$invoke$$inlined$new$5;->getSuperType()Ljava/lang/reflect/Type;
