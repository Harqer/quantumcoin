  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colorRoles.background.primary }}>
      <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 16, paddingVertical: 12 }}>
        <TouchableOpacity testID="btn-auto-b80aee" testID="btn-auto-fe2e07" onPress={() => { HapticsManager.light(); router.back(); }} style={{ padding: 8, marginLeft: -8 }}>
      ...
      <View style={{ flex: 1, padding: 24 }}>
        <Animated.View entering={FadeInDown.springify().stiffness(80).damping(28).delay(100)}>
          ...
          <TouchableOpacity testID="btn-auto-d15f1b" testID="btn-auto-4dc8b0" onPress={handleInfoPress} style={{ marginTop: 24, padding: 12, backgroundColor: colorRoles.background.baseLight, borderRadius: 8 }}>
      ...
      <Modal visible={showWarningModal} transparent={true} animationType="fade">
        <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'center', alignItems: 'center', padding: 24 }}>
          <View style={{ backgroundColor: colorRoles.background.primary, padding: 24, borderRadius: 16, width: '100%' }}>
            ...
            <TouchableOpacity testID="btn-i-understand" testID="btn-i-understand" onPress={() => setShowWarningModal(false)} style={{ backgroundColor: colorRoles.content.accentMid, padding: 16, borderRadius: 999 }}>
      ...
      <View style={{ paddingHorizontal: 24, paddingBottom: insets.bottom + 16, borderTopWidth: 1, borderTopColor: colorRoles.border.default, paddingTop: 24 }}>
        <TouchableOpacity testID="btn-auto-d5981b" testID="btn-auto-807e65" 
