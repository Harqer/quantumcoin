...
export default function WalletScreen() {
  ...
  const renderRightActions = (id: string) => {
    return (
      <TouchableOpacity testID="btn-auto-731f89" testID="btn-auto-3907b4" 
        onPress={() => {
  ...
  const ListHeaderComponent = useMemo(() => (
    <View style={{paddingHorizontal: Platform.OS === 'web' ? 0 : spacing.l, paddingTop: spacing.l, paddingBottom: spacing.m}}>
      ...
      <Animated.View entering={FadeInDown.springify().stiffness(80).damping(28).delay(100)}>
        <PressableScale testID="btn-auto-077f75" testID="btn-auto-2711d1" haptics="none" onPress={() => AudioHapticsManager.mediumInteraction()} style={{ backgroundColor: '#2563EB', borderRadius: 24, padding: spacing.l, marginBottom: spacing.m }}>
      ...
      <Animated.View entering={FadeInDown.springify().stiffness(80).damping(28).delay(150)}>
        <PressableScale testID="btn-auto-7f2e46" testID="btn-auto-38957b" haptics="none" onPress={() => AudioHapticsManager.mediumInteraction()} style={{ backgroundColor: '#7C3AED', borderRadius: 24, padding: spacing.l, marginBottom: spacing.m }}>
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colorRoles.background.primary }} edges={['top']}>
      <View style={{flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: spacing.l, paddingBottom: spacing.s, backgroundColor: colorRoles.background.primary}}>
        <TouchableOpacity testID="btn-auto-827b88" testID="btn-auto-f329cc" onPress={() => { AudioHapticsManager.lightInteraction(); router.back(); }} style={{ width: 40, height: 40, borderRadius: 20, backgroundColor: colorRoles.background.baseLight, alignItems: 'center', justifyContent: 'center' }}>
        ...
        <TouchableOpacity testID="btn-auto-61a5c0" testID="btn-auto-ec7302" onPress={() => { AudioHapticsManager.lightInteraction(); router.push('/(main)/banks-list'); }} style={{ width: 40, height: 40, borderRadius: 20, backgroundColor: colorRoles.background.secondary, alignItems: 'center', justifyContent: 'center' }}>
