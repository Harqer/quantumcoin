  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colorRoles.background.primary }}>
      <View style={[styles.header, { borderBottomColor: colorRoles.border.divider }]}>
        <TouchableOpacity testID="btn-basic-details" testID="btn-basic-details" onPress={() => router.back()}>
      ...
      <ScrollView contentContainerStyle={{ padding: spacing.xl }}>
        ...
        <TouchableOpacity testID="btn-first-name" testID="btn-first-name" style={[styles.row, { borderBottomColor: colorRoles.border.divider }]} onPress={() => setDrawerType('firstName')}>
          <View>
        ...
        <TouchableOpacity testID="btn-last-name" testID="btn-last-name" style={[styles.row, { borderBottomColor: colorRoles.border.divider }]} onPress={() => setDrawerType('lastName')}>
          <View>
        ...
        <TouchableOpacity testID="btn-date-of-birth" testID="btn-date-of-birth" style={[styles.row, { borderBottomColor: colorRoles.border.divider }]} onPress={() => setDrawerType('dob')}>
          <View>
        ...
        <TouchableOpacity testID="btn-home-address" testID="btn-home-address" style={[styles.row, { borderBottomColor: colorRoles.border.divider }]} onPress={() => setDrawerType('address')}>
          <View>
      ...
      <View style={[styles.footer, { borderTopColor: colorRoles.border.divider }]}>
        <TouchableOpacity testID="btn-auto-156ba5" testID="btn-auto-816d69" 
