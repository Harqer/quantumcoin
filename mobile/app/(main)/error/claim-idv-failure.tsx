      ...
      <View style={{ flex: 1, padding: spacing.xl, justifyContent: 'center' }}>
        <Animated.View entering={FadeInDown.springify()} style={{ alignItems: 'center' }}>
          <View style={{ backgroundColor: colorRoles.content.negativeLight, padding: 24, borderRadius: 999, marginBottom: spacing.l }}>
            <Ionicons name="shield-half-outline" size={64} color={colorRoles.content.negativeDark} />
          </View>
          ...
          <Text style={{ fontFamily: typography.bodyLarge.fontFamily, fontSize: 16, color: colorRoles.content.secondary, textAlign: 'center', lineHeight: 24 }}>
            We couldn't verify the claim on this identity. Please check your documentation and try again, or reach out to support.
          </Text>
        </Animated.View>
      </View>

      <View style={{ padding: spacing.xl, gap: spacing.m }}>
        <PressableScale testID="btn-auto-454c30" testID="btn-auto-1ca039" 
        ...
        <PressableScale testID="btn-auto-3bbb50" testID="btn-go-back" 
          onPress={handleBack}
