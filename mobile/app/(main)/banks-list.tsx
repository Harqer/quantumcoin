  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colorRoles.background.primary }}>
      ...
      <GenericBottomSheet ref={errorSheetRef} snapPoints={['40%']}>
        ...
        <PressableScale haptics="light" onPress={() => errorSheetRef.current?.dismiss()} style={{ backgroundColor: colorRoles.background.baseLight, paddingVertical: 18, borderRadius: 9999, alignItems: 'center' }}>
      ...
      <GenericBottomSheet ref={addAccountSheetRef} snapPoints={['40%']}>
        <View style={{ marginBottom: spacing.l }}>
          ...
          <PressableScale haptics="medium" onPress={() => { addAccountSheetRef.current?.dismiss(); open(); }} style={{ backgroundColor: colorRoles.content.accentMid, paddingVertical: 16, borderRadius: 16, alignItems: 'center', marginBottom: spacing.m }}>
          ...
          <PressableScale haptics="light" onPress={() => addAccountSheetRef.current?.dismiss()} style={{ backgroundColor: colorRoles.background.baseLight, paddingVertical: 16, borderRadius: 16, alignItems: 'center' }}>
