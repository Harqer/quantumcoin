...
export default function BNPLScreen() {
  ...
  const { data: bnplData, isLoading } = coreTrpc.epics.getBnplStatus.useQuery();
  ...
  return (
    ...
    >
      ...
      >
        <TouchableOpacity testID="btn-auto-60d968" testID="btn-auto-7b7569"
          onPress={() => router.back()}
      ...
      <ScrollView contentContainerStyle={{ padding: spacing.xl }}>
        ...
        <TouchableOpacity testID="btn-auto-09b116" testID="btn-auto-ad488b"
          onPress={() => {
