  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colorRoles.background.primary }}>
      <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 16, paddingVertical: 12 }}>
        <TouchableOpacity testID="btn-auto-89e429" testID="btn-auto-86638f" onPress={() => { HapticsManager.light(); router.back(); }} style={{ padding: 8, marginLeft: -8 }}>
      ...
      <View style={{ padding: 24 }}>
        <TouchableOpacity testID="btn-auto-640e14" testID="btn-auto-bd8932" 
