  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colorRoles.background.primary }}>
      <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 16, paddingVertical: 12 }}>
        <TouchableOpacity testID="btn-auto-8b4d3b" testID="btn-auto-fbcb2f" onPress={() => { HapticsManager.light(); router.back(); }} style={{ padding: 8, marginLeft: -8 }}>
          ...
          <View style={{ gap: 16 }}>
            {documents.map((doc, index) => (
              <Animated.View key={doc.id} entering={FadeInDown.springify().stiffness(80).damping(28).delay(200 + index * 50)}>
                <TouchableOpacity testID="btn-auto-7d76e5" testID="btn-auto-342c13" 
