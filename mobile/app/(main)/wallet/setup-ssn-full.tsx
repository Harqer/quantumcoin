  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colorRoles.background.primary }} edges={['bottom', 'top']}>
      <ScrollView contentContainerStyle={{ padding: spacing.xl, flexGrow: 1 }}>
        ...
        <TextInput testID="input-auto-a84e7e" testID="input-auto-826723" style={{ backgroundColor: colorRoles.background.secondary, color: colorRoles.content.primary, padding: spacing.l, borderRadius: 16, marginBottom: spacing.xl, fontSize: 24, letterSpacing: 4, textAlign: 'center', fontWeight: 'bold' }} placeholder="XXX-XX-XXXX" placeholderTextColor={colorRoles.content.secondary} keyboardType="numeric" maxLength={9} />

        <View style={{ flex: 1 }} />

        <PressableScale testID="btn-auto-078745" testID="btn-auto-0f7778" onPress={() => router.push('/(main)/wallet/setup-kyc')} style={{ backgroundColor: colorRoles.content.accentMid, paddingVertical: spacing.l, borderRadius: 999, alignItems: 'center', width: '100%' }}>
