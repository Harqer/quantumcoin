  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colorRoles.background.primary }} edges={['bottom', 'top']}>
      <ScrollView contentContainerStyle={{ padding: spacing.xl, flexGrow: 1 }}>
        ...
        <PressableScale testID="btn-auto-f75c0a" testID="btn-auto-a0896c" style={{ backgroundColor: colorRoles.background.secondary, padding: spacing.l, borderRadius: 16, flexDirection: 'row', alignItems: 'center', marginBottom: spacing.m }}>
        ...
        <PressableScale testID="btn-auto-2e55dc" testID="btn-auto-93e1cd" onPress={() => router.push('/(main)/wallet/setup-unsupported-bank')} style={{ padding: spacing.l, alignItems: 'center' }}>
        ...
        <PressableScale testID="btn-auto-3af210" testID="btn-auto-bc453b" onPress={() => router.push('/(main)/wallet/setup-finish')} style={{ backgroundColor: colorRoles.content.accentMid, paddingVertical: spacing.l, borderRadius: 999, alignItems: 'center', width: '100%' }}>
