  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colorRoles.background.primary }} edges={['bottom', 'top']}>
      <ScrollView contentContainerStyle={{ padding: spacing.l, flexGrow: 1 }}>
        ...
        <TouchableOpacity testID="btn-standard" testID="btn-standard" style={{ padding: spacing.l, borderRadius: 16, backgroundColor: colorRoles.background.secondary, marginBottom: spacing.m }}>
        ...
        <TouchableOpacity testID="btn-auto-4529a6" testID="btn-premium" style={{ padding: spacing.l, borderRadius: 16, borderWidth: 2, borderColor: colorRoles.content.accentMid, backgroundColor: colorRoles.background.secondary, marginBottom: spacing.m }}>
        ...
        <PressableScale testID="btn-auto-0c99b3" testID="btn-auto-fe0e82" onPress={() => router.push('/(main)/subscription/resume-credit')} style={{ backgroundColor: colorRoles.content.accentMid, paddingVertical: spacing.l, borderRadius: 999, alignItems: 'center', marginBottom: spacing.m }}>
