...
export default function IntroducingAiScreen() {
  ...
  useEffect(() => {
    floatY.value = withRepeat(
      withSequence(withTiming(-15, { duration: 2000 }), withTiming(0, { duration: 2000 })),
      -1,
      true,
    );
      ...
      >
        ...
        >
            ...
            style={[
              {
                ...
                backgroundColor: step === 0 ? colorRoles.content.accentMid : '#EC4899',
                justifyContent: 'center',
                alignItems: 'center',
                marginBottom: spacing.xxl,
                shadowColor: step === 0 ? colorRoles.content.accentMid : '#EC4899',
          ...
          >
            {/* The AI "Eye" */}
            <LottieView
              source={require('../../assets/shimmering_overlay.json')}
              autoPlay
              loop
          ...
          {step === 0 ? (
            ...
            <Animated.View key="step1" entering={FadeInUp} exiting={FadeInDown}>
              ...
              >
                I can hype you up when you save, or ruthlessly roast you when you spend $40 on
                coffee. Your call.
              </Text>
            </Animated.View>
          )}
        ...
        >
          <Button
            ...
            onPress={handleNext}
            variant="primary"
            title={step === 0 ? 'Nice to meet you' : "I'm ready"}
          />
        </Animated.View>
      </View>
    </SafeAreaView>
