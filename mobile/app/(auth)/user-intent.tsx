  ...
  const intents = [
    {
      ...
      icon: 'pie-chart',
      desc: 'Let me roast your bad habits.',
    },
    {
      id: 'credit',
      title: 'Build Credit',
      icon: 'trending-up',
      desc: 'Boost your score on autopilot.',
    },
    {
      id: 'save',
      title: 'Save Money',
      icon: 'wallet',
      desc: 'Stash cash without thinking about it.',
    },
  ];
              ...
              >
                <View
                  style={{
                    ...
                    backgroundColor: isSelected
                      ...
                      : colorRoles.background.secondary,
                    alignItems: 'center',
                ...
                >
                  <Ionicons
                    ...
                    size={24}
                    color={isSelected ? colorRoles.content.onPrimary : colorRoles.content.primary}
                  />
                </View>
                <View style={{ flex: 1 }}>
                  <Text
