...
export default function CreatorDashboardComponent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setMessage(
        "Service registered successfully! It is now live on the Bazaar.",
      );
      setFormData({
        name: "",
        description: "",
        ...
        <form onSubmit={handleSubmit}>
          <div className={styles.formGroup}>
            ...
            <input
              ...
              placeholder="e.g., Quantum Data Analyzer"
            />
          </div>
          <div className={styles.formGroup}>
          ...
          <div className={styles.formGroup}>
            ...
            <input
              ...
              placeholder="https://api.yourdomain.com/execute"
            />
          </div>
          <div className={styles.formGroup}>
          ...
          <div className={styles.formGroup}>
            ...
            <input
              ...
              onChange={(e) =>
                setFormData({ ...formData, creator_address: e.target.value })
              }
              placeholder="0x..."
            />
          </div>
