// TokenSelectDropdownDemo component for selecting a token from a dropdown
...
export default function TokenSelectDropdownDemo() {
  const [token, setToken] = useState<Token>(tokenOptions[0]);
