...
contract HSMKeyManager is Ownable, ReentrancyGuard {
    ...
    {
        HSMKey memory key = validatorKeys[msg.sender];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010001,0)}
        ...
        requestId = keccak256(abi.encodePacked(
            ...
            key.keyId,
            block.timestamp
        ));assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000004,requestId)}
    ...
    function submitSignature(
        ...
        SigningRequest storage request = signingRequests[requestId];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010002,0)}
        
        require(request.timestamp != 0, "Request not found");
        require(!request.completed, "Already completed");
        
        request.signature = signature;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020005,0)}
        request.completed = true;bool certora_local6 = request.completed;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000006,certora_local6)}
    ...
    function initiateKeyRotation(
        ...
        operationHash = keccak256(abi.encodePacked(
            ...
            newPublicKeyHash,
            block.timestamp
        ));assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000007,operationHash)}
    ...
    function executeKeyRotation(
        ...
        HSMKey storage key = validatorKeys[validator];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010003,0)}
        key.keyId = newKeyId;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020008,0)}
        key.publicKeyHash = newPublicKeyHash;bytes32 certora_local9 = key.publicKeyHash;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000009,certora_local9)}
        key.createdAt = block.timestamp;uint256 certora_local10 = key.createdAt;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000a,certora_local10)}
